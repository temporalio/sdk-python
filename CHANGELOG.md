...
- `ActivityExecutionDescription.last_failure` previously came back unconditionally and is now
  opt-in: pass `include_last_failure=True` to `ActivityHandle.describe`.
