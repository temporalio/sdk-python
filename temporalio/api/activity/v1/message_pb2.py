...
from temporalio.api.callback.v1 import message_pb2 as temporal_dot_api_dot_callback_dot_v1_dot_message__pb2
...
_ACTIVITYEXECUTIONLISTINFO = DESCRIPTOR.message_types_by_name['ActivityExecutionListInfo']
_CALLBACKINFO = DESCRIPTOR.message_types_by_name['CallbackInfo']
_CALLBACKINFO_ACTIVITYCLOSED = _CALLBACKINFO.nested_types_by_name['ActivityClosed']
_CALLBACKINFO_TRIGGER = _CALLBACKINFO.nested_types_by_name['Trigger']
ActivityExecutionOutcome = _reflection.GeneratedProtocolMessageType('ActivityExecutionOutcome', (_message.Message,), {
...
ActivityOptions = _reflection.GeneratedProtocolMessageType('ActivityOptions', (_message.Message,), {
...
ActivityExecutionInfo = _reflection.GeneratedProtocolMessageType('ActivityExecutionInfo', (_message.Message,), {
...
ActivityExecutionListInfo = _reflection.GeneratedProtocolMessageType('ActivityExecutionListInfo', (_message.Message,), {
...
CallbackInfo = _reflection.GeneratedProtocolMessageType('CallbackInfo', (_message.Message,), {
  ...
  'ActivityClosed' : _reflection.GeneratedProtocolMessageType('ActivityClosed', (_message.Message,), {
    'DESCRIPTOR' : _CALLBACKINFO_ACTIVITYCLOSED,
    '__module__' : 'temporalio.api.activity.v1.message_pb2'
    # @@protoc_insertion_point(class_scope:temporal.api.activity.v1.CallbackInfo.ActivityClosed)
    })
  ,
  ...
  'Trigger' : _reflection.GeneratedProtocolMessageType('Trigger', (_message.Message,), {
    ...
    '__module__' : 'temporalio.api.activity.v1.message_pb2'
    # @@protoc_insertion_point(class_scope:temporal.api.activity.v1.CallbackInfo.Trigger)
    })
  ,
  'DESCRIPTOR' : _CALLBACKINFO,
  '__module__' : 'temporalio.api.activity.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.activity.v1.CallbackInfo)
  })
_sym_db.RegisterMessage(CallbackInfo)
_sym_db.RegisterMessage(CallbackInfo.ActivityClosed)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _ACTIVITYEXECUTIONOUTCOME._serialized_start=451
  _ACTIVITYEXECUTIONOUTCOME._serialized_end=591
  _ACTIVITYOPTIONS._serialized_start=594
  _ACTIVITYOPTIONS._serialized_end=1065
  _ACTIVITYEXECUTIONINFO._serialized_start=1068
  _ACTIVITYEXECUTIONINFO._serialized_end=2914
  _ACTIVITYEXECUTIONLISTINFO._serialized_start=2917
  _ACTIVITYEXECUTIONLISTINFO._serialized_end=3459
  _CALLBACKINFO._serialized_start=3462
  _CALLBACKINFO._serialized_end=3717
  _CALLBACKINFO_ACTIVITYCLOSED._serialized_start=3597
  _CALLBACKINFO_ACTIVITYCLOSED._serialized_end=3613
  _CALLBACKINFO_TRIGGER._serialized_start=3615
  _CALLBACKINFO_TRIGGER._serialized_end=3717
