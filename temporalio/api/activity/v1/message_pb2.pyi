...
class ActivityExecutionOutcome(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure", b"failure", "result", b"result", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failure", b"failure", "result", b"result", "retry_state", b"retry_state", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["result", "failure"] | None: ...
...
class ActivityOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["heartbeat_timeout", b"heartbeat_timeout", "priority", b"priority", "retry_policy", b"retry_policy", "schedule_to_close_timeout", b"schedule_to_close_timeout", "schedule_to_start_timeout", b"schedule_to_start_timeout", "start_delay", b"start_delay", "start_to_close_timeout", b"start_to_close_timeout", "task_queue", b"task_queue"]) -> None: ...
...
class ActivityExecutionListInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["activity_type", b"activity_type", "close_time", b"close_time", "execution_duration", b"execution_duration", "execution_time", b"execution_time", "schedule_time", b"schedule_time", "search_attributes", b"search_attributes"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id", b"activity_id", "activity_type", b"activity_type", "close_time", b"close_time", "execution_duration", b"execution_duration", "execution_time", b"execution_time", "run_id", b"run_id", "schedule_time", b"schedule_time", "search_attributes", b"search_attributes", "state_size_bytes", b"state_size_bytes", "state_transition_count", b"state_transition_count", "status", b"status", "task_queue", b"task_queue"]) -> None: ...
...
class CallbackInfo(google.protobuf.message.Message):
    ...
    class Trigger(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["activity_closed", b"activity_closed", "variant", b"variant"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["activity_closed", b"activity_closed", "variant", b"variant"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["activity_closed"] | None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["info", b"info", "trigger", b"trigger"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["info", b"info", "trigger", b"trigger"]) -> None: ...
