...
_BATCHOPERATIONTERMINATION = DESCRIPTOR.message_types_by_name['BatchOperationTermination']
_BATCHOPERATIONTERMINATEACTIVITIES = DESCRIPTOR.message_types_by_name['BatchOperationTerminateActivities']
_BATCHOPERATIONSIGNAL = DESCRIPTOR.message_types_by_name['BatchOperationSignal']
_BATCHOPERATIONCANCELLATION = DESCRIPTOR.message_types_by_name['BatchOperationCancellation']
_BATCHOPERATIONCANCELACTIVITIES = DESCRIPTOR.message_types_by_name['BatchOperationCancelActivities']
_BATCHOPERATIONDELETION = DESCRIPTOR.message_types_by_name['BatchOperationDeletion']
_BATCHOPERATIONDELETEACTIVITIES = DESCRIPTOR.message_types_by_name['BatchOperationDeleteActivities']
_BATCHOPERATIONRESET = DESCRIPTOR.message_types_by_name['BatchOperationReset']
_BATCHOPERATIONUPDATEWORKFLOWEXECUTIONOPTIONS = DESCRIPTOR.message_types_by_name['BatchOperationUpdateWorkflowExecutionOptions']
_BATCHOPERATIONUNPAUSEACTIVITIES = DESCRIPTOR.message_types_by_name['BatchOperationUnpauseActivities']
_BATCHOPERATIONTRIGGERWORKFLOWRULE = DESCRIPTOR.message_types_by_name['BatchOperationTriggerWorkflowRule']
_BATCHOPERATIONRESETACTIVITIES = DESCRIPTOR.message_types_by_name['BatchOperationResetActivities']
_BATCHOPERATIONUPDATEACTIVITYOPTIONS = DESCRIPTOR.message_types_by_name['BatchOperationUpdateActivityOptions']
BatchOperationInfo = _reflection.GeneratedProtocolMessageType('BatchOperationInfo', (_message.Message,), {
...
BatchOperationTermination = _reflection.GeneratedProtocolMessageType('BatchOperationTermination', (_message.Message,), {
...
BatchOperationTerminateActivities = _reflection.GeneratedProtocolMessageType('BatchOperationTerminateActivities', (_message.Message,), {
...
BatchOperationSignal = _reflection.GeneratedProtocolMessageType('BatchOperationSignal', (_message.Message,), {
...
BatchOperationCancellation = _reflection.GeneratedProtocolMessageType('BatchOperationCancellation', (_message.Message,), {
...
BatchOperationCancelActivities = _reflection.GeneratedProtocolMessageType('BatchOperationCancelActivities', (_message.Message,), {
...
BatchOperationDeletion = _reflection.GeneratedProtocolMessageType('BatchOperationDeletion', (_message.Message,), {
...
BatchOperationDeleteActivities = _reflection.GeneratedProtocolMessageType('BatchOperationDeleteActivities', (_message.Message,), {
...
BatchOperationReset = _reflection.GeneratedProtocolMessageType('BatchOperationReset', (_message.Message,), {
...
BatchOperationUpdateWorkflowExecutionOptions = _reflection.GeneratedProtocolMessageType('BatchOperationUpdateWorkflowExecutionOptions', (_message.Message,), {
...
BatchOperationUnpauseActivities = _reflection.GeneratedProtocolMessageType('BatchOperationUnpauseActivities', (_message.Message,), {
...
BatchOperationTriggerWorkflowRule = _reflection.GeneratedProtocolMessageType('BatchOperationTriggerWorkflowRule', (_message.Message,), {
...
BatchOperationResetActivities = _reflection.GeneratedProtocolMessageType('BatchOperationResetActivities', (_message.Message,), {
...
BatchOperationUpdateActivityOptions = _reflection.GeneratedProtocolMessageType('BatchOperationUpdateActivityOptions', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BATCHOPERATIONRESET.fields_by_name['reset_reapply_type']._serialized_options = b'\030\001'
