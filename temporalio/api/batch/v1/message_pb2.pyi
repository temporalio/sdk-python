...
class BatchOperationInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["close_time", b"close_time", "job_id", b"job_id", "operation_type", b"operation_type", "start_time", b"start_time", "state", b"state"]) -> None: ...
...
class BatchOperationTermination(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["details", b"details", "identity", b"identity"]) -> None: ...
...
class BatchOperationSignal(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["header", b"header", "identity", b"identity", "input", b"input", "signal", b"signal"]) -> None: ...
...
class BatchOperationReset(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "options", b"options", "post_reset_operations", b"post_reset_operations", "reset_reapply_type", b"reset_reapply_type", "reset_type", b"reset_type"]) -> None: ...
...
class BatchOperationUpdateWorkflowExecutionOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "update_mask", b"update_mask", "workflow_execution_options", b"workflow_execution_options"]) -> None: ...

global___BatchOperationUpdateWorkflowExecutionOptions = BatchOperationUpdateWorkflowExecutionOptions
...
class BatchOperationUnpauseActivities(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["activity", b"activity", "jitter", b"jitter", "match_all", b"match_all", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity", b"activity", "identity", b"identity", "jitter", b"jitter", "match_all", b"match_all", "reset_attempts", b"reset_attempts", "reset_heartbeat", b"reset_heartbeat", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["activity", b"activity"]) -> typing_extensions.Literal["type", "match_all"] | None: ...
...
class BatchOperationTriggerWorkflowRule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["id", b"id", "rule", b"rule", "spec", b"spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "identity", b"identity", "rule", b"rule", "spec", b"spec"]) -> None: ...
...
class BatchOperationResetActivities(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["activity", b"activity", "jitter", b"jitter", "match_all", b"match_all", "type", b"type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity", b"activity", "identity", b"identity", "jitter", b"jitter", "keep_paused", b"keep_paused", "match_all", b"match_all", "reset_attempts", b"reset_attempts", "reset_heartbeat", b"reset_heartbeat", "restore_original_options", b"restore_original_options", "type", b"type"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["activity", b"activity"]) -> typing_extensions.Literal["type", "match_all"] | None: ...
...
class BatchOperationUpdateActivityOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["activity", b"activity", "activity_options", b"activity_options", "match_all", b"match_all", "type", b"type", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity", b"activity", "activity_options", b"activity_options", "identity", b"identity", "match_all", b"match_all", "restore_original", b"restore_original", "type", b"type", "update_mask", b"update_mask"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["activity", b"activity"]) -> typing_extensions.Literal["type", "match_all"] | None: ...
