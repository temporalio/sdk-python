...
class AuditLogSink(google.protobuf.message.Message):
    ...
    class _HealthEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[AuditLogSink._Health.ValueType], builtins.type):  # noqa: F821
    ...
    def HasField(self, field_name: typing_extensions.Literal["last_succeeded_time", b"last_succeeded_time", "spec", b"spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["error_message", b"error_message", "health", b"health", "last_succeeded_time", b"last_succeeded_time", "name", b"name", "resource_version", b"resource_version", "spec", b"spec", "state", b"state"]) -> None: ...
