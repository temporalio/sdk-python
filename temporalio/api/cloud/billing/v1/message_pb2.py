...
_BILLINGREPORTSPEC_BILLINGREPORTGRANULARITY = _BILLINGREPORTSPEC.enum_types_by_name['BillingReportGranularity']
...
BillingReportSpec = _reflection.GeneratedProtocolMessageType('BillingReportSpec', (_message.Message,), {
...
BillingReport = _reflection.GeneratedProtocolMessageType('BillingReport', (_message.Message,), {
