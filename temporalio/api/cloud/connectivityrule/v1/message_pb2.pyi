...
class ConnectivityRule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_time", b"created_time", "spec", b"spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["async_operation_id", b"async_operation_id", "created_time", b"created_time", "id", b"id", "resource_version", b"resource_version", "spec", b"spec", "state", b"state"]) -> None: ...
...
class ConnectivityRuleSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["connection_type", b"connection_type", "private_rule", b"private_rule", "public_rule", b"public_rule"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["connection_type", b"connection_type", "private_rule", b"private_rule", "public_rule", b"public_rule"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["connection_type", b"connection_type"]) -> typing_extensions.Literal["public_rule", "private_rule"] | None: ...
...
class PublicConnectivityRule(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["enable_stable_ips", b"enable_stable_ips"]) -> None: ...
...
class PrivateConnectivityRule(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["connection_id", b"connection_id", "gcp_project_id", b"gcp_project_id", "region", b"region"]) -> None: ...
