...
_USERNAMESPACEASSIGNMENT = DESCRIPTOR.message_types_by_name['UserNamespaceAssignment']
_SERVICEACCOUNTNAMESPACEASSIGNMENT = DESCRIPTOR.message_types_by_name['ServiceAccountNamespaceAssignment']
_USERGROUPNAMESPACEASSIGNMENT = DESCRIPTOR.message_types_by_name['UserGroupNamespaceAssignment']
...
NamespaceAccess = _reflection.GeneratedProtocolMessageType('NamespaceAccess', (_message.Message,), {
...
Access = _reflection.GeneratedProtocolMessageType('Access', (_message.Message,), {
  ...
  'NamespaceAccessesEntry' : _reflection.GeneratedProtocolMessageType('NamespaceAccessesEntry', (_message.Message,), {
...
NamespaceScopedAccess = _reflection.GeneratedProtocolMessageType('NamespaceScopedAccess', (_message.Message,), {
...
GoogleGroupSpec = _reflection.GeneratedProtocolMessageType('GoogleGroupSpec', (_message.Message,), {
...
SCIMGroupSpec = _reflection.GeneratedProtocolMessageType('SCIMGroupSpec', (_message.Message,), {
...
CloudGroupSpec = _reflection.GeneratedProtocolMessageType('CloudGroupSpec', (_message.Message,), {
...
UserGroupSpec = _reflection.GeneratedProtocolMessageType('UserGroupSpec', (_message.Message,), {
...
UserGroupMemberId = _reflection.GeneratedProtocolMessageType('UserGroupMemberId', (_message.Message,), {
...
UserGroupMember = _reflection.GeneratedProtocolMessageType('UserGroupMember', (_message.Message,), {
...
ServiceAccountSpec = _reflection.GeneratedProtocolMessageType('ServiceAccountSpec', (_message.Message,), {
...
ApiKeySpec = _reflection.GeneratedProtocolMessageType('ApiKeySpec', (_message.Message,), {
...
CustomRoleSpec = _reflection.GeneratedProtocolMessageType('CustomRoleSpec', (_message.Message,), {
...
UserNamespaceAssignment = _reflection.GeneratedProtocolMessageType('UserNamespaceAssignment', (_message.Message,), {
  'DESCRIPTOR' : _USERNAMESPACEASSIGNMENT,
  '__module__' : 'temporalio.api.cloud.identity.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.cloud.identity.v1.UserNamespaceAssignment)
  })
_sym_db.RegisterMessage(UserNamespaceAssignment)

ServiceAccountNamespaceAssignment = _reflection.GeneratedProtocolMessageType('ServiceAccountNamespaceAssignment', (_message.Message,), {
  'DESCRIPTOR' : _SERVICEACCOUNTNAMESPACEASSIGNMENT,
  '__module__' : 'temporalio.api.cloud.identity.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.cloud.identity.v1.ServiceAccountNamespaceAssignment)
  })
_sym_db.RegisterMessage(ServiceAccountNamespaceAssignment)

UserGroupNamespaceAssignment = _reflection.GeneratedProtocolMessageType('UserGroupNamespaceAssignment', (_message.Message,), {
  'DESCRIPTOR' : _USERGROUPNAMESPACEASSIGNMENT,
  '__module__' : 'temporalio.api.cloud.identity.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.cloud.identity.v1.UserGroupNamespaceAssignment)
  })
_sym_db.RegisterMessage(UserGroupNamespaceAssignment)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _NAMESPACEACCESS.fields_by_name['permission_deprecated']._serialized_options = b'\030\001'
  ...
  _APIKEYSPEC.fields_by_name['owner_type_deprecated']._serialized_options = b'\030\001'
  _OWNERTYPE._serialized_start=4969
  _OWNERTYPE._serialized_end=5061
  ...
  _USERNAMESPACEASSIGNMENT._serialized_start=4403
  _USERNAMESPACEASSIGNMENT._serialized_end=4582
  _SERVICEACCOUNTNAMESPACEASSIGNMENT._serialized_start=4585
  _SERVICEACCOUNTNAMESPACEASSIGNMENT._serialized_end=4773
  _USERGROUPNAMESPACEASSIGNMENT._serialized_start=4776
  _USERGROUPNAMESPACEASSIGNMENT._serialized_end=4967
