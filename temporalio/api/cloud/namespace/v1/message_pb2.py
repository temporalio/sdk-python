...
from temporalio.api.cloud.sink.v1 import message_pb2 as temporal_dot_api_dot_cloud_dot_sink_dot_v1_dot_message__pb2
...
_CODECSERVERSPEC_CUSTOMERRORMESSAGE = _CODECSERVERSPEC.nested_types_by_name['CustomErrorMessage']
_CODECSERVERSPEC_CUSTOMERRORMESSAGE_ERRORMESSAGE = _CODECSERVERSPEC_CUSTOMERRORMESSAGE.nested_types_by_name['ErrorMessage']
_HIGHAVAILABILITYSPEC = DESCRIPTOR.message_types_by_name['HighAvailabilitySpec']
_REPLICASPEC = DESCRIPTOR.message_types_by_name['ReplicaSpec']
...
_FAIRNESSSPEC = DESCRIPTOR.message_types_by_name['FairnessSpec']
_NAMESPACESPEC = DESCRIPTOR.message_types_by_name['NamespaceSpec']
_NAMESPACESPEC_CUSTOMSEARCHATTRIBUTESENTRY = _NAMESPACESPEC.nested_types_by_name['CustomSearchAttributesEntry']
_NAMESPACESPEC_SEARCHATTRIBUTESENTRY = _NAMESPACESPEC.nested_types_by_name['SearchAttributesEntry']
...
_NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS = _NAMESPACECAPACITYINFO.nested_types_by_name['CapacityModeOptions']
_NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS_PROVISIONED = _NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS.nested_types_by_name['Provisioned']
_NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS_ONDEMAND = _NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS.nested_types_by_name['OnDemand']
_NAMESPACECAPACITYINFO_STATS = _NAMESPACECAPACITYINFO.nested_types_by_name['Stats']
_NAMESPACECAPACITYINFO_STATS_SUMMARY = _NAMESPACECAPACITYINFO_STATS.nested_types_by_name['Summary']
_REPLICA_REPLICASTATE = _REPLICA.enum_types_by_name['ReplicaState']
_CAPACITY_REQUEST_STATE = _CAPACITY_REQUEST.enum_types_by_name['State']
_NAMESPACESPEC_SEARCHATTRIBUTETYPE = _NAMESPACESPEC.enum_types_by_name['SearchAttributeType']
...
CertificateFilterSpec = _reflection.GeneratedProtocolMessageType('CertificateFilterSpec', (_message.Message,), {
...
MtlsAuthSpec = _reflection.GeneratedProtocolMessageType('MtlsAuthSpec', (_message.Message,), {
...
ApiKeyAuthSpec = _reflection.GeneratedProtocolMessageType('ApiKeyAuthSpec', (_message.Message,), {
...
LifecycleSpec = _reflection.GeneratedProtocolMessageType('LifecycleSpec', (_message.Message,), {
...
CodecServerSpec = _reflection.GeneratedProtocolMessageType('CodecServerSpec', (_message.Message,), {

  'CustomErrorMessage' : _reflection.GeneratedProtocolMessageType('CustomErrorMessage', (_message.Message,), {
...
HighAvailabilitySpec = _reflection.GeneratedProtocolMessageType('HighAvailabilitySpec', (_message.Message,), {
...
ReplicaSpec = _reflection.GeneratedProtocolMessageType('ReplicaSpec', (_message.Message,), {
  'DESCRIPTOR' : _REPLICASPEC,
  '__module__' : 'temporalio.api.cloud.namespace.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.cloud.namespace.v1.ReplicaSpec)
  })
_sym_db.RegisterMessage(ReplicaSpec)

Replica = _reflection.GeneratedProtocolMessageType('Replica', (_message.Message,), {
  'DESCRIPTOR' : _REPLICA,
  '__module__' : 'temporalio.api.cloud.namespace.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.cloud.namespace.v1.Replica)
  })
_sym_db.RegisterMessage(Replica)

CapacitySpec = _reflection.GeneratedProtocolMessageType('CapacitySpec', (_message.Message,), {
  ...
  'Provisioned' : _reflection.GeneratedProtocolMessageType('Provisioned', (_message.Message,), {
...
FairnessSpec = _reflection.GeneratedProtocolMessageType('FairnessSpec', (_message.Message,), {
  'DESCRIPTOR' : _FAIRNESSSPEC,
  '__module__' : 'temporalio.api.cloud.namespace.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.cloud.namespace.v1.FairnessSpec)
  })
_sym_db.RegisterMessage(FairnessSpec)

NamespaceSpec = _reflection.GeneratedProtocolMessageType('NamespaceSpec', (_message.Message,), {

  'CustomSearchAttributesEntry' : _reflection.GeneratedProtocolMessageType('CustomSearchAttributesEntry', (_message.Message,), {
...
AWSPrivateLinkInfo = _reflection.GeneratedProtocolMessageType('AWSPrivateLinkInfo', (_message.Message,), {
...
Namespace = _reflection.GeneratedProtocolMessageType('Namespace', (_message.Message,), {
  ...
  'RegionStatusEntry' : _reflection.GeneratedProtocolMessageType('RegionStatusEntry', (_message.Message,), {
...
NamespaceRegionStatus = _reflection.GeneratedProtocolMessageType('NamespaceRegionStatus', (_message.Message,), {
...
ExportSinkSpec = _reflection.GeneratedProtocolMessageType('ExportSinkSpec', (_message.Message,), {
...
ExportSink = _reflection.GeneratedProtocolMessageType('ExportSink', (_message.Message,), {
...
NamespaceCapacityInfo = _reflection.GeneratedProtocolMessageType('NamespaceCapacityInfo', (_message.Message,), {

  'CapacityModeOptions' : _reflection.GeneratedProtocolMessageType('CapacityModeOptions', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MTLSAUTHSPEC.fields_by_name['accepted_client_ca_deprecated']._serialized_options = b'\030\001'
  ...
  _NAMESPACESPEC.fields_by_name['regions']._options = None
  _NAMESPACESPEC.fields_by_name['regions']._serialized_options = b'\030\001'
  _NAMESPACESPEC.fields_by_name['custom_search_attributes']._options = None
  _NAMESPACESPEC.fields_by_name['custom_search_attributes']._serialized_options = b'\030\001'
  ...
  _NAMESPACE.fields_by_name['region_status']._options = None
  _NAMESPACE.fields_by_name['region_status']._serialized_options = b'\030\001'
  _NAMESPACEREGIONSTATUS.fields_by_name['state_deprecated']._options = None
  _NAMESPACEREGIONSTATUS.fields_by_name['state_deprecated']._serialized_options = b'\030\001'
  ...
  _HIGHAVAILABILITYSPEC._serialized_end=1139
  _REPLICASPEC._serialized_start=1141
  _REPLICASPEC._serialized_end=1170
  _REPLICA._serialized_start=1173
  _REPLICA._serialized_end=1454
  _REPLICA_REPLICASTATE._serialized_start=1303
  _REPLICA_REPLICASTATE._serialized_end=1454
  _CAPACITYSPEC._serialized_start=1457
  _CAPACITYSPEC._serialized_end=1680
  _CAPACITYSPEC_ONDEMAND._serialized_start=1632
  _CAPACITYSPEC_ONDEMAND._serialized_end=1642
  _CAPACITYSPEC_PROVISIONED._serialized_start=1644
  _CAPACITYSPEC_PROVISIONED._serialized_end=1672
  _CAPACITY._serialized_start=1683
  _CAPACITY._serialized_end=2415
  _CAPACITY_ONDEMAND._serialized_start=1632
  _CAPACITY_ONDEMAND._serialized_end=1642
  _CAPACITY_PROVISIONED._serialized_start=1933
  _CAPACITY_PROVISIONED._serialized_end=1969
  _CAPACITY_REQUEST._serialized_start=1972
  _CAPACITY_REQUEST._serialized_end=2399
  _CAPACITY_REQUEST_STATE._serialized_start=2239
  _CAPACITY_REQUEST_STATE._serialized_end=2399
  _FAIRNESSSPEC._serialized_start=2417
  _FAIRNESSSPEC._serialized_end=2468
  _NAMESPACESPEC._serialized_start=2471
  _NAMESPACESPEC._serialized_end=3835
  _NAMESPACESPEC_CUSTOMSEARCHATTRIBUTESENTRY._serialized_start=3346
  _NAMESPACESPEC_CUSTOMSEARCHATTRIBUTESENTRY._serialized_end=3407
  _NAMESPACESPEC_SEARCHATTRIBUTESENTRY._serialized_start=3409
  _NAMESPACESPEC_SEARCHATTRIBUTESENTRY._serialized_end=3532
  _NAMESPACESPEC_SEARCHATTRIBUTETYPE._serialized_start=3535
  _NAMESPACESPEC_SEARCHATTRIBUTETYPE._serialized_end=3835
  _ENDPOINTS._serialized_start=3837
  _ENDPOINTS._serialized_end=3918
  _LIMITS._serialized_start=3920
  _LIMITS._serialized_end=3962
  _AWSPRIVATELINKINFO._serialized_start=3964
  _AWSPRIVATELINKINFO._serialized_end=4052
  _PRIVATECONNECTIVITY._serialized_start=4054
  _PRIVATECONNECTIVITY._serialized_end=4170
  _NAMESPACE._serialized_start=4173
  _NAMESPACE._serialized_end=5264
  _NAMESPACE_REGIONSTATUSENTRY._serialized_start=5112
  _NAMESPACE_REGIONSTATUSENTRY._serialized_end=5219
  _NAMESPACE_TAGSENTRY._serialized_start=5221
  _NAMESPACE_TAGSENTRY._serialized_end=5264
  _NAMESPACEREGIONSTATUS._serialized_start=5267
  _NAMESPACEREGIONSTATUS._serialized_end=5550
  _NAMESPACEREGIONSTATUS_STATE._serialized_start=5427
  _NAMESPACEREGIONSTATUS_STATE._serialized_end=5550
  _EXPORTSINKSPEC._serialized_start=5553
  _EXPORTSINKSPEC._serialized_end=5698
  _EXPORTSINK._serialized_start=5701
  _EXPORTSINK._serialized_end=6203
  _EXPORTSINK_HEALTH._serialized_start=6092
  _EXPORTSINK_HEALTH._serialized_end=6203
  _NAMESPACECAPACITYINFO._serialized_start=6206
  _NAMESPACECAPACITYINFO._serialized_end=7005
  _NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS._serialized_start=6522
  _NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS._serialized_end=6861
  _NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS_PROVISIONED._serialized_start=6758
  _NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS_PROVISIONED._serialized_end=6830
  _NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS_ONDEMAND._serialized_start=6832
  _NAMESPACECAPACITYINFO_CAPACITYMODEOPTIONS_ONDEMAND._serialized_end=6861
  _NAMESPACECAPACITYINFO_STATS._serialized_start=6864
  _NAMESPACECAPACITYINFO_STATS._serialized_end=7005
  _NAMESPACECAPACITYINFO_STATS_SUMMARY._serialized_start=6956
  _NAMESPACECAPACITYINFO_STATS_SUMMARY._serialized_end=7005
