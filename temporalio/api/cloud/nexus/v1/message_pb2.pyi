...
class EndpointSpec(google.protobuf.message.Message):
    ...
    @property
    def policy_specs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___EndpointPolicySpec]:
    ...
    def __init__(
        ...
        *,
        ...
        policy_specs: collections.abc.Iterable[global___EndpointPolicySpec] | None = ...,
        description_deprecated: builtins.str = ...,
        description: temporalio.api.common.v1.message_pb2.Payload | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["description", b"description", "target_spec", b"target_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["description", b"description", "description_deprecated", b"description_deprecated", "name", b"name", "policy_specs", b"policy_specs", "target_spec", b"target_spec"]) -> None: ...
...
class EndpointTargetSpec(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["variant", b"variant", "worker_target_spec", b"worker_target_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["variant", b"variant", "worker_target_spec", b"worker_target_spec"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["worker_target_spec"] | None: ...
...
class WorkerTargetSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace_id", b"namespace_id", "task_queue", b"task_queue"]) -> None: ...
...
class EndpointPolicySpec(google.protobuf.message.Message):
    ...
    @property
    def allowed_cloud_namespace_policy_spec(self) -> global___AllowedCloudNamespacePolicySpec:
        """A policy spec that allows one caller namespace to access the endpoint."""
    def __init__(
        self,
        *,
        allowed_cloud_namespace_policy_spec: global___AllowedCloudNamespacePolicySpec | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["allowed_cloud_namespace_policy_spec", b"allowed_cloud_namespace_policy_spec", "variant", b"variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["allowed_cloud_namespace_policy_spec", b"allowed_cloud_namespace_policy_spec", "variant", b"variant"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["allowed_cloud_namespace_policy_spec"] | None: ...
