...
S3Spec = _reflection.GeneratedProtocolMessageType('S3Spec', (_message.Message,), {
  'DESCRIPTOR' : _S3SPEC,
...
GCSSpec = _reflection.GeneratedProtocolMessageType('GCSSpec', (_message.Message,), {
  'DESCRIPTOR' : _GCSSPEC,
  '__module__' : 'temporalio.api.cloud.sink.v1.message_pb2'
...
KinesisSpec = _reflection.GeneratedProtocolMessageType('KinesisSpec', (_message.Message,), {
...
PubSubSpec = _reflection.GeneratedProtocolMessageType('PubSubSpec', (_message.Message,), {
