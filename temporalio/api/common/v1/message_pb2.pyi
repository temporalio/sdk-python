...
class Payload(google.protobuf.message.Message):
    ...
    class ExternalPayloadDetails(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["size_bytes", b"size_bytes"]) -> None: ...
    ...
    data: builtins.bytes
    @property
    def external_payloads(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Payload.ExternalPayloadDetails]:
    ...
    def __init__(
        ...
        *,
        ...
        data: builtins.bytes = ...,
        external_payloads: collections.abc.Iterable[global___Payload.ExternalPayloadDetails] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["data", b"data", "external_payloads", b"external_payloads", "metadata", b"metadata"]) -> None: ...
...
class SearchAttributes(google.protobuf.message.Message):
    ...
    @property
    def indexed_fields(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___Payload]: ...
    def __init__(
        self,
        *,
        indexed_fields: collections.abc.Mapping[builtins.str, global___Payload] | None = ...,
    ) -> None: ...
...
class Memo(google.protobuf.message.Message):
    ...
    @property
    def fields(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___Payload]: ...
    def __init__(
        self,
        *,
...
class Execution(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["business_id", b"business_id", "run_id", b"run_id", "type", b"type"]) -> None: ...
...
class RetryPolicy(google.protobuf.message.Message):
    ...
    """
    @property
    def non_retryable_error_types(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
...
class MeteringMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["nonfirst_local_activity_execution_attempts", b"nonfirst_local_activity_execution_attempts"]) -> None: ...
...
class WorkerVersionStamp(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["build_id", b"build_id", "use_versioning", b"use_versioning"]) -> None: ...
...
class WorkerVersionCapabilities(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["build_id", b"build_id", "deployment_series_name", b"deployment_series_name", "use_versioning", b"use_versioning"]) -> None: ...
...
class ResetOptions(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["build_id", b"build_id", "first_workflow_task", b"first_workflow_task", "last_workflow_task", b"last_workflow_task", "target", b"target", "workflow_task_id", b"workflow_task_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["build_id", b"build_id", "current_run_only", b"current_run_only", "first_workflow_task", b"first_workflow_task", "last_workflow_task", b"last_workflow_task", "reset_reapply_exclude_types", b"reset_reapply_exclude_types", "reset_reapply_type", b"reset_reapply_type", "target", b"target", "workflow_task_id", b"workflow_task_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["target", b"target"]) -> typing_extensions.Literal["first_workflow_task", "last_workflow_task", "workflow_task_id", "build_id"] | None: ...
...
class Callback(google.protobuf.message.Message):
    ...
    class Nexus(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["header", b"header", "url", b"url"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["internal", b"internal", "nexus", b"nexus", "variant", b"variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["internal", b"internal", "links", b"links", "nexus", b"nexus", "variant", b"variant"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["nexus", "internal"] | None: ...
...
class Link(google.protobuf.message.Message):
    ...
    class WorkflowEvent(google.protobuf.message.Message):
        ...
        class EventReference(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal["event_id", b"event_id", "event_type", b"event_type"]) -> None: ...
        ...
        class RequestIdReference(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal["event_type", b"event_type", "request_id", b"request_id"]) -> None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal["event_ref", b"event_ref", "reference", b"reference", "request_id_ref", b"request_id_ref"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["event_ref", b"event_ref", "namespace", b"namespace", "reference", b"reference", "request_id_ref", b"request_id_ref", "run_id", b"run_id", "workflow_id", b"workflow_id"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["reference", b"reference"]) -> typing_extensions.Literal["event_ref", "request_id_ref"] | None: ...
    ...
    class Workflow(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["namespace", b"namespace", "reason", b"reason", "run_id", b"run_id", "workflow_id", b"workflow_id"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["activity", b"activity", "batch_job", b"batch_job", "nexus_operation", b"nexus_operation", "variant", b"variant", "workflow", b"workflow", "workflow_event", b"workflow_event"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity", b"activity", "batch_job", b"batch_job", "nexus_operation", b"nexus_operation", "variant", b"variant", "workflow", b"workflow", "workflow_event", b"workflow_event"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["workflow_event", "batch_job", "activity", "nexus_operation", "workflow"] | None: ...
...
class Priority(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["fairness_key", b"fairness_key", "fairness_weight", b"fairness_weight", "priority_key", b"priority_key"]) -> None: ...
...
class WorkerSelector(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["selector", b"selector", "worker_instance_key", b"worker_instance_key"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["selector", b"selector", "worker_instance_key", b"worker_instance_key"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["selector", b"selector"]) -> typing_extensions.Literal["worker_instance_key"] | None: ...
...
class TimeSkippingStatePropagation(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["fast_forward_target_time", b"fast_forward_target_time", "initial_skipped_duration", b"initial_skipped_duration"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["fast_forward_target_time", b"fast_forward_target_time", "initial_skip_count", b"initial_skip_count", "initial_skipped_duration", b"initial_skipped_duration"]) -> None: ...
...
class TimeSkippingFastForwardInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["fast_forward_duration", b"fast_forward_duration", "target_time", b"target_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["fast_forward_duration", b"fast_forward_duration", "fast_forward_id", b"fast_forward_id", "has_completed", b"has_completed", "target_time", b"target_time"]) -> None: ...
