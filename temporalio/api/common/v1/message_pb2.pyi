...
class Link(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["batch_job", b"batch_job", "variant", b"variant", "workflow_event", b"workflow_event"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["batch_job", b"batch_job", "variant", b"variant", "workflow_event", b"workflow_event"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["workflow_event", "batch_job"] | None: ...
