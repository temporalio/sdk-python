...
from temporalio.api.compute.v1 import provider_pb2 as temporal_dot_api_dot_compute_dot_v1_dot_provider__pb2
from temporalio.api.compute.v1 import scaler_pb2 as temporal_dot_api_dot_compute_dot_v1_dot_scaler__pb2
...
_COMPUTECONFIGSCALINGGROUP = DESCRIPTOR.message_types_by_name['ComputeConfigScalingGroup']
_COMPUTECONFIG = DESCRIPTOR.message_types_by_name['ComputeConfig']
_COMPUTECONFIG_SCALINGGROUPSENTRY = _COMPUTECONFIG.nested_types_by_name['ScalingGroupsEntry']
_COMPUTECONFIGSCALINGGROUPUPDATE = DESCRIPTOR.message_types_by_name['ComputeConfigScalingGroupUpdate']
_COMPUTECONFIGSUMMARY = DESCRIPTOR.message_types_by_name['ComputeConfigSummary']
_COMPUTECONFIGSUMMARY_SCALINGGROUPSENTRY = _COMPUTECONFIGSUMMARY.nested_types_by_name['ScalingGroupsEntry']
_COMPUTECONFIGSCALINGGROUPSUMMARY = DESCRIPTOR.message_types_by_name['ComputeConfigScalingGroupSummary']
ComputeConfigScalingGroup = _reflection.GeneratedProtocolMessageType('ComputeConfigScalingGroup', (_message.Message,), {
...
ComputeConfig = _reflection.GeneratedProtocolMessageType('ComputeConfig', (_message.Message,), {
  ...
  'ScalingGroupsEntry' : _reflection.GeneratedProtocolMessageType('ScalingGroupsEntry', (_message.Message,), {
...
ComputeConfigScalingGroupUpdate = _reflection.GeneratedProtocolMessageType('ComputeConfigScalingGroupUpdate', (_message.Message,), {
...
ComputeConfigSummary = _reflection.GeneratedProtocolMessageType('ComputeConfigSummary', (_message.Message,), {
...
ComputeConfigScalingGroupSummary = _reflection.GeneratedProtocolMessageType('ComputeConfigScalingGroupSummary', (_message.Message,), {
