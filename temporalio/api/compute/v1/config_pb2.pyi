...
class ComputeConfigScalingGroup(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["provider", b"provider", "scaler", b"scaler"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["provider", b"provider", "scaler", b"scaler", "task_queue_types", b"task_queue_types"]) -> None: ...
...
class ComputeConfig(google.protobuf.message.Message):
    ...
    @property
    def scaling_groups(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___ComputeConfigScalingGroup]:
    ...
    def __init__(
        self,
        *,
        scaling_groups: collections.abc.Mapping[builtins.str, global___ComputeConfigScalingGroup] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["scaling_groups", b"scaling_groups"]) -> None: ...
...
class ComputeConfigScalingGroupUpdate(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["scaling_group", b"scaling_group", "update_mask", b"update_mask"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["scaling_group", b"scaling_group", "update_mask", b"update_mask"]) -> None: ...
...
class ComputeConfigSummary(google.protobuf.message.Message):
    ...
    SCALING_GROUPS_FIELD_NUMBER: builtins.int
    @property
    def scaling_groups(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___ComputeConfigScalingGroupSummary]: ...
    def __init__(
        self,
        *,
        scaling_groups: collections.abc.Mapping[builtins.str, global___ComputeConfigScalingGroupSummary] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["scaling_groups", b"scaling_groups"]) -> None: ...
...
class ComputeConfigScalingGroupSummary(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["provider_type", b"provider_type", "task_queue_types", b"task_queue_types"]) -> None: ...
