...
_UPDATEDEPLOYMENTMETADATA_UPSERTENTRIESENTRY = _UPDATEDEPLOYMENTMETADATA.nested_types_by_name['UpsertEntriesEntry']
_DEPLOYMENTLISTINFO = DESCRIPTOR.message_types_by_name['DeploymentListInfo']
_WORKERDEPLOYMENTVERSIONINFO = DESCRIPTOR.message_types_by_name['WorkerDeploymentVersionInfo']
_WORKERDEPLOYMENTVERSIONINFO_VERSIONTASKQUEUEINFO = _WORKERDEPLOYMENTVERSIONINFO.nested_types_by_name['VersionTaskQueueInfo']
_VERSIONDRAINAGEINFO = DESCRIPTOR.message_types_by_name['VersionDrainageInfo']
_COMPUTESTATUS = DESCRIPTOR.message_types_by_name['ComputeStatus']
_COMPUTESTATUS_PROVIDERVALIDATIONSTATUS = _COMPUTESTATUS.nested_types_by_name['ProviderValidationStatus']
_WORKERDEPLOYMENTINFO = DESCRIPTOR.message_types_by_name['WorkerDeploymentInfo']
_WORKERDEPLOYMENTINFO_WORKERDEPLOYMENTVERSIONSUMMARY = _WORKERDEPLOYMENTINFO.nested_types_by_name['WorkerDeploymentVersionSummary']
...
_INHERITEDAUTOUPGRADEINFO = DESCRIPTOR.message_types_by_name['InheritedAutoUpgradeInfo']
WorkerDeploymentOptions = _reflection.GeneratedProtocolMessageType('WorkerDeploymentOptions', (_message.Message,), {
...
DeploymentInfo = _reflection.GeneratedProtocolMessageType('DeploymentInfo', (_message.Message,), {
  ...
  'TaskQueueInfo' : _reflection.GeneratedProtocolMessageType('TaskQueueInfo', (_message.Message,), {
...
UpdateDeploymentMetadata = _reflection.GeneratedProtocolMessageType('UpdateDeploymentMetadata', (_message.Message,), {
...
DeploymentListInfo = _reflection.GeneratedProtocolMessageType('DeploymentListInfo', (_message.Message,), {
...
WorkerDeploymentVersionInfo = _reflection.GeneratedProtocolMessageType('WorkerDeploymentVersionInfo', (_message.Message,), {

  'VersionTaskQueueInfo' : _reflection.GeneratedProtocolMessageType('VersionTaskQueueInfo', (_message.Message,), {
...
VersionDrainageInfo = _reflection.GeneratedProtocolMessageType('VersionDrainageInfo', (_message.Message,), {
...
ComputeStatus = _reflection.GeneratedProtocolMessageType('ComputeStatus', (_message.Message,), {
  ...
  'ProviderValidationStatus' : _reflection.GeneratedProtocolMessageType('ProviderValidationStatus', (_message.Message,), {
    'DESCRIPTOR' : _COMPUTESTATUS_PROVIDERVALIDATIONSTATUS,
    '__module__' : 'temporalio.api.deployment.v1.message_pb2'
    # @@protoc_insertion_point(class_scope:temporal.api.deployment.v1.ComputeStatus.ProviderValidationStatus)
    })
  ,
  'DESCRIPTOR' : _COMPUTESTATUS,
  '__module__' : 'temporalio.api.deployment.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.deployment.v1.ComputeStatus)
  })
_sym_db.RegisterMessage(ComputeStatus)
_sym_db.RegisterMessage(ComputeStatus.ProviderValidationStatus)

WorkerDeploymentInfo = _reflection.GeneratedProtocolMessageType('WorkerDeploymentInfo', (_message.Message,), {

  'WorkerDeploymentVersionSummary' : _reflection.GeneratedProtocolMessageType('WorkerDeploymentVersionSummary', (_message.Message,), {
...
WorkerDeploymentVersion = _reflection.GeneratedProtocolMessageType('WorkerDeploymentVersion', (_message.Message,), {
...
InheritedAutoUpgradeInfo = _reflection.GeneratedProtocolMessageType('InheritedAutoUpgradeInfo', (_message.Message,), {
  'DESCRIPTOR' : _INHERITEDAUTOUPGRADEINFO,
  '__module__' : 'temporalio.api.deployment.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.deployment.v1.InheritedAutoUpgradeInfo)
  })
_sym_db.RegisterMessage(InheritedAutoUpgradeInfo)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _WORKERDEPLOYMENTVERSIONINFO.fields_by_name['version']._serialized_options = b'\030\001'
  _WORKERDEPLOYMENTINFO_WORKERDEPLOYMENTVERSIONSUMMARY.fields_by_name['version']._options = None
  _WORKERDEPLOYMENTINFO_WORKERDEPLOYMENTVERSIONSUMMARY.fields_by_name['version']._serialized_options = b'\030\001'
  ...
  _WORKERDEPLOYMENTOPTIONS._serialized_start=300
  _WORKERDEPLOYMENTOPTIONS._serialized_end=445
  _DEPLOYMENT._serialized_start=447
  _DEPLOYMENT._serialized_end=498
  _DEPLOYMENTINFO._serialized_start=501
  _DEPLOYMENTINFO._serialized_end=1027
  _DEPLOYMENTINFO_METADATAENTRY._serialized_start=808
  _DEPLOYMENTINFO_METADATAENTRY._serialized_end=888
  _DEPLOYMENTINFO_TASKQUEUEINFO._serialized_start=891
  _DEPLOYMENTINFO_TASKQUEUEINFO._serialized_end=1027
  _UPDATEDEPLOYMENTMETADATA._serialized_start=1030
  _UPDATEDEPLOYMENTMETADATA._serialized_end=1264
  _UPDATEDEPLOYMENTMETADATA_UPSERTENTRIESENTRY._serialized_start=1179
  _UPDATEDEPLOYMENTMETADATA_UPSERTENTRIESENTRY._serialized_end=1264
  _DEPLOYMENTLISTINFO._serialized_start=1267
  _DEPLOYMENTLISTINFO._serialized_end=1416
  _WORKERDEPLOYMENTVERSIONINFO._serialized_start=1419
  _WORKERDEPLOYMENTVERSIONINFO._serialized_end=2488
  _WORKERDEPLOYMENTVERSIONINFO_VERSIONTASKQUEUEINFO._serialized_start=2400
  _WORKERDEPLOYMENTVERSIONINFO_VERSIONTASKQUEUEINFO._serialized_end=2488
  _VERSIONDRAINAGEINFO._serialized_start=2491
  _VERSIONDRAINAGEINFO._serialized_end=2684
  _COMPUTESTATUS._serialized_start=2687
  _COMPUTESTATUS._serialized_end=2903
  _COMPUTESTATUS_PROVIDERVALIDATIONSTATUS._serialized_start=2801
  _COMPUTESTATUS_PROVIDERVALIDATIONSTATUS._serialized_end=2903
  _WORKERDEPLOYMENTINFO._serialized_start=2906
  _WORKERDEPLOYMENTINFO._serialized_end=4190
  _WORKERDEPLOYMENTINFO_WORKERDEPLOYMENTVERSIONSUMMARY._serialized_start=3313
  _WORKERDEPLOYMENTINFO_WORKERDEPLOYMENTVERSIONSUMMARY._serialized_end=4190
  _WORKERDEPLOYMENTVERSION._serialized_start=4192
  _WORKERDEPLOYMENTVERSION._serialized_end=4260
  _VERSIONMETADATA._serialized_start=4263
  _VERSIONMETADATA._serialized_end=4436
  _VERSIONMETADATA_ENTRIESENTRY._serialized_start=4357
  _VERSIONMETADATA_ENTRIESENTRY._serialized_end=4436
  _ROUTINGCONFIG._serialized_start=4439
  _ROUTINGCONFIG._serialized_end=4960
  _INHERITEDAUTOUPGRADEINFO._serialized_start=4963
  _INHERITEDAUTOUPGRADEINFO._serialized_end=5229
