...
_COMPUTESTATUS_PROVIDERVALIDATIONSTATUS = _COMPUTESTATUS.nested_types_by_name[
...
ComputeStatus = _reflection.GeneratedProtocolMessageType(
    "ComputeStatus",
    (_message.Message,),
    {
        "ProviderValidationStatus": _reflection.GeneratedProtocolMessageType(
            "ProviderValidationStatus",
            (_message.Message,),
            {
...
InheritedAutoUpgradeInfo = _reflection.GeneratedProtocolMessageType(
