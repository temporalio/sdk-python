...
class WorkerDeploymentInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "last_modifier_identity", b"last_modifier_identity", "name", b"name", "routing_config", b"routing_config", "version_summaries", b"version_summaries"]) -> None: ...
