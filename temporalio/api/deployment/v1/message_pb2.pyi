...
class WorkerDeploymentOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["build_id", b"build_id", "deployment_name", b"deployment_name", "worker_versioning_mode", b"worker_versioning_mode"]) -> None: ...
...
class Deployment(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["build_id", b"build_id", "series_name", b"series_name"]) -> None: ...
...
class DeploymentInfo(google.protobuf.message.Message):
    ...
    class TaskQueueInfo(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["first_poller_time", b"first_poller_time"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["first_poller_time", b"first_poller_time", "name", b"name", "type", b"type"]) -> None: ...
    ...
    @property
    def task_queue_infos(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DeploymentInfo.TaskQueueInfo]: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        task_queue_infos: collections.abc.Iterable[global___DeploymentInfo.TaskQueueInfo] | None = ...,
        metadata: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ...,
        is_current: builtins.bool = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "deployment", b"deployment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "deployment", b"deployment", "is_current", b"is_current", "metadata", b"metadata", "task_queue_infos", b"task_queue_infos"]) -> None: ...
...
class UpdateDeploymentMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["remove_entries", b"remove_entries", "upsert_entries", b"upsert_entries"]) -> None: ...
...
class DeploymentListInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "deployment", b"deployment"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "deployment", b"deployment", "is_current", b"is_current"]) -> None: ...
...
class WorkerDeploymentVersionInfo(google.protobuf.message.Message):
    ...
    """
    @property
    def task_queue_infos(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___WorkerDeploymentVersionInfo.VersionTaskQueueInfo]:
    ...
    def __init__(
        ...
        *,
        ...
        ramp_percentage: builtins.float = ...,
        task_queue_infos: collections.abc.Iterable[global___WorkerDeploymentVersionInfo.VersionTaskQueueInfo] | None = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["compute_config", b"compute_config", "create_time", b"create_time", "current_since_time", b"current_since_time", "deployment_version", b"deployment_version", "drainage_info", b"drainage_info", "first_activation_time", b"first_activation_time", "last_current_time", b"last_current_time", "last_deactivation_time", b"last_deactivation_time", "metadata", b"metadata", "ramping_since_time", b"ramping_since_time", "routing_changed_time", b"routing_changed_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["compute_config", b"compute_config", "create_time", b"create_time", "current_since_time", b"current_since_time", "deployment_name", b"deployment_name", "deployment_version", b"deployment_version", "drainage_info", b"drainage_info", "first_activation_time", b"first_activation_time", "last_current_time", b"last_current_time", "last_deactivation_time", b"last_deactivation_time", "last_modifier_identity", b"last_modifier_identity", "metadata", b"metadata", "ramp_percentage", b"ramp_percentage", "ramping_since_time", b"ramping_since_time", "routing_changed_time", b"routing_changed_time", "status", b"status", "task_queue_infos", b"task_queue_infos", "version", b"version"]) -> None: ...
...
class VersionDrainageInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["last_changed_time", b"last_changed_time", "last_checked_time", b"last_checked_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["last_changed_time", b"last_changed_time", "last_checked_time", b"last_checked_time", "status", b"status"]) -> None: ...
...
class ComputeStatus(google.protobuf.message.Message):
    ...
    class ProviderValidationStatus(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["last_check_time", b"last_check_time"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["error_message", b"error_message", "last_check_time", b"last_check_time"]) -> None: ...
    ...
    def __init__(
        self,
        *,
        provider_validation: global___ComputeStatus.ProviderValidationStatus | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["provider_validation", b"provider_validation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["provider_validation", b"provider_validation"]) -> None: ...
...
class WorkerDeploymentInfo(google.protobuf.message.Message):
    ...
    class WorkerDeploymentVersionSummary(google.protobuf.message.Message):
        ...
        def last_deactivation_time(self) -> google.protobuf.timestamp_pb2.Timestamp:
            ...
            """
        @property
        def compute_config(self) -> temporalio.api.compute.v1.config_pb2.ComputeConfigSummary: ...
        @property
        ...
        def __init__(
            ...
            *,
            ...
            last_current_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
            last_deactivation_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
            compute_config: temporalio.api.compute.v1.config_pb2.ComputeConfigSummary | None = ...,
            compute_status: global___ComputeStatus | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["compute_config", b"compute_config", "compute_status", b"compute_status", "create_time", b"create_time", "current_since_time", b"current_since_time", "deployment_version", b"deployment_version", "drainage_info", b"drainage_info", "first_activation_time", b"first_activation_time", "last_current_time", b"last_current_time", "last_deactivation_time", b"last_deactivation_time", "ramping_since_time", b"ramping_since_time", "routing_update_time", b"routing_update_time"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["compute_config", b"compute_config", "compute_status", b"compute_status", "create_time", b"create_time", "current_since_time", b"current_since_time", "deployment_version", b"deployment_version", "drainage_info", b"drainage_info", "drainage_status", b"drainage_status", "first_activation_time", b"first_activation_time", "last_current_time", b"last_current_time", "last_deactivation_time", b"last_deactivation_time", "ramping_since_time", b"ramping_since_time", "routing_update_time", b"routing_update_time", "status", b"status", "version", b"version"]) -> None: ...
    ...
    def __init__(
        ...
        *,
        name: builtins.str = ...,
        version_summaries: collections.abc.Iterable[global___WorkerDeploymentInfo.WorkerDeploymentVersionSummary] | None = ...,
        create_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "routing_config", b"routing_config"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "last_modifier_identity", b"last_modifier_identity", "manager_identity", b"manager_identity", "name", b"name", "routing_config", b"routing_config", "routing_config_update_state", b"routing_config_update_state", "version_summaries", b"version_summaries"]) -> None: ...
...
class VersionMetadata(google.protobuf.message.Message):
    ...
    @property
    def entries(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, temporalio.api.common.v1.message_pb2.Payload]:
        """Arbitrary key-values."""
    def __init__(
        self,
        *,
        entries: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payload] | None = ...,
    ) -> None: ...
...
class RoutingConfig(google.protobuf.message.Message):
    ...
    @property
    def ramping_version_percentage_changed_time(self) -> google.protobuf.timestamp_pb2.Timestamp:
    ...
    def __init__(
        ...
        *,
        ...
        ramping_version: builtins.str = ...,
        ramping_version_percentage: builtins.float = ...,
        current_version_changed_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        ramping_version_changed_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        ramping_version_percentage_changed_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        revision_number: builtins.int = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["current_deployment_version", b"current_deployment_version", "current_version_changed_time", b"current_version_changed_time", "ramping_deployment_version", b"ramping_deployment_version", "ramping_version_changed_time", b"ramping_version_changed_time", "ramping_version_percentage_changed_time", b"ramping_version_percentage_changed_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["current_deployment_version", b"current_deployment_version", "current_version", b"current_version", "current_version_changed_time", b"current_version_changed_time", "ramping_deployment_version", b"ramping_deployment_version", "ramping_version", b"ramping_version", "ramping_version_changed_time", b"ramping_version_changed_time", "ramping_version_percentage", b"ramping_version_percentage", "ramping_version_percentage_changed_time", b"ramping_version_percentage_changed_time", "revision_number", b"revision_number"]) -> None: ...
...
class InheritedAutoUpgradeInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["source_deployment_version", b"source_deployment_version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["continue_as_new_initial_versioning_behavior", b"continue_as_new_initial_versioning_behavior", "source_deployment_revision_number", b"source_deployment_revision_number", "source_deployment_version", b"source_deployment_version"]) -> None: ...
