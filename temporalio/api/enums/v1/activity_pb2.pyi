...
class _ActivityExecutionStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ActivityExecutionStatus.ValueType], builtins.type):  # noqa: F821
...
class ActivityExecutionStatus(_ActivityExecutionStatus, metaclass=_ActivityExecutionStatusEnumTypeWrapper):
...
class _ActivityIdReusePolicyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ActivityIdReusePolicy.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    ACTIVITY_ID_REUSE_POLICY_ALLOW_DUPLICATE_FAILED_ONLY: _ActivityIdReusePolicy.ValueType  # 2
...
class ActivityIdReusePolicy(_ActivityIdReusePolicy, metaclass=_ActivityIdReusePolicyEnumTypeWrapper):
...
"""Always allow starting an activity using the same activity ID."""
ACTIVITY_ID_REUSE_POLICY_ALLOW_DUPLICATE_FAILED_ONLY: ActivityIdReusePolicy.ValueType  # 2
"""Allow starting an activity using the same ID only when the last activity's final state is one
of {failed, canceled, terminated, timed out}.
"""
...
class _ActivityIdConflictPolicyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ActivityIdConflictPolicy.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class ActivityIdConflictPolicy(_ActivityIdConflictPolicy, metaclass=_ActivityIdConflictPolicyEnumTypeWrapper):
