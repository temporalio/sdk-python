...
_PENDINGNEXUSOPERATIONSTATE = DESCRIPTOR.enum_types_by_name['PendingNexusOperationState']
PendingNexusOperationState = enum_type_wrapper.EnumTypeWrapper(_PENDINGNEXUSOPERATIONSTATE)
_NEXUSOPERATIONCANCELLATIONSTATE = DESCRIPTOR.enum_types_by_name['NexusOperationCancellationState']
NexusOperationCancellationState = enum_type_wrapper.EnumTypeWrapper(_NEXUSOPERATIONCANCELLATIONSTATE)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _EXECUTIONTYPE._serialized_start=1797
  _EXECUTIONTYPE._serialized_end=1902
