...
class _DeploymentReachabilityEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_DeploymentReachability.ValueType], builtins.type):  # noqa: F821
    ...
    """
    DEPLOYMENT_REACHABILITY_CLOSED_WORKFLOWS_ONLY: _DeploymentReachability.ValueType  # 2
...
class _VersionDrainageStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_VersionDrainageStatus.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _WorkerVersioningModeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_WorkerVersioningMode.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _WorkerDeploymentVersionStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_WorkerDeploymentVersionStatus.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    WORKER_DEPLOYMENT_VERSION_STATUS_UNSPECIFIED: _WorkerDeploymentVersionStatus.ValueType  # 0
    WORKER_DEPLOYMENT_VERSION_STATUS_INACTIVE: _WorkerDeploymentVersionStatus.ValueType  # 1
    ...
    """
    WORKER_DEPLOYMENT_VERSION_STATUS_CURRENT: _WorkerDeploymentVersionStatus.ValueType  # 2
    ...
    """
    WORKER_DEPLOYMENT_VERSION_STATUS_RAMPING: _WorkerDeploymentVersionStatus.ValueType  # 3
    ...
    """
    WORKER_DEPLOYMENT_VERSION_STATUS_DRAINING: _WorkerDeploymentVersionStatus.ValueType  # 4
    """The Worker Deployment Version is not used by new workflows but is still used by
    open pinned workflows. The version cannot be decommissioned safely.
    """
    WORKER_DEPLOYMENT_VERSION_STATUS_DRAINED: _WorkerDeploymentVersionStatus.ValueType  # 5
    """The Worker Deployment Version is not used by new or open workflows, but might be still needed by
    Queries sent to closed workflows. The version can be decommissioned safely if user does
    not query closed workflows. If the user does query closed workflows for some time x after
    workflows are closed, they should decommission the version after it has been drained for that duration.
    """
    WORKER_DEPLOYMENT_VERSION_STATUS_CREATED: _WorkerDeploymentVersionStatus.ValueType  # 6
...
WORKER_DEPLOYMENT_VERSION_STATUS_UNSPECIFIED: WorkerDeploymentVersionStatus.ValueType  # 0
