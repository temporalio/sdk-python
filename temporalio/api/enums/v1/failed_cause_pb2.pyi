...
class _WorkflowTaskFailedCauseEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_WorkflowTaskFailedCause.ValueType], builtins.type):  # noqa: F821
    ...
    """
    WORKFLOW_TASK_FAILED_CAUSE_GRPC_MESSAGE_TOO_LARGE: _WorkflowTaskFailedCause.ValueType  # 36
    """A workflow task failed because a grpc message was too large."""
    WORKFLOW_TASK_FAILED_CAUSE_PAYLOADS_TOO_LARGE: _WorkflowTaskFailedCause.ValueType  # 37
    """A workflow task failed because payloads were too large."""
    WORKFLOW_TASK_FAILED_CAUSE_EXTERNAL_STORAGE_FAILURE: _WorkflowTaskFailedCause.ValueType  # 38
...
Check the workflow task failure message for more information.
"""
WORKFLOW_TASK_FAILED_CAUSE_GRPC_MESSAGE_TOO_LARGE: WorkflowTaskFailedCause.ValueType  # 36
"""A workflow task failed because a grpc message was too large."""
WORKFLOW_TASK_FAILED_CAUSE_PAYLOADS_TOO_LARGE: WorkflowTaskFailedCause.ValueType  # 37
"""A workflow task failed because payloads were too large."""
WORKFLOW_TASK_FAILED_CAUSE_EXTERNAL_STORAGE_FAILURE: WorkflowTaskFailedCause.ValueType  # 38
"""A workflow task failed because an external storage operation failed.
Check the workflow task failure message for more information.
"""
...
class _StartChildWorkflowExecutionFailedCauseEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_StartChildWorkflowExecutionFailedCause.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    START_CHILD_WORKFLOW_EXECUTION_FAILED_CAUSE_INVALID_VERSIONING_OVERRIDE: _StartChildWorkflowExecutionFailedCause.ValueType  # 3
...
START_CHILD_WORKFLOW_EXECUTION_FAILED_CAUSE_INVALID_VERSIONING_OVERRIDE: StartChildWorkflowExecutionFailedCause.ValueType  # 3
...
class _CancelExternalWorkflowExecutionFailedCauseEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_CancelExternalWorkflowExecutionFailedCause.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _SignalExternalWorkflowExecutionFailedCauseEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SignalExternalWorkflowExecutionFailedCause.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _ResourceExhaustedCauseEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ResourceExhaustedCause.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    ...
    RESOURCE_EXHAUSTED_CAUSE_CIRCUIT_BREAKER_OPEN: _ResourceExhaustedCause.ValueType  # 8
    ...
    RESOURCE_EXHAUSTED_CAUSE_WORKER_DEPLOYMENT_LIMITS: _ResourceExhaustedCause.ValueType  # 10
...
"""Namespace exceeds operations rate limit."""
RESOURCE_EXHAUSTED_CAUSE_WORKER_DEPLOYMENT_LIMITS: ResourceExhaustedCause.ValueType  # 10
"""Limits related to Worker Deployments are reached."""
...
class _ResourceExhaustedScopeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ResourceExhaustedScope.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
