...
_NEXUSHANDLERERRORRETRYBEHAVIOR = DESCRIPTOR.enum_types_by_name['NexusHandlerErrorRetryBehavior']
NexusHandlerErrorRetryBehavior = enum_type_wrapper.EnumTypeWrapper(_NEXUSHANDLERERRORRETRYBEHAVIOR)
_NEXUSOPERATIONEXECUTIONSTATUS = DESCRIPTOR.enum_types_by_name['NexusOperationExecutionStatus']
NexusOperationExecutionStatus = enum_type_wrapper.EnumTypeWrapper(_NEXUSOPERATIONEXECUTIONSTATUS)
...
_NEXUSOPERATIONIDREUSEPOLICY = DESCRIPTOR.enum_types_by_name['NexusOperationIdReusePolicy']
NexusOperationIdReusePolicy = enum_type_wrapper.EnumTypeWrapper(_NEXUSOPERATIONIDREUSEPOLICY)
_NEXUSOPERATIONIDCONFLICTPOLICY = DESCRIPTOR.enum_types_by_name['NexusOperationIdConflictPolicy']
NexusOperationIdConflictPolicy = enum_type_wrapper.EnumTypeWrapper(_NEXUSOPERATIONIDCONFLICTPOLICY)
