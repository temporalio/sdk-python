...
_UPDATEWORKFLOWEXECUTIONLIFECYCLESTAGE = DESCRIPTOR.enum_types_by_name['UpdateWorkflowExecutionLifecycleStage']
UpdateWorkflowExecutionLifecycleStage = enum_type_wrapper.EnumTypeWrapper(_UPDATEWORKFLOWEXECUTIONLIFECYCLESTAGE)
_UPDATEADMITTEDEVENTORIGIN = DESCRIPTOR.enum_types_by_name['UpdateAdmittedEventOrigin']
UpdateAdmittedEventOrigin = enum_type_wrapper.EnumTypeWrapper(_UPDATEADMITTEDEVENTORIGIN)
