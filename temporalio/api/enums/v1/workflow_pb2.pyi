...
class _WorkflowIdReusePolicyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_WorkflowIdReusePolicy.ValueType], builtins.type):  # noqa: F821
...
class _WorkflowIdConflictPolicyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_WorkflowIdConflictPolicy.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _ParentClosePolicyEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ParentClosePolicy.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _ContinueAsNewInitiatorEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ContinueAsNewInitiator.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _WorkflowExecutionStatusEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_WorkflowExecutionStatus.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _PendingActivityStateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_PendingActivityState.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _PendingWorkflowTaskStateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_PendingWorkflowTaskState.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _HistoryEventFilterTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_HistoryEventFilterType.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _RetryStateEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_RetryState.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _TimeoutTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_TimeoutType.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _VersioningBehaviorEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_VersioningBehavior.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class _ContinueAsNewVersioningBehaviorEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_ContinueAsNewVersioningBehavior.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_UNSPECIFIED: _ContinueAsNewVersioningBehavior.ValueType  # 0
    CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_AUTO_UPGRADE: _ContinueAsNewVersioningBehavior.ValueType  # 1
    """Experimental.
    ...
    """
    CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_USE_RAMPING_VERSION: _ContinueAsNewVersioningBehavior.ValueType  # 2
    """Experimental.
...
class ContinueAsNewVersioningBehavior(_ContinueAsNewVersioningBehavior, metaclass=_ContinueAsNewVersioningBehaviorEnumTypeWrapper):
...
CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_UNSPECIFIED: ContinueAsNewVersioningBehavior.ValueType  # 0
CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_AUTO_UPGRADE: ContinueAsNewVersioningBehavior.ValueType  # 1
"""Experimental.
Start the new run with AutoUpgrade behavior. Use the Target Version of the workflow's task queue at
start-time, as AutoUpgrade workflows do. After the first workflow task completes, use whatever
Versioning Behavior the workflow is annotated with in the workflow code.
...
command. Versioning Override always takes precedence until it's removed manually via UpdateWorkflowExecutionOptions.
"""
CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_USE_RAMPING_VERSION: ContinueAsNewVersioningBehavior.ValueType  # 2
"""Experimental.
Use the Ramping Version of the workflow's task queue at start time, regardless of the workflow's
Target Version (according to f(workflow_id, ramp_percentage)). After the first workflow task completes,
the workflow will use whatever Versioning Behavior it is annotated with. If there is no Ramping
...
class _SuggestContinueAsNewReasonEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_SuggestContinueAsNewReason.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    SUGGEST_CONTINUE_AS_NEW_REASON_UNSPECIFIED: _SuggestContinueAsNewReason.ValueType  # 0
    SUGGEST_CONTINUE_AS_NEW_REASON_HISTORY_SIZE_TOO_LARGE: _SuggestContinueAsNewReason.ValueType  # 1
    """Workflow History size is getting too large."""
    SUGGEST_CONTINUE_AS_NEW_REASON_TOO_MANY_HISTORY_EVENTS: _SuggestContinueAsNewReason.ValueType  # 2
    """Workflow History event count is getting too large."""
    SUGGEST_CONTINUE_AS_NEW_REASON_TOO_MANY_UPDATES: _SuggestContinueAsNewReason.ValueType  # 3
    """Workflow's count of completed plus in-flight updates is too large."""

class SuggestContinueAsNewReason(_SuggestContinueAsNewReason, metaclass=_SuggestContinueAsNewReasonEnumTypeWrapper):
...
SUGGEST_CONTINUE_AS_NEW_REASON_HISTORY_SIZE_TOO_LARGE: SuggestContinueAsNewReason.ValueType  # 1
"""Workflow History size is getting too large."""
SUGGEST_CONTINUE_AS_NEW_REASON_TOO_MANY_HISTORY_EVENTS: SuggestContinueAsNewReason.ValueType  # 2
"""Workflow History event count is getting too large."""
SUGGEST_CONTINUE_AS_NEW_REASON_TOO_MANY_UPDATES: SuggestContinueAsNewReason.ValueType  # 3
"""Workflow's count of completed plus in-flight updates is too large."""
