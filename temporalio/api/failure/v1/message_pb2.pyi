...
class ApplicationFailureInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["details", b"details", "next_retry_delay", b"next_retry_delay"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["category", b"category", "details", b"details", "next_retry_delay", b"next_retry_delay", "non_retryable", b"non_retryable", "type", b"type"]) -> None: ...
...
class NexusOperationFailureInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["endpoint", b"endpoint", "operation", b"operation", "operation_id", b"operation_id", "operation_token", b"operation_token", "scheduled_event_id", b"scheduled_event_id", "service", b"service"]) -> None: ...
...
class NexusHandlerFailureInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["retry_behavior", b"retry_behavior", "type", b"type"]) -> None: ...
...
class Failure(google.protobuf.message.Message):
    ...
    @property
    def nexus_operation_execution_failure_info(self) -> global___NexusOperationFailureInfo: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        child_workflow_execution_failure_info: global___ChildWorkflowExecutionFailureInfo | None = ...,
        nexus_operation_execution_failure_info: global___NexusOperationFailureInfo | None = ...,
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["failure_info", b"failure_info"]) -> typing_extensions.Literal["application_failure_info", "timeout_failure_info", "canceled_failure_info", "terminated_failure_info", "server_failure_info", "reset_workflow_failure_info", "activity_failure_info", "child_workflow_execution_failure_info", "nexus_operation_execution_failure_info", "nexus_handler_failure_info"] | None: ...
