...
class WorkflowExecutionStartedEventAttributes(google.protobuf.message.Message):
    ...
    @property
    def source_version_stamp(self) -> temporalio.api.common.v1.message_pb2.WorkerVersionStamp:
    ...
    @property
    def root_workflow_execution(self) -> temporalio.api.common.v1.message_pb2.WorkflowExecution:
    ...
    def priority(self) -> temporalio.api.common.v1.message_pb2.Priority:
        """Priority metadata"""
    @property
    def inherited_pinned_version(self) -> temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion:
        ...
        """
    @property
    def inherited_auto_upgrade_info(self) -> temporalio.api.deployment.v1.message_pb2.InheritedAutoUpgradeInfo:
    ...
    def time_skipping_config(self) -> temporalio.api.common.v1.message_pb2.TimeSkippingConfig:
        ...
        """
    @property
    def time_skipping_state_propagation(self) -> temporalio.api.common.v1.message_pb2.TimeSkippingStatePropagation:
    ...
    def __init__(
        ...
        *,
        ...
        parent_workflow_namespace: builtins.str = ...,
        parent_workflow_namespace_id: builtins.str = ...,
        parent_workflow_execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ...,
        parent_initiated_event_id: builtins.int = ...,
        ...
        prev_auto_reset_points: temporalio.api.workflow.v1.message_pb2.ResetPoints | None = ...,
        header: temporalio.api.common.v1.message_pb2.Header | None = ...,
        parent_initiated_event_version: builtins.int = ...,
        workflow_id: builtins.str = ...,
        source_version_stamp: temporalio.api.common.v1.message_pb2.WorkerVersionStamp | None = ...,
        completion_callbacks: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Callback] | None = ...,
        root_workflow_execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ...,
        inherited_build_id: builtins.str = ...,
        ...
        inherited_pinned_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ...,
        inherited_auto_upgrade_info: temporalio.api.deployment.v1.message_pb2.InheritedAutoUpgradeInfo | None = ...,
        eager_execution_accepted: builtins.bool = ...,
        declined_target_version_upgrade: global___DeclinedTargetVersionUpgrade | None = ...,
        time_skipping_config: temporalio.api.common.v1.message_pb2.TimeSkippingConfig | None = ...,
        time_skipping_state_propagation: temporalio.api.common.v1.message_pb2.TimeSkippingStatePropagation | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["continued_failure", b"continued_failure", "declined_target_version_upgrade", b"declined_target_version_upgrade", "first_workflow_task_backoff", b"first_workflow_task_backoff", "header", b"header", "inherited_auto_upgrade_info", b"inherited_auto_upgrade_info", "inherited_pinned_version", b"inherited_pinned_version", "input", b"input", "last_completion_result", b"last_completion_result", "memo", b"memo", "parent_workflow_execution", b"parent_workflow_execution", "prev_auto_reset_points", b"prev_auto_reset_points", "priority", b"priority", "retry_policy", b"retry_policy", "root_workflow_execution", b"root_workflow_execution", "search_attributes", b"search_attributes", "source_version_stamp", b"source_version_stamp", "task_queue", b"task_queue", "time_skipping_config", b"time_skipping_config", "time_skipping_state_propagation", b"time_skipping_state_propagation", "versioning_override", b"versioning_override", "workflow_execution_expiration_time", b"workflow_execution_expiration_time", "workflow_execution_timeout", b"workflow_execution_timeout", "workflow_run_timeout", b"workflow_run_timeout", "workflow_task_timeout", b"workflow_task_timeout", "workflow_type", b"workflow_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attempt", b"attempt", "completion_callbacks", b"completion_callbacks", "continued_execution_run_id", b"continued_execution_run_id", "continued_failure", b"continued_failure", "cron_schedule", b"cron_schedule", "declined_target_version_upgrade", b"declined_target_version_upgrade", "eager_execution_accepted", b"eager_execution_accepted", "first_execution_run_id", b"first_execution_run_id", "first_workflow_task_backoff", b"first_workflow_task_backoff", "header", b"header", "identity", b"identity", "inherited_auto_upgrade_info", b"inherited_auto_upgrade_info", "inherited_build_id", b"inherited_build_id", "inherited_pinned_version", b"inherited_pinned_version", "initiator", b"initiator", "input", b"input", "last_completion_result", b"last_completion_result", "memo", b"memo", "original_execution_run_id", b"original_execution_run_id", "parent_initiated_event_id", b"parent_initiated_event_id", "parent_initiated_event_version", b"parent_initiated_event_version", "parent_pinned_worker_deployment_version", b"parent_pinned_worker_deployment_version", "parent_workflow_execution", b"parent_workflow_execution", "parent_workflow_namespace", b"parent_workflow_namespace", "parent_workflow_namespace_id", b"parent_workflow_namespace_id", "prev_auto_reset_points", b"prev_auto_reset_points", "priority", b"priority", "retry_policy", b"retry_policy", "root_workflow_execution", b"root_workflow_execution", "search_attributes", b"search_attributes", "source_version_stamp", b"source_version_stamp", "task_queue", b"task_queue", "time_skipping_config", b"time_skipping_config", "time_skipping_state_propagation", b"time_skipping_state_propagation", "versioning_override", b"versioning_override", "workflow_execution_expiration_time", b"workflow_execution_expiration_time", "workflow_execution_timeout", b"workflow_execution_timeout", "workflow_id", b"workflow_id", "workflow_run_timeout", b"workflow_run_timeout", "workflow_task_timeout", b"workflow_task_timeout", "workflow_type", b"workflow_type"]) -> None: ...
...
class DeclinedTargetVersionUpgrade(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deployment_version", b"deployment_version", "revision_number", b"revision_number"]) -> None: ...
...
class WorkflowExecutionContinuedAsNewEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["backoff_start_interval", b"backoff_start_interval", "failure", b"failure", "header", b"header", "inherit_build_id", b"inherit_build_id", "initial_versioning_behavior", b"initial_versioning_behavior", "initiator", b"initiator", "input", b"input", "last_completion_result", b"last_completion_result", "memo", b"memo", "new_execution_run_id", b"new_execution_run_id", "search_attributes", b"search_attributes", "task_queue", b"task_queue", "workflow_run_timeout", b"workflow_run_timeout", "workflow_task_completed_event_id", b"workflow_task_completed_event_id", "workflow_task_timeout", b"workflow_task_timeout", "workflow_type", b"workflow_type"]) -> None: ...
...
class WorkflowTaskStartedEventAttributes(google.protobuf.message.Message):
    ...
    @property
    def suggest_continue_as_new_reasons(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[temporalio.api.enums.v1.workflow_pb2.SuggestContinueAsNewReason.ValueType]:
    ...
    def __init__(
        ...
        *,
        ...
        request_id: builtins.str = ...,
        suggest_continue_as_new: builtins.bool = ...,
        suggest_continue_as_new_reasons: collections.abc.Iterable[temporalio.api.enums.v1.workflow_pb2.SuggestContinueAsNewReason.ValueType] | None = ...,
        target_worker_deployment_version_changed: builtins.bool = ...,
        history_size_bytes: builtins.int = ...,
        worker_version: temporalio.api.common.v1.message_pb2.WorkerVersionStamp | None = ...,
        build_id_redirect_counter: builtins.int = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["worker_version", b"worker_version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["build_id_redirect_counter", b"build_id_redirect_counter", "history_size_bytes", b"history_size_bytes", "identity", b"identity", "request_id", b"request_id", "scheduled_event_id", b"scheduled_event_id", "suggest_continue_as_new", b"suggest_continue_as_new", "suggest_continue_as_new_reasons", b"suggest_continue_as_new_reasons", "target_worker_deployment_version_changed", b"target_worker_deployment_version_changed", "worker_version", b"worker_version"]) -> None: ...
...
class WorkflowTaskCompletedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["deployment", b"deployment", "deployment_version", b"deployment_version", "metering_metadata", b"metering_metadata", "sdk_metadata", b"sdk_metadata", "worker_version", b"worker_version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["binary_checksum", b"binary_checksum", "deployment", b"deployment", "deployment_version", b"deployment_version", "identity", b"identity", "metering_metadata", b"metering_metadata", "scheduled_event_id", b"scheduled_event_id", "sdk_metadata", b"sdk_metadata", "started_event_id", b"started_event_id", "versioning_behavior", b"versioning_behavior", "worker_deployment_name", b"worker_deployment_name", "worker_deployment_version", b"worker_deployment_version", "worker_version", b"worker_version"]) -> None: ...
...
class WorkflowTaskFailedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure", b"failure", "worker_version", b"worker_version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["base_run_id", b"base_run_id", "binary_checksum", b"binary_checksum", "cause", b"cause", "failure", b"failure", "fork_event_version", b"fork_event_version", "identity", b"identity", "new_run_id", b"new_run_id", "scheduled_event_id", b"scheduled_event_id", "started_event_id", b"started_event_id", "worker_version", b"worker_version"]) -> None: ...
...
class ActivityTaskScheduledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["activity_type", b"activity_type", "header", b"header", "heartbeat_timeout", b"heartbeat_timeout", "input", b"input", "priority", b"priority", "retry_policy", b"retry_policy", "schedule_to_close_timeout", b"schedule_to_close_timeout", "schedule_to_start_timeout", b"schedule_to_start_timeout", "start_to_close_timeout", b"start_to_close_timeout", "task_queue", b"task_queue"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id", b"activity_id", "activity_type", b"activity_type", "header", b"header", "heartbeat_timeout", b"heartbeat_timeout", "input", b"input", "priority", b"priority", "retry_policy", b"retry_policy", "schedule_to_close_timeout", b"schedule_to_close_timeout", "schedule_to_start_timeout", b"schedule_to_start_timeout", "start_to_close_timeout", b"start_to_close_timeout", "task_queue", b"task_queue", "use_workflow_build_id", b"use_workflow_build_id", "workflow_task_completed_event_id", b"workflow_task_completed_event_id"]) -> None: ...
...
class ActivityTaskStartedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["last_failure", b"last_failure", "worker_version", b"worker_version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attempt", b"attempt", "build_id_redirect_counter", b"build_id_redirect_counter", "identity", b"identity", "last_failure", b"last_failure", "request_id", b"request_id", "scheduled_event_id", b"scheduled_event_id", "worker_version", b"worker_version"]) -> None: ...
...
class ActivityTaskCompletedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["result", b"result", "worker_version", b"worker_version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "result", b"result", "scheduled_event_id", b"scheduled_event_id", "started_event_id", b"started_event_id", "worker_version", b"worker_version"]) -> None: ...
...
class ActivityTaskFailedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure", b"failure", "worker_version", b"worker_version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failure", b"failure", "identity", b"identity", "retry_state", b"retry_state", "scheduled_event_id", b"scheduled_event_id", "started_event_id", b"started_event_id", "worker_version", b"worker_version"]) -> None: ...
...
class ActivityTaskCanceledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["details", b"details", "worker_version", b"worker_version"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["details", b"details", "identity", b"identity", "latest_cancel_requested_event_id", b"latest_cancel_requested_event_id", "scheduled_event_id", b"scheduled_event_id", "started_event_id", b"started_event_id", "worker_version", b"worker_version"]) -> None: ...
...
class WorkflowExecutionCancelRequestedEventAttributes(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        cause: builtins.str = ...,
        external_initiated_event_id: builtins.int = ...,
        external_workflow_execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ...,
        identity: builtins.str = ...,
    ) -> None: ...
...
class MarkerRecordedEventAttributes(google.protobuf.message.Message):
    ...
    @property
    def details(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, temporalio.api.common.v1.message_pb2.Payloads]:
    ...
    def __init__(
        ...
        *,
        marker_name: builtins.str = ...,
        details: collections.abc.Mapping[builtins.str, temporalio.api.common.v1.message_pb2.Payloads] | None = ...,
        workflow_task_completed_event_id: builtins.int = ...,
        header: temporalio.api.common.v1.message_pb2.Header | None = ...,
        failure: temporalio.api.failure.v1.message_pb2.Failure | None = ...,
    ) -> None: ...
...
class WorkflowExecutionSignaledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["external_workflow_execution", b"external_workflow_execution", "header", b"header", "input", b"input"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["external_workflow_execution", b"external_workflow_execution", "header", b"header", "identity", b"identity", "input", b"input", "request_id", b"request_id", "signal_name", b"signal_name", "skip_generate_workflow_task", b"skip_generate_workflow_task"]) -> None: ...
...
class RequestCancelExternalWorkflowExecutionInitiatedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["child_workflow_only", b"child_workflow_only", "control", b"control", "namespace", b"namespace", "namespace_id", b"namespace_id", "reason", b"reason", "workflow_execution", b"workflow_execution", "workflow_task_completed_event_id", b"workflow_task_completed_event_id"]) -> None: ...
...
class RequestCancelExternalWorkflowExecutionFailedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution", b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cause", b"cause", "control", b"control", "initiated_event_id", b"initiated_event_id", "namespace", b"namespace", "namespace_id", b"namespace_id", "workflow_execution", b"workflow_execution", "workflow_task_completed_event_id", b"workflow_task_completed_event_id"]) -> None: ...
...
class ExternalWorkflowExecutionCancelRequestedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution", b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["initiated_event_id", b"initiated_event_id", "namespace", b"namespace", "namespace_id", b"namespace_id", "workflow_execution", b"workflow_execution"]) -> None: ...
...
class ExternalWorkflowExecutionSignaledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution", b"workflow_execution"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["control", b"control", "initiated_event_id", b"initiated_event_id", "namespace", b"namespace", "namespace_id", b"namespace_id", "workflow_execution", b"workflow_execution"]) -> None: ...
...
class WorkflowPropertiesModifiedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["upserted_memo", b"upserted_memo"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["upserted_memo", b"upserted_memo", "workflow_task_completed_event_id", b"workflow_task_completed_event_id"]) -> None: ...

global___WorkflowPropertiesModifiedEventAttributes = WorkflowPropertiesModifiedEventAttributes
...
class StartChildWorkflowExecutionInitiatedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["header", b"header", "input", b"input", "memo", b"memo", "priority", b"priority", "retry_policy", b"retry_policy", "search_attributes", b"search_attributes", "task_queue", b"task_queue", "time_skipping_config", b"time_skipping_config", "time_skipping_state_propagation", b"time_skipping_state_propagation", "versioning_override", b"versioning_override", "workflow_execution_timeout", b"workflow_execution_timeout", "workflow_run_timeout", b"workflow_run_timeout", "workflow_task_timeout", b"workflow_task_timeout", "workflow_type", b"workflow_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["control", b"control", "cron_schedule", b"cron_schedule", "header", b"header", "inherit_build_id", b"inherit_build_id", "input", b"input", "memo", b"memo", "namespace", b"namespace", "namespace_id", b"namespace_id", "parent_close_policy", b"parent_close_policy", "priority", b"priority", "retry_policy", b"retry_policy", "search_attributes", b"search_attributes", "task_queue", b"task_queue", "time_skipping_config", b"time_skipping_config", "time_skipping_state_propagation", b"time_skipping_state_propagation", "versioning_override", b"versioning_override", "workflow_execution_timeout", b"workflow_execution_timeout", "workflow_id", b"workflow_id", "workflow_id_reuse_policy", b"workflow_id_reuse_policy", "workflow_run_timeout", b"workflow_run_timeout", "workflow_task_completed_event_id", b"workflow_task_completed_event_id", "workflow_task_timeout", b"workflow_task_timeout", "workflow_type", b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionStartedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["header", b"header", "initiated_event_id", b"initiated_event_id", "namespace", b"namespace", "namespace_id", b"namespace_id", "workflow_execution", b"workflow_execution", "workflow_type", b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionCompletedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["initiated_event_id", b"initiated_event_id", "namespace", b"namespace", "namespace_id", b"namespace_id", "result", b"result", "started_event_id", b"started_event_id", "workflow_execution", b"workflow_execution", "workflow_type", b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionCanceledEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["details", b"details", "initiated_event_id", b"initiated_event_id", "namespace", b"namespace", "namespace_id", b"namespace_id", "started_event_id", b"started_event_id", "workflow_execution", b"workflow_execution", "workflow_type", b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionTimedOutEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["initiated_event_id", b"initiated_event_id", "namespace", b"namespace", "namespace_id", b"namespace_id", "retry_state", b"retry_state", "started_event_id", b"started_event_id", "workflow_execution", b"workflow_execution", "workflow_type", b"workflow_type"]) -> None: ...
...
class ChildWorkflowExecutionTerminatedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution", b"workflow_execution", "workflow_type", b"workflow_type"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["initiated_event_id", b"initiated_event_id", "namespace", b"namespace", "namespace_id", b"namespace_id", "started_event_id", b"started_event_id", "workflow_execution", b"workflow_execution", "workflow_type", b"workflow_type"]) -> None: ...
...
class WorkflowExecutionOptionsUpdatedEventAttributes(google.protobuf.message.Message):
    ...
    class WorkflowUpdateOptionsUpdate(google.protobuf.message.Message):
        ...
        """
        @property
        def attached_completion_callbacks(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.common.v1.message_pb2.Callback]:
        ...
        def __init__(
            ...
            *,
            update_id: builtins.str = ...,
            attached_request_id: builtins.str = ...,
            attached_completion_callbacks: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Callback] | None = ...,
        ) -> None: ...
        def ClearField(self, field_name: typing_extensions.Literal["attached_completion_callbacks", b"attached_completion_callbacks", "attached_request_id", b"attached_request_id", "update_id", b"update_id"]) -> None: ...
    ...
    """
    @property
    def workflow_update_options(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___WorkflowExecutionOptionsUpdatedEventAttributes.WorkflowUpdateOptionsUpdate]:
    ...
    def __init__(
        ...
        *,
        ...
        time_skipping_config: temporalio.api.common.v1.message_pb2.TimeSkippingConfig | None = ...,
        time_skipping_config_updated: builtins.bool = ...,
        workflow_update_options: collections.abc.Iterable[global___WorkflowExecutionOptionsUpdatedEventAttributes.WorkflowUpdateOptionsUpdate] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["priority", b"priority", "time_skipping_config", b"time_skipping_config", "versioning_override", b"versioning_override"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attached_completion_callbacks", b"attached_completion_callbacks", "attached_request_id", b"attached_request_id", "identity", b"identity", "priority", b"priority", "time_skipping_config", b"time_skipping_config", "time_skipping_config_updated", b"time_skipping_config_updated", "unset_versioning_override", b"unset_versioning_override", "versioning_override", b"versioning_override", "workflow_update_options", b"workflow_update_options"]) -> None: ...

global___WorkflowExecutionOptionsUpdatedEventAttributes = WorkflowExecutionOptionsUpdatedEventAttributes

class WorkflowPropertiesModifiedExternallyEventAttributes(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        new_workflow_execution_timeout: google.protobuf.duration_pb2.Duration | None = ...,
        upserted_memo: temporalio.api.common.v1.message_pb2.Memo | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["new_workflow_execution_timeout", b"new_workflow_execution_timeout", "new_workflow_run_timeout", b"new_workflow_run_timeout", "new_workflow_task_timeout", b"new_workflow_task_timeout", "upserted_memo", b"upserted_memo"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["new_task_queue", b"new_task_queue", "new_workflow_execution_timeout", b"new_workflow_execution_timeout", "new_workflow_run_timeout", b"new_workflow_run_timeout", "new_workflow_task_timeout", b"new_workflow_task_timeout", "upserted_memo", b"upserted_memo"]) -> None: ...

global___WorkflowPropertiesModifiedExternallyEventAttributes = WorkflowPropertiesModifiedExternallyEventAttributes

class ActivityPropertiesModifiedExternallyEventAttributes(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def HasField(self, field_name: typing_extensions.Literal["new_retry_policy", b"new_retry_policy"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["new_retry_policy", b"new_retry_policy", "scheduled_event_id", b"scheduled_event_id"]) -> None: ...

global___ActivityPropertiesModifiedExternallyEventAttributes = ActivityPropertiesModifiedExternallyEventAttributes
...
class WorkflowExecutionUpdateAcceptedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["accepted_request", b"accepted_request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["accepted_request", b"accepted_request", "accepted_request_message_id", b"accepted_request_message_id", "accepted_request_sequencing_event_id", b"accepted_request_sequencing_event_id", "protocol_instance_id", b"protocol_instance_id"]) -> None: ...

global___WorkflowExecutionUpdateAcceptedEventAttributes = WorkflowExecutionUpdateAcceptedEventAttributes
...
class WorkflowExecutionUpdateCompletedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["meta", b"meta", "outcome", b"outcome"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["accepted_event_id", b"accepted_event_id", "meta", b"meta", "outcome", b"outcome"]) -> None: ...
...
class WorkflowExecutionUpdateRejectedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure", b"failure", "rejected_request", b"rejected_request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failure", b"failure", "protocol_instance_id", b"protocol_instance_id", "rejected_request", b"rejected_request", "rejected_request_message_id", b"rejected_request_message_id", "rejected_request_sequencing_event_id", b"rejected_request_sequencing_event_id"]) -> None: ...

global___WorkflowExecutionUpdateRejectedEventAttributes = WorkflowExecutionUpdateRejectedEventAttributes
...
class WorkflowExecutionUpdateAdmittedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["origin", b"origin", "request", b"request"]) -> None: ...

global___WorkflowExecutionUpdateAdmittedEventAttributes = WorkflowExecutionUpdateAdmittedEventAttributes
...
class WorkflowExecutionPausedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "reason", b"reason", "request_id", b"request_id"]) -> None: ...
...
global___WorkflowExecutionUnpausedEventAttributes = WorkflowExecutionUnpausedEventAttributes

class WorkflowExecutionTimeSkippingTransitionedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["target_time", b"target_time", "wall_clock_time", b"wall_clock_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["disabled_after_fast_forward", b"disabled_after_fast_forward", "target_time", b"target_time", "wall_clock_time", b"wall_clock_time"]) -> None: ...

global___WorkflowExecutionTimeSkippingTransitionedEventAttributes = WorkflowExecutionTimeSkippingTransitionedEventAttributes
...
class NexusOperationScheduledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input", "schedule_to_close_timeout", b"schedule_to_close_timeout", "schedule_to_start_timeout", b"schedule_to_start_timeout", "start_to_close_timeout", b"start_to_close_timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["endpoint", b"endpoint", "endpoint_id", b"endpoint_id", "input", b"input", "nexus_header", b"nexus_header", "operation", b"operation", "request_id", b"request_id", "schedule_to_close_timeout", b"schedule_to_close_timeout", "schedule_to_start_timeout", b"schedule_to_start_timeout", "service", b"service", "start_to_close_timeout", b"start_to_close_timeout", "workflow_task_completed_event_id", b"workflow_task_completed_event_id"]) -> None: ...
...
class NexusOperationStartedEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["operation_id", b"operation_id", "operation_token", b"operation_token", "request_id", b"request_id", "scheduled_event_id", b"scheduled_event_id"]) -> None: ...
...
class NexusOperationCompletedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["result", b"result"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["request_id", b"request_id", "result", b"result", "scheduled_event_id", b"scheduled_event_id"]) -> None: ...
...
class NexusOperationFailedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure", b"failure"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failure", b"failure", "request_id", b"request_id", "scheduled_event_id", b"scheduled_event_id"]) -> None: ...
...
class NexusOperationCancelRequestCompletedEventAttributes(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def ClearField(self, field_name: typing_extensions.Literal["requested_event_id", b"requested_event_id", "scheduled_event_id", b"scheduled_event_id", "workflow_task_completed_event_id", b"workflow_task_completed_event_id"]) -> None: ...

global___NexusOperationCancelRequestCompletedEventAttributes = NexusOperationCancelRequestCompletedEventAttributes
...
class NexusOperationCancelRequestFailedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure", b"failure"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failure", b"failure", "requested_event_id", b"requested_event_id", "scheduled_event_id", b"scheduled_event_id", "workflow_task_completed_event_id", b"workflow_task_completed_event_id"]) -> None: ...

global___NexusOperationCancelRequestFailedEventAttributes = NexusOperationCancelRequestFailedEventAttributes
...
class HistoryEvent(google.protobuf.message.Message):
    ...
    WORKFLOW_EXECUTION_TIME_SKIPPING_TRANSITIONED_EVENT_ATTRIBUTES_FIELD_NUMBER: builtins.int
    ...
    @property
    def event_group_markers(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.sdk.v1.event_group_marker_pb2.EventGroupMarker]:
    ...
    @property
    def workflow_execution_update_rejected_event_attributes(self) -> global___WorkflowExecutionUpdateRejectedEventAttributes: ...
    @property
    def workflow_execution_update_completed_event_attributes(self) -> global___WorkflowExecutionUpdateCompletedEventAttributes: ...
    @property
    def workflow_properties_modified_externally_event_attributes(self) -> global___WorkflowPropertiesModifiedExternallyEventAttributes: ...
    @property
    def activity_properties_modified_externally_event_attributes(self) -> global___ActivityPropertiesModifiedExternallyEventAttributes: ...
    @property
    def workflow_properties_modified_event_attributes(self) -> global___WorkflowPropertiesModifiedEventAttributes: ...
    @property
    def workflow_execution_update_admitted_event_attributes(self) -> global___WorkflowExecutionUpdateAdmittedEventAttributes: ...
    @property
    def nexus_operation_scheduled_event_attributes(self) -> global___NexusOperationScheduledEventAttributes: ...
    @property
    def nexus_operation_started_event_attributes(self) -> global___NexusOperationStartedEventAttributes: ...
    @property
    def nexus_operation_completed_event_attributes(self) -> global___NexusOperationCompletedEventAttributes: ...
    @property
    def nexus_operation_failed_event_attributes(self) -> global___NexusOperationFailedEventAttributes: ...
    @property
    def nexus_operation_canceled_event_attributes(self) -> global___NexusOperationCanceledEventAttributes: ...
    @property
    def nexus_operation_timed_out_event_attributes(self) -> global___NexusOperationTimedOutEventAttributes: ...
    @property
    def nexus_operation_cancel_requested_event_attributes(self) -> global___NexusOperationCancelRequestedEventAttributes: ...
    @property
    def workflow_execution_options_updated_event_attributes(self) -> global___WorkflowExecutionOptionsUpdatedEventAttributes: ...
    @property
    def nexus_operation_cancel_request_completed_event_attributes(self) -> global___NexusOperationCancelRequestCompletedEventAttributes: ...
    @property
    def nexus_operation_cancel_request_failed_event_attributes(self) -> global___NexusOperationCancelRequestFailedEventAttributes: ...
    @property
    def workflow_execution_paused_event_attributes(self) -> global___WorkflowExecutionPausedEventAttributes: ...
    @property
    def workflow_execution_unpaused_event_attributes(self) -> global___WorkflowExecutionUnpausedEventAttributes: ...
    @property
    def workflow_execution_time_skipping_transitioned_event_attributes(self) -> global___WorkflowExecutionTimeSkippingTransitionedEventAttributes: ...
    def __init__(
        self,
        *,
        event_id: builtins.int = ...,
