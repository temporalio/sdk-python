...
class WorkflowExecutionContinuedAsNewEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["backoff_start_interval", b"backoff_start_interval", "failure", b"failure", "header", b"header", "inherit_build_id", b"inherit_build_id", "initiator", b"initiator", "input", b"input", "last_completion_result", b"last_completion_result", "memo", b"memo", "new_execution_run_id", b"new_execution_run_id", "search_attributes", b"search_attributes", "task_queue", b"task_queue", "workflow_run_timeout", b"workflow_run_timeout", "workflow_task_completed_event_id", b"workflow_task_completed_event_id", "workflow_task_timeout", b"workflow_task_timeout", "workflow_type", b"workflow_type"]) -> None: ...
...
class WorkflowExecutionSignaledEventAttributes(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["external_workflow_execution", b"external_workflow_execution", "header", b"header", "identity", b"identity", "input", b"input", "signal_name", b"signal_name", "skip_generate_workflow_task", b"skip_generate_workflow_task"]) -> None: ...
...
class WorkflowExecutionOptionsUpdatedEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["versioning_override", b"versioning_override"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attached_completion_callbacks", b"attached_completion_callbacks", "attached_request_id", b"attached_request_id", "unset_versioning_override", b"unset_versioning_override", "versioning_override", b"versioning_override"]) -> None: ...
...
class NexusOperationScheduledEventAttributes(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input", "schedule_to_close_timeout", b"schedule_to_close_timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["endpoint", b"endpoint", "endpoint_id", b"endpoint_id", "input", b"input", "nexus_header", b"nexus_header", "operation", b"operation", "request_id", b"request_id", "schedule_to_close_timeout", b"schedule_to_close_timeout", "service", b"service", "workflow_task_completed_event_id", b"workflow_task_completed_event_id"]) -> None: ...
