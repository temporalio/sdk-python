...
class NamespaceInfo(google.protobuf.message.Message):
    ...
    class Capabilities(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["async_update", b"async_update", "eager_workflow_start", b"eager_workflow_start", "reported_problems_search_attribute", b"reported_problems_search_attribute", "sync_update", b"sync_update", "worker_heartbeats", b"worker_heartbeats"]) -> None: ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal["capabilities", b"capabilities", "data", b"data", "description", b"description", "id", b"id", "name", b"name", "owner_email", b"owner_email", "state", b"state", "supports_schedules", b"supports_schedules"]) -> None: ...
