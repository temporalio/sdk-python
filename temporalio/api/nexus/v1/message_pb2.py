...
_UNSUCCESSFULOPERATIONERROR = DESCRIPTOR.message_types_by_name['UnsuccessfulOperationError']
_LINK = DESCRIPTOR.message_types_by_name['Link']
_STARTOPERATIONREQUEST = DESCRIPTOR.message_types_by_name['StartOperationRequest']
_STARTOPERATIONREQUEST_CALLBACKHEADERENTRY = _STARTOPERATIONREQUEST.nested_types_by_name['CallbackHeaderEntry']
...
_NEXUSOPERATIONEXECUTIONCANCELLATIONINFO = DESCRIPTOR.message_types_by_name['NexusOperationExecutionCancellationInfo']
_NEXUSOPERATIONEXECUTIONINFO = DESCRIPTOR.message_types_by_name['NexusOperationExecutionInfo']
_NEXUSOPERATIONEXECUTIONINFO_NEXUSHEADERENTRY = _NEXUSOPERATIONEXECUTIONINFO.nested_types_by_name['NexusHeaderEntry']
_NEXUSOPERATIONEXECUTIONLISTINFO = DESCRIPTOR.message_types_by_name['NexusOperationExecutionListInfo']
...
HandlerError = _reflection.GeneratedProtocolMessageType('HandlerError', (_message.Message,), {
...
UnsuccessfulOperationError = _reflection.GeneratedProtocolMessageType('UnsuccessfulOperationError', (_message.Message,), {
...
StartOperationRequest = _reflection.GeneratedProtocolMessageType('StartOperationRequest', (_message.Message,), {

  'CallbackHeaderEntry' : _reflection.GeneratedProtocolMessageType('CallbackHeaderEntry', (_message.Message,), {
...
StartOperationResponse = _reflection.GeneratedProtocolMessageType('StartOperationResponse', (_message.Message,), {
  ...
  'Async' : _reflection.GeneratedProtocolMessageType('Async', (_message.Message,), {
...
EndpointTarget = _reflection.GeneratedProtocolMessageType('EndpointTarget', (_message.Message,), {
...
NexusOperationExecutionCancellationInfo = _reflection.GeneratedProtocolMessageType('NexusOperationExecutionCancellationInfo', (_message.Message,), {
  'DESCRIPTOR' : _NEXUSOPERATIONEXECUTIONCANCELLATIONINFO,
  '__module__' : 'temporalio.api.nexus.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.nexus.v1.NexusOperationExecutionCancellationInfo)
  })
_sym_db.RegisterMessage(NexusOperationExecutionCancellationInfo)

NexusOperationExecutionInfo = _reflection.GeneratedProtocolMessageType('NexusOperationExecutionInfo', (_message.Message,), {

  'NexusHeaderEntry' : _reflection.GeneratedProtocolMessageType('NexusHeaderEntry', (_message.Message,), {
    'DESCRIPTOR' : _NEXUSOPERATIONEXECUTIONINFO_NEXUSHEADERENTRY,
    '__module__' : 'temporalio.api.nexus.v1.message_pb2'
    # @@protoc_insertion_point(class_scope:temporal.api.nexus.v1.NexusOperationExecutionInfo.NexusHeaderEntry)
    })
  ,
  'DESCRIPTOR' : _NEXUSOPERATIONEXECUTIONINFO,
  '__module__' : 'temporalio.api.nexus.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.nexus.v1.NexusOperationExecutionInfo)
  })
_sym_db.RegisterMessage(NexusOperationExecutionInfo)
_sym_db.RegisterMessage(NexusOperationExecutionInfo.NexusHeaderEntry)

NexusOperationExecutionListInfo = _reflection.GeneratedProtocolMessageType('NexusOperationExecutionListInfo', (_message.Message,), {
  'DESCRIPTOR' : _NEXUSOPERATIONEXECUTIONLISTINFO,
  '__module__' : 'temporalio.api.nexus.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.nexus.v1.NexusOperationExecutionListInfo)
  })
_sym_db.RegisterMessage(NexusOperationExecutionListInfo)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _STARTOPERATIONRESPONSE_ASYNC.fields_by_name['operation_id']._serialized_options = b'\030\001'
  _STARTOPERATIONRESPONSE.fields_by_name['operation_error']._options = None
  _STARTOPERATIONRESPONSE.fields_by_name['operation_error']._serialized_options = b'\030\001'
  _NEXUSOPERATIONEXECUTIONINFO_NEXUSHEADERENTRY._options = None
  _NEXUSOPERATIONEXECUTIONINFO_NEXUSHEADERENTRY._serialized_options = b'8\001'
  _FAILURE._serialized_start=317
  _FAILURE._serialized_end=541
  _FAILURE_METADATAENTRY._serialized_start=494
  _FAILURE_METADATAENTRY._serialized_end=541
  _HANDLERERROR._serialized_start=544
  _HANDLERERROR._serialized_end=706
  _UNSUCCESSFULOPERATIONERROR._serialized_start=708
  _UNSUCCESSFULOPERATIONERROR._serialized_end=810
  _LINK._serialized_start=812
  _LINK._serialized_end=845
  _STARTOPERATIONREQUEST._serialized_start=848
  _STARTOPERATIONREQUEST._serialized_end=1185
  _STARTOPERATIONREQUEST_CALLBACKHEADERENTRY._serialized_start=1132
