...
class Failure(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["details", b"details", "message", b"message", "metadata", b"metadata"]) -> None: ...
...
class Request(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cancel_operation", b"cancel_operation", "scheduled_time", b"scheduled_time", "start_operation", b"start_operation", "variant", b"variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cancel_operation", b"cancel_operation", "header", b"header", "scheduled_time", b"scheduled_time", "start_operation", b"start_operation", "variant", b"variant"]) -> None: ...
...
class StartOperationResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["async_success", b"async_success", "operation_error", b"operation_error", "sync_success", b"sync_success", "variant", b"variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["async_success", b"async_success", "operation_error", b"operation_error", "sync_success", b"sync_success", "variant", b"variant"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["sync_success", "async_success", "operation_error"] | None: ...
