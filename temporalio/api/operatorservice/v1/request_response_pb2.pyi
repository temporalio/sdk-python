...
class AddOrUpdateRemoteClusterRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["enable_remote_cluster_connection", b"enable_remote_cluster_connection", "frontend_address", b"frontend_address", "frontend_http_address", b"frontend_http_address"]) -> None: ...
...
class ClusterMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["address", b"address", "cluster_id", b"cluster_id", "cluster_name", b"cluster_name", "history_shard_count", b"history_shard_count", "http_address", b"http_address", "initial_failover_version", b"initial_failover_version", "is_connection_enabled", b"is_connection_enabled"]) -> None: ...
