...
class AddSearchAttributesRequest(google.protobuf.message.Message):
    ...
    @property
    def search_attributes(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, temporalio.api.enums.v1.common_pb2.IndexedValueType.ValueType]:
        """Mapping between search attribute name and its IndexedValueType."""
    namespace: builtins.str
    def __init__(
        self,
        *,
        search_attributes: collections.abc.Mapping[builtins.str, temporalio.api.enums.v1.common_pb2.IndexedValueType.ValueType] | None = ...,
        namespace: builtins.str = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace", b"namespace", "search_attributes", b"search_attributes"]) -> None: ...
...
class RemoveSearchAttributesRequest(google.protobuf.message.Message):
    ...
    NAMESPACE_FIELD_NUMBER: builtins.int
    @property
    def search_attributes(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
...
class ListSearchAttributesResponse(google.protobuf.message.Message):
    ...
    @property
    def custom_attributes(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, temporalio.api.enums.v1.common_pb2.IndexedValueType.ValueType]:
        """Mapping between custom (user-registered) search attribute name to its IndexedValueType."""
    @property
    def system_attributes(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, temporalio.api.enums.v1.common_pb2.IndexedValueType.ValueType]:
        """Mapping between system (predefined) search attribute name to its IndexedValueType."""
    @property
    def storage_schema(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.str]:
        """Mapping from the attribute name to the visibility storage native type."""
    def __init__(
        self,
        *,
        custom_attributes: collections.abc.Mapping[builtins.str, temporalio.api.enums.v1.common_pb2.IndexedValueType.ValueType] | None = ...,
        system_attributes: collections.abc.Mapping[builtins.str, temporalio.api.enums.v1.common_pb2.IndexedValueType.ValueType] | None = ...,
        storage_schema: collections.abc.Mapping[builtins.str, builtins.str] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["custom_attributes", b"custom_attributes", "storage_schema", b"storage_schema", "system_attributes", b"system_attributes"]) -> None: ...
...
class DeleteNamespaceRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["namespace_delete_delay", b"namespace_delete_delay"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace", b"namespace", "namespace_delete_delay", b"namespace_delete_delay", "namespace_id", b"namespace_id"]) -> None: ...
...
class DeleteNamespaceResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deleted_namespace", b"deleted_namespace"]) -> None: ...
...
class AddOrUpdateRemoteClusterRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["enable_remote_cluster_connection", b"enable_remote_cluster_connection", "enable_replication", b"enable_replication", "frontend_address", b"frontend_address", "frontend_http_address", b"frontend_http_address"]) -> None: ...
...
class ListClustersResponse(google.protobuf.message.Message):
    ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: builtins.int
    @property
    def clusters(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___ClusterMetadata]:
...
class ClusterMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["address", b"address", "cluster_id", b"cluster_id", "cluster_name", b"cluster_name", "history_shard_count", b"history_shard_count", "http_address", b"http_address", "initial_failover_version", b"initial_failover_version", "is_connection_enabled", b"is_connection_enabled", "is_replication_enabled", b"is_replication_enabled"]) -> None: ...
...
class UpdateNexusEndpointRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["spec", b"spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["id", b"id", "spec", b"spec", "version", b"version"]) -> None: ...
...
class ListNexusEndpointsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["name", b"name", "next_page_token", b"next_page_token", "page_size", b"page_size"]) -> None: ...
...
class ListNexusEndpointsResponse(google.protobuf.message.Message):
    ...
    @property
    def endpoints(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.nexus.v1.message_pb2.Endpoint]: ...
    def __init__(
        self,
        *,
        next_page_token: builtins.bytes = ...,
