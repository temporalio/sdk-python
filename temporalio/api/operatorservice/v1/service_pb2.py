...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _OPERATORSERVICE.methods_by_name['ListSearchAttributes']._serialized_options = b'\202\323\344\223\002g\0221/cluster/namespaces/{namespace}/search-attributesZ2\0220/api/v1/namespaces/{namespace}/search-attributes'
  _OPERATORSERVICE.methods_by_name['GetNexusEndpoint']._options = None
  _OPERATORSERVICE.methods_by_name['GetNexusEndpoint']._serialized_options = b'\202\323\344\223\002?\022\035/cluster/nexus/endpoints/{id}Z\036\022\034/api/v1/nexus/endpoints/{id}'
  _OPERATORSERVICE.methods_by_name['CreateNexusEndpoint']._options = None
  _OPERATORSERVICE.methods_by_name['CreateNexusEndpoint']._serialized_options = b'\202\323\344\223\002;\"\030/cluster/nexus/endpoints:\001*Z\034\"\027/api/v1/nexus/endpoints:\001*'
  _OPERATORSERVICE.methods_by_name['UpdateNexusEndpoint']._options = None
  _OPERATORSERVICE.methods_by_name['UpdateNexusEndpoint']._serialized_options = b'\202\323\344\223\002S\"$/cluster/nexus/endpoints/{id}/update:\001*Z(\"#/api/v1/nexus/endpoints/{id}/update:\001*'
  _OPERATORSERVICE.methods_by_name['DeleteNexusEndpoint']._options = None
  _OPERATORSERVICE.methods_by_name['DeleteNexusEndpoint']._serialized_options = b'\202\323\344\223\002?*\035/cluster/nexus/endpoints/{id}Z\036*\034/api/v1/nexus/endpoints/{id}'
  _OPERATORSERVICE.methods_by_name['ListNexusEndpoints']._options = None
  _OPERATORSERVICE.methods_by_name['ListNexusEndpoints']._serialized_options = b'\202\323\344\223\0025\022\030/cluster/nexus/endpointsZ\031\022\027/api/v1/nexus/endpoints'
