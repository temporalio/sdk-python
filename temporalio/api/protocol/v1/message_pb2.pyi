...
class Message(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["body", b"body", "command_index", b"command_index", "event_id", b"event_id", "sequencing_id", b"sequencing_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["body", b"body", "command_index", b"command_index", "event_id", b"event_id", "id", b"id", "protocol_instance_id", b"protocol_instance_id", "sequencing_id", b"sequencing_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["sequencing_id", b"sequencing_id"]) -> typing_extensions.Literal["event_id", "command_index"] | None: ...
