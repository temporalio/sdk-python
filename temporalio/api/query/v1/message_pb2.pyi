...
class WorkflowQueryResult(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["answer", b"answer", "failure", b"failure"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["answer", b"answer", "error_message", b"error_message", "failure", b"failure", "result_type", b"result_type"]) -> None: ...
