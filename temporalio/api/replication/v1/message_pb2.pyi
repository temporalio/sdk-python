...
class NamespaceReplicationConfig(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        active_cluster_name: builtins.str = ...,
        clusters: collections.abc.Iterable[global___ClusterReplicationConfig] | None = ...,
        state: temporalio.api.enums.v1.namespace_pb2.ReplicationState.ValueType = ...,
    ) -> None: ...
...
class FailoverStatus(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failover_time", b"failover_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failover_time", b"failover_time", "failover_version", b"failover_version"]) -> None: ...
