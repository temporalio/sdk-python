...
_WORKFLOWRULEACTION_ACTIONACTIVITYPAUSE = _WORKFLOWRULEACTION.nested_types_by_name['ActionActivityPause']
_WORKFLOWRULESPEC = DESCRIPTOR.message_types_by_name['WorkflowRuleSpec']
_WORKFLOWRULESPEC_ACTIVITYSTARTINGTRIGGER = _WORKFLOWRULESPEC.nested_types_by_name['ActivityStartingTrigger']
_WORKFLOWRULE = DESCRIPTOR.message_types_by_name['WorkflowRule']
WorkflowRuleAction = _reflection.GeneratedProtocolMessageType('WorkflowRuleAction', (_message.Message,), {

  'ActionActivityPause' : _reflection.GeneratedProtocolMessageType('ActionActivityPause', (_message.Message,), {
...
WorkflowRuleSpec = _reflection.GeneratedProtocolMessageType('WorkflowRuleSpec', (_message.Message,), {

  'ActivityStartingTrigger' : _reflection.GeneratedProtocolMessageType('ActivityStartingTrigger', (_message.Message,), {
...
WorkflowRule = _reflection.GeneratedProtocolMessageType('WorkflowRule', (_message.Message,), {
