...
class ScheduleListInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["future_action_times", b"future_action_times", "notes", b"notes", "paused", b"paused", "recent_actions", b"recent_actions", "spec", b"spec", "state_size_bytes", b"state_size_bytes", "workflow_type", b"workflow_type"]) -> None: ...
