...
class IntervalSpec(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        phase: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
...
class ScheduleSpec(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        calendar: typing.Optional[typing.Iterable[global___CalendarSpec]] = ...,
        interval: typing.Optional[typing.Iterable[global___IntervalSpec]] = ...,
        exclude_calendar: typing.Optional[typing.Iterable[global___CalendarSpec]] = ...,
        start_time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        end_time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        jitter: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        timezone_name: typing.Text = ...,
        timezone_data: builtins.bytes = ...,
    ) -> None: ...
    def HasField(
...
class SchedulePolicies(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        overlap_policy: temporalio.api.enums.v1.schedule_pb2.ScheduleOverlapPolicy.ValueType = ...,
        catchup_window: typing.Optional[google.protobuf.duration_pb2.Duration] = ...,
        pause_on_failure: builtins.bool = ...,
    ) -> None: ...
    def HasField(
...
class ScheduleAction(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        start_workflow: typing.Optional[
            temporalio.api.workflow.v1.message_pb2.NewWorkflowExecutionInfo
        ] = ...,
    ) -> None: ...
    def HasField(
    ...
    ) -> typing.Optional[typing_extensions.Literal["start_workflow"]]: ...
...
class ScheduleActionResult(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        actual_time: typing.Optional[google.protobuf.timestamp_pb2.Timestamp] = ...,
        start_workflow_result: typing.Optional[
            temporalio.api.common.v1.message_pb2.WorkflowExecution
        ] = ...,
    ) -> None: ...
    def HasField(
...
class SchedulePatch(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        trigger_immediately: typing.Optional[global___TriggerImmediatelyRequest] = ...,
        backfill_request: typing.Optional[
            typing.Iterable[global___BackfillRequest]
        ] = ...,
        pause: typing.Text = ...,
        unpause: typing.Text = ...,
    ) -> None: ...
...
class ScheduleInfo(google.protobuf.message.Message):
    ...
    invalid_schedule_error: typing.Text
    ...
    def __init__(
        ...
        *,
        ...
        missed_catchup_window: builtins.int = ...,
        overlap_skipped: builtins.int = ...,
        running_workflows: typing.Optional[
            typing.Iterable[temporalio.api.common.v1.message_pb2.WorkflowExecution]
        ] = ...,
        recent_actions: typing.Optional[
            typing.Iterable[global___ScheduleActionResult]
        ] = ...,
        future_action_times: typing.Optional[
...
class Schedule(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        spec: typing.Optional[global___ScheduleSpec] = ...,
        action: typing.Optional[global___ScheduleAction] = ...,
        policies: typing.Optional[global___SchedulePolicies] = ...,
        state: typing.Optional[global___ScheduleState] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
...
class ScheduleListEntry(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        info: typing.Optional[global___ScheduleListInfo] = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
