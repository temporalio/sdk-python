...
class EnhancedStackTrace(google.protobuf.message.Message):
    ...
    @property
    def sources(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___StackTraceFileSlice]:
    ...
    def __init__(
        ...
        *,
        ...
        sources: collections.abc.Mapping[builtins.str, global___StackTraceFileSlice] | None = ...,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["sdk", b"sdk", "sources", b"sources", "stacks", b"stacks"]) -> None: ...
...
class StackTraceFileSlice(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["content", b"content", "line_offset", b"line_offset"]) -> None: ...
...
class StackTraceFileLocation(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["column", b"column", "file_path", b"file_path", "function_name", b"function_name", "internal_code", b"internal_code", "line", b"line"]) -> None: ...
...
class StackTrace(google.protobuf.message.Message):
    ...
    @property
    def locations(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___StackTraceFileLocation]:
        """Collection of `FileLocation`s, each for a stack frame that comprise a stack trace."""
    def __init__(
        self,
        *,
        locations: collections.abc.Iterable[global___StackTraceFileLocation] | None = ...,
    ) -> None: ...
