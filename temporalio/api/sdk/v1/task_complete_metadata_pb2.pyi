...
class WorkflowTaskCompletedMetadata(google.protobuf.message.Message):
    ...
    @property
    def core_used_flags(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
        ...
        * The SDK is free to use all flags it knows about. It must record any newly-used (IE: not
        ...
        """
    @property
    def lang_used_flags(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.int]:
    ...
    def ClearField(self, field_name: typing_extensions.Literal["core_used_flags", b"core_used_flags", "lang_used_flags", b"lang_used_flags", "sdk_name", b"sdk_name", "sdk_version", b"sdk_version"]) -> None: ...
