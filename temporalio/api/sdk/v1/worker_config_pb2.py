...
_WORKERCONFIG_SIMPLEPOLLERBEHAVIOR = _WORKERCONFIG.nested_types_by_name['SimplePollerBehavior']
_WORKERCONFIG_AUTOSCALINGPOLLERBEHAVIOR = _WORKERCONFIG.nested_types_by_name['AutoscalingPollerBehavior']
WorkerConfig = _reflection.GeneratedProtocolMessageType('WorkerConfig', (_message.Message,), {

  'SimplePollerBehavior' : _reflection.GeneratedProtocolMessageType('SimplePollerBehavior', (_message.Message,), {
  ...
  'AutoscalingPollerBehavior' : _reflection.GeneratedProtocolMessageType('AutoscalingPollerBehavior', (_message.Message,), {
