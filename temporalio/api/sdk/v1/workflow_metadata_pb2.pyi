...
class WorkflowMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["current_details", b"current_details", "definition", b"definition"]) -> None: ...
...
class WorkflowDefinition(google.protobuf.message.Message):
    ...
    @property
    def update_definitions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___WorkflowInteractionDefinition]:
        """Update definitions, sorted by name."""
    def __init__(
        self,
        *,
        type: builtins.str = ...,
        query_definitions: collections.abc.Iterable[global___WorkflowInteractionDefinition] | None = ...,
        signal_definitions: collections.abc.Iterable[global___WorkflowInteractionDefinition] | None = ...,
        update_definitions: collections.abc.Iterable[global___WorkflowInteractionDefinition] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["query_definitions", b"query_definitions", "signal_definitions", b"signal_definitions", "type", b"type", "update_definitions", b"update_definitions"]) -> None: ...
