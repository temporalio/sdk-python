...
_TASKQUEUEVERSIONSELECTION = DESCRIPTOR.message_types_by_name['TaskQueueVersionSelection']
_TASKQUEUEVERSIONINFO = DESCRIPTOR.message_types_by_name['TaskQueueVersionInfo']
_TASKQUEUEVERSIONINFO_TYPESINFOENTRY = _TASKQUEUEVERSIONINFO.nested_types_by_name['TypesInfoEntry']
...
_COMPATIBLEBUILDIDREDIRECTRULE = DESCRIPTOR.message_types_by_name['CompatibleBuildIdRedirectRule']
_TIMESTAMPEDBUILDIDASSIGNMENTRULE = DESCRIPTOR.message_types_by_name['TimestampedBuildIdAssignmentRule']
_TIMESTAMPEDCOMPATIBLEBUILDIDREDIRECTRULE = DESCRIPTOR.message_types_by_name['TimestampedCompatibleBuildIdRedirectRule']
_POLLERGROUPINFO = DESCRIPTOR.message_types_by_name['PollerGroupInfo']
_POLLERGROUPSINFO = DESCRIPTOR.message_types_by_name['PollerGroupsInfo']
...
_TASKQUEUECONFIG_FAIRNESSWEIGHTOVERRIDESENTRY = _TASKQUEUECONFIG.nested_types_by_name['FairnessWeightOverridesEntry']
...
TaskQueueVersioningInfo = _reflection.GeneratedProtocolMessageType('TaskQueueVersioningInfo', (_message.Message,), {
...
TaskQueueVersionSelection = _reflection.GeneratedProtocolMessageType('TaskQueueVersionSelection', (_message.Message,), {
...
TaskQueueVersionInfo = _reflection.GeneratedProtocolMessageType('TaskQueueVersionInfo', (_message.Message,), {

  'TypesInfoEntry' : _reflection.GeneratedProtocolMessageType('TypesInfoEntry', (_message.Message,), {
...
TaskQueueTypeInfo = _reflection.GeneratedProtocolMessageType('TaskQueueTypeInfo', (_message.Message,), {
...
TaskQueueStats = _reflection.GeneratedProtocolMessageType('TaskQueueStats', (_message.Message,), {
...
CompatibleVersionSet = _reflection.GeneratedProtocolMessageType('CompatibleVersionSet', (_message.Message,), {
...
TaskQueueReachability = _reflection.GeneratedProtocolMessageType('TaskQueueReachability', (_message.Message,), {
...
BuildIdReachability = _reflection.GeneratedProtocolMessageType('BuildIdReachability', (_message.Message,), {
...
RampByPercentage = _reflection.GeneratedProtocolMessageType('RampByPercentage', (_message.Message,), {
...
BuildIdAssignmentRule = _reflection.GeneratedProtocolMessageType('BuildIdAssignmentRule', (_message.Message,), {
...
CompatibleBuildIdRedirectRule = _reflection.GeneratedProtocolMessageType('CompatibleBuildIdRedirectRule', (_message.Message,), {
...
TimestampedBuildIdAssignmentRule = _reflection.GeneratedProtocolMessageType('TimestampedBuildIdAssignmentRule', (_message.Message,), {
...
TimestampedCompatibleBuildIdRedirectRule = _reflection.GeneratedProtocolMessageType('TimestampedCompatibleBuildIdRedirectRule', (_message.Message,), {
...
PollerGroupInfo = _reflection.GeneratedProtocolMessageType('PollerGroupInfo', (_message.Message,), {
  'DESCRIPTOR' : _POLLERGROUPINFO,
  '__module__' : 'temporalio.api.taskqueue.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.taskqueue.v1.PollerGroupInfo)
  })
_sym_db.RegisterMessage(PollerGroupInfo)

PollerGroupsInfo = _reflection.GeneratedProtocolMessageType('PollerGroupsInfo', (_message.Message,), {
  'DESCRIPTOR' : _POLLERGROUPSINFO,
  '__module__' : 'temporalio.api.taskqueue.v1.message_pb2'
  # @@protoc_insertion_point(class_scope:temporal.api.taskqueue.v1.PollerGroupsInfo)
  })
_sym_db.RegisterMessage(PollerGroupsInfo)

PollerScalingDecision = _reflection.GeneratedProtocolMessageType('PollerScalingDecision', (_message.Message,), {
...
TaskQueueConfig = _reflection.GeneratedProtocolMessageType('TaskQueueConfig', (_message.Message,), {

  'FairnessWeightOverridesEntry' : _reflection.GeneratedProtocolMessageType('FairnessWeightOverridesEntry', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _TASKQUEUEVERSIONINGINFO.fields_by_name['current_version']._serialized_options = b'\030\001'
  _TASKQUEUEVERSIONINGINFO.fields_by_name['ramping_version']._options = None
  _TASKQUEUEVERSIONINGINFO.fields_by_name['ramping_version']._serialized_options = b'\030\001'
  ...
  _POLLERINFO.fields_by_name['worker_version_capabilities']._serialized_options = b'\030\001'
  ...
  _TASKQUEUESTATS._serialized_end=1517
  _TASKQUEUESTATUS._serialized_start=1520
  _TASKQUEUESTATUS._serialized_end=1692
  _TASKIDBLOCK._serialized_start=1694
  _TASKIDBLOCK._serialized_end=1741
  _TASKQUEUEPARTITIONMETADATA._serialized_start=1743
  _TASKQUEUEPARTITIONMETADATA._serialized_end=1809
  _POLLERINFO._serialized_start=1812
  _POLLERINFO._serialized_end=2094
  _STICKYEXECUTIONATTRIBUTES._serialized_start=2097
  _STICKYEXECUTIONATTRIBUTES._serialized_end=2251
  _COMPATIBLEVERSIONSET._serialized_start=2253
  _COMPATIBLEVERSIONSET._serialized_end=2294
  _TASKQUEUEREACHABILITY._serialized_start=2296
  _TASKQUEUEREACHABILITY._serialized_end=2402
  _BUILDIDREACHABILITY._serialized_start=2404
  _BUILDIDREACHABILITY._serialized_end=2526
  _RAMPBYPERCENTAGE._serialized_start=2528
  _RAMPBYPERCENTAGE._serialized_end=2571
  _BUILDIDASSIGNMENTRULE._serialized_start=2574
  _BUILDIDASSIGNMENTRULE._serialized_end=2702
  _COMPATIBLEBUILDIDREDIRECTRULE._serialized_start=2704
  _COMPATIBLEBUILDIDREDIRECTRULE._serialized_end=2785
  _TIMESTAMPEDBUILDIDASSIGNMENTRULE._serialized_start=2788
  _TIMESTAMPEDBUILDIDASSIGNMENTRULE._serialized_end=2935
  _TIMESTAMPEDCOMPATIBLEBUILDIDREDIRECTRULE._serialized_start=2938
  _TIMESTAMPEDCOMPATIBLEBUILDIDREDIRECTRULE._serialized_end=3101
  _POLLERGROUPINFO._serialized_start=3103
  _POLLERGROUPINFO._serialized_end=3148
  _POLLERGROUPSINFO._serialized_start=3150
  _POLLERGROUPSINFO._serialized_end=3252
  _POLLERSCALINGDECISION._serialized_start=3254
  _POLLERSCALINGDECISION._serialized_end=3316
  _RATELIMIT._serialized_start=3318
  _RATELIMIT._serialized_end=3358
  _CONFIGMETADATA._serialized_start=3360
  _CONFIGMETADATA._serialized_end=3466
  _RATELIMITCONFIG._serialized_start=3469
  _RATELIMITCONFIG._serialized_end=3605
  _TASKQUEUECONFIG._serialized_start=3608
  _TASKQUEUECONFIG._serialized_end=3953
  _TASKQUEUECONFIG_FAIRNESSWEIGHTOVERRIDESENTRY._serialized_start=3891
  _TASKQUEUECONFIG_FAIRNESSWEIGHTOVERRIDESENTRY._serialized_end=3953
