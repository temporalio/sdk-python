...
class TaskQueue(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["kind", b"kind", "name", b"name", "normal_name", b"normal_name"]) -> None: ...
...
class TaskQueueVersioningInfo(google.protobuf.message.Message):
    ...
    @property
    def current_deployment_version(self) -> temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion:
    ...
    @property
    def ramping_deployment_version(self) -> temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion:
    ...
    def __init__(
        self,
        *,
        current_deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ...,
        current_version: builtins.str = ...,
        ramping_deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ...,
        ramping_version: builtins.str = ...,
        ramping_version_percentage: builtins.float = ...,
        update_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["current_deployment_version", b"current_deployment_version", "ramping_deployment_version", b"ramping_deployment_version", "update_time", b"update_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["current_deployment_version", b"current_deployment_version", "current_version", b"current_version", "ramping_deployment_version", b"ramping_deployment_version", "ramping_version", b"ramping_version", "ramping_version_percentage", b"ramping_version_percentage", "update_time", b"update_time"]) -> None: ...
...
class TaskQueueVersionInfo(google.protobuf.message.Message):
    ...
    @property
    def types_info(self) -> google.protobuf.internal.containers.MessageMap[builtins.int, global___TaskQueueTypeInfo]:
    ...
    def __init__(
        self,
        *,
        types_info: collections.abc.Mapping[builtins.int, global___TaskQueueTypeInfo] | None = ...,
        task_reachability: temporalio.api.enums.v1.task_queue_pb2.BuildIdTaskReachability.ValueType = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["task_reachability", b"task_reachability", "types_info", b"types_info"]) -> None: ...
...
class TaskQueueTypeInfo(google.protobuf.message.Message):
    ...
    @property
    def pollers(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PollerInfo]:
    ...
    def ClearField(self, field_name: typing_extensions.Literal["pollers", b"pollers", "stats", b"stats"]) -> None: ...
...
class TaskQueueStats(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["approximate_backlog_age", b"approximate_backlog_age"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["approximate_backlog_age", b"approximate_backlog_age", "approximate_backlog_count", b"approximate_backlog_count", "rate_limiting_active", b"rate_limiting_active", "tasks_add_rate", b"tasks_add_rate", "tasks_dispatch_rate", b"tasks_dispatch_rate"]) -> None: ...
...
class PollerInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["deployment_options", b"deployment_options", "last_access_time", b"last_access_time", "worker_version_capabilities", b"worker_version_capabilities"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["deployment_options", b"deployment_options", "identity", b"identity", "last_access_time", b"last_access_time", "rate_per_second", b"rate_per_second", "worker_version_capabilities", b"worker_version_capabilities"]) -> None: ...
...
class TaskQueueReachability(google.protobuf.message.Message):
    ...
    @property
    def reachability(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[temporalio.api.enums.v1.task_queue_pb2.TaskReachability.ValueType]:
    ...
    def __init__(
        ...
        *,
        task_queue: builtins.str = ...,
        reachability: collections.abc.Iterable[temporalio.api.enums.v1.task_queue_pb2.TaskReachability.ValueType] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["reachability", b"reachability", "task_queue", b"task_queue"]) -> None: ...
...
class BuildIdReachability(google.protobuf.message.Message):
    ...
    @property
    def task_queue_reachability(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TaskQueueReachability]:
        """Reachability per task queue."""
    def __init__(
        self,
        *,
        build_id: builtins.str = ...,
        task_queue_reachability: collections.abc.Iterable[global___TaskQueueReachability] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["build_id", b"build_id", "task_queue_reachability", b"task_queue_reachability"]) -> None: ...
...
class RampByPercentage(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["ramp_percentage", b"ramp_percentage"]) -> None: ...
...
class BuildIdAssignmentRule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["percentage_ramp", b"percentage_ramp", "ramp", b"ramp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["percentage_ramp", b"percentage_ramp", "ramp", b"ramp", "target_build_id", b"target_build_id"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["ramp", b"ramp"]) -> typing_extensions.Literal["percentage_ramp"] | None: ...
...
class CompatibleBuildIdRedirectRule(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["source_build_id", b"source_build_id", "target_build_id", b"target_build_id"]) -> None: ...
...
class TimestampedBuildIdAssignmentRule(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "rule", b"rule"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_time", b"create_time", "rule", b"rule"]) -> None: ...
...
global___TimestampedCompatibleBuildIdRedirectRule = TimestampedCompatibleBuildIdRedirectRule
...
class PollerGroupsInfo(google.protobuf.message.Message):
    ...
    """
    @property
    def poller_groups(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PollerGroupInfo]:
    ...
    def ClearField(self, field_name: typing_extensions.Literal["poller_groups", b"poller_groups", "version", b"version"]) -> None: ...
...
class PollerScalingDecision(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["poll_request_delta_suggestion", b"poll_request_delta_suggestion"]) -> None: ...
...
class RateLimit(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["requests_per_second", b"requests_per_second"]) -> None: ...
...
class ConfigMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["reason", b"reason", "update_identity", b"update_identity", "update_time", b"update_time"]) -> None: ...
...
class RateLimitConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["metadata", b"metadata", "rate_limit", b"rate_limit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["metadata", b"metadata", "rate_limit", b"rate_limit"]) -> None: ...
...
class TaskQueueConfig(google.protobuf.message.Message):
    ...
    @property
    def fairness_weight_overrides(self) -> google.protobuf.internal.containers.ScalarMap[builtins.str, builtins.float]:
    ...
    def __init__(
        ...
        *,
        ...
        fairness_weight_overrides: collections.abc.Mapping[builtins.str, builtins.float] | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["fairness_keys_rate_limit_default", b"fairness_keys_rate_limit_default", "queue_rate_limit", b"queue_rate_limit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["fairness_keys_rate_limit_default", b"fairness_keys_rate_limit_default", "fairness_weight_overrides", b"fairness_weight_overrides", "queue_rate_limit", b"queue_rate_limit"]) -> None: ...
