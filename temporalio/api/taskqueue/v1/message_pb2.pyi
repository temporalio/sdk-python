...
class TaskQueueStats(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["approximate_backlog_age", b"approximate_backlog_age", "approximate_backlog_count", b"approximate_backlog_count", "tasks_add_rate", b"tasks_add_rate", "tasks_dispatch_rate", b"tasks_dispatch_rate"]) -> None: ...
...
class TaskQueueConfig(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["fairness_keys_rate_limit_default", b"fairness_keys_rate_limit_default", "queue_rate_limit", b"queue_rate_limit"]) -> None: ...
