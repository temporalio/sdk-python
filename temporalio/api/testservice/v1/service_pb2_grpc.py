...
class TestService(object):
    ...
    def LockTimeSkipping(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/temporal.api.testservice.v1.TestService/LockTimeSkipping',
    ...
    @staticmethod
    def UnlockTimeSkipping(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/temporal.api.testservice.v1.TestService/UnlockTimeSkipping',
    ...
    def Sleep(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/temporal.api.testservice.v1.TestService/Sleep',
    ...
    def SleepUntil(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/temporal.api.testservice.v1.TestService/SleepUntil',
    ...
    @staticmethod
    def UnlockTimeSkippingWithSleep(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/temporal.api.testservice.v1.TestService/UnlockTimeSkippingWithSleep',
            temporal_dot_api_dot_testservice_dot_v1_dot_request__response__pb2.SleepRequest.SerializeToString,
            temporal_dot_api_dot_testservice_dot_v1_dot_request__response__pb2.SleepResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def GetCurrentTime(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/temporal.api.testservice.v1.TestService/GetCurrentTime',
