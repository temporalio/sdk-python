...
WaitPolicy = _reflection.GeneratedProtocolMessageType('WaitPolicy', (_message.Message,), {
...
UpdateRef = _reflection.GeneratedProtocolMessageType('UpdateRef', (_message.Message,), {
...
Acceptance = _reflection.GeneratedProtocolMessageType('Acceptance', (_message.Message,), {
