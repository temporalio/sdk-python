...
class WaitPolicy(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["lifecycle_stage", b"lifecycle_stage"]) -> None: ...
...
class UpdateRef(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["update_id", b"update_id", "workflow_execution", b"workflow_execution"]) -> None: ...
...
class Outcome(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["failure", b"failure", "success", b"success", "value", b"value"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["failure", b"failure", "success", b"success", "value", b"value"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["value", b"value"]) -> typing_extensions.Literal["success", "failure"] | None: ...
...
class Meta(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "update_id", b"update_id"]) -> None: ...
...
class Input(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["args", b"args", "header", b"header"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["args", b"args", "header", b"header", "name", b"name"]) -> None: ...
...
class Request(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["input", b"input", "meta", b"meta"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["completion_callbacks", b"completion_callbacks", "input", b"input", "links", b"links", "meta", b"meta", "request_id", b"request_id"]) -> None: ...
...
class Rejection(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["failure", b"failure", "rejected_request", b"rejected_request", "rejected_request_message_id", b"rejected_request_message_id", "rejected_request_sequencing_event_id", b"rejected_request_sequencing_event_id"]) -> None: ...
...
class Acceptance(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["accepted_request", b"accepted_request", "accepted_request_message_id", b"accepted_request_message_id", "accepted_request_sequencing_event_id", b"accepted_request_sequencing_event_id"]) -> None: ...
...
class Response(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["meta", b"meta", "outcome", b"outcome"]) -> None: ...
