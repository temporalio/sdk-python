...
_TIMESKIPPINGCONFIG_AUTOSKIPCONFIG = _TIMESKIPPINGCONFIG.nested_types_by_name[
    "AutoSkipConfig"
]
_TIMESKIPPINGINFO = DESCRIPTOR.message_types_by_name["TimeSkippingInfo"]
_TIMESKIPPINGINFO_AUTOSKIPINFO = _TIMESKIPPINGINFO.nested_types_by_name["AutoSkipInfo"]
_UPCOMINGTIMEPOINTINFO = DESCRIPTOR.message_types_by_name["UpcomingTimePointInfo"]
_UPCOMINGTIMEPOINTINFO_TIMERTIMEPOINT = _UPCOMINGTIMEPOINTINFO.nested_types_by_name[
    "TimerTimePoint"
]
_UPCOMINGTIMEPOINTINFO_ACTIVITYTIMEOUTTIMEPOINT = (
    _UPCOMINGTIMEPOINTINFO.nested_types_by_name["ActivityTimeoutTimePoint"]
)
_UPCOMINGTIMEPOINTINFO_WORKFLOWTIMEOUTTIMEPOINT = (
    _UPCOMINGTIMEPOINTINFO.nested_types_by_name["WorkflowTimeoutTimePoint"]
)
_UPCOMINGTIMEPOINTINFO_CHILDWORKFLOWTIMEPOINT = (
    _UPCOMINGTIMEPOINTINFO.nested_types_by_name["ChildWorkflowTimePoint"]
)
_UPCOMINGTIMEPOINTINFO_NEXUSOPERATIONTIMEOUTTIMEPOINT = (
    _UPCOMINGTIMEPOINTINFO.nested_types_by_name["NexusOperationTimeoutTimePoint"]
)
...
TimeSkippingConfig = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "AutoSkipConfig": _reflection.GeneratedProtocolMessageType(
            "AutoSkipConfig",
            (_message.Message,),
            {
                "DESCRIPTOR": _TIMESKIPPINGCONFIG_AUTOSKIPCONFIG,
                "__module__": "temporalio.api.workflow.v1.message_pb2",
                # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.TimeSkippingConfig.AutoSkipConfig)
            },
        ),
        "DESCRIPTOR": _TIMESKIPPINGCONFIG,
        "__module__": "temporalio.api.workflow.v1.message_pb2",
        # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.TimeSkippingConfig)
    },
)
_sym_db.RegisterMessage(TimeSkippingConfig)
_sym_db.RegisterMessage(TimeSkippingConfig.AutoSkipConfig)

TimeSkippingInfo = _reflection.GeneratedProtocolMessageType(
    "TimeSkippingInfo",
    (_message.Message,),
    {
        "AutoSkipInfo": _reflection.GeneratedProtocolMessageType(
            "AutoSkipInfo",
            (_message.Message,),
            {
                "DESCRIPTOR": _TIMESKIPPINGINFO_AUTOSKIPINFO,
                "__module__": "temporalio.api.workflow.v1.message_pb2",
                # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.TimeSkippingInfo.AutoSkipInfo)
            },
        ),
        "DESCRIPTOR": _TIMESKIPPINGINFO,
        "__module__": "temporalio.api.workflow.v1.message_pb2",
        # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.TimeSkippingInfo)
    },
)
_sym_db.RegisterMessage(TimeSkippingInfo)
_sym_db.RegisterMessage(TimeSkippingInfo.AutoSkipInfo)

UpcomingTimePointInfo = _reflection.GeneratedProtocolMessageType(
    "UpcomingTimePointInfo",
    (_message.Message,),
    {
        "TimerTimePoint": _reflection.GeneratedProtocolMessageType(
            "TimerTimePoint",
            (_message.Message,),
            {
                "DESCRIPTOR": _UPCOMINGTIMEPOINTINFO_TIMERTIMEPOINT,
                "__module__": "temporalio.api.workflow.v1.message_pb2",
                # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.UpcomingTimePointInfo.TimerTimePoint)
            },
        ),
        "ActivityTimeoutTimePoint": _reflection.GeneratedProtocolMessageType(
            "ActivityTimeoutTimePoint",
            (_message.Message,),
            {
                "DESCRIPTOR": _UPCOMINGTIMEPOINTINFO_ACTIVITYTIMEOUTTIMEPOINT,
                "__module__": "temporalio.api.workflow.v1.message_pb2",
                # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.UpcomingTimePointInfo.ActivityTimeoutTimePoint)
            },
        ),
        "WorkflowTimeoutTimePoint": _reflection.GeneratedProtocolMessageType(
            "WorkflowTimeoutTimePoint",
            (_message.Message,),
            {
                "DESCRIPTOR": _UPCOMINGTIMEPOINTINFO_WORKFLOWTIMEOUTTIMEPOINT,
                "__module__": "temporalio.api.workflow.v1.message_pb2",
                # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.UpcomingTimePointInfo.WorkflowTimeoutTimePoint)
            },
        ),
        "ChildWorkflowTimePoint": _reflection.GeneratedProtocolMessageType(
            "ChildWorkflowTimePoint",
            (_message.Message,),
            {
                "DESCRIPTOR": _UPCOMINGTIMEPOINTINFO_CHILDWORKFLOWTIMEPOINT,
                "__module__": "temporalio.api.workflow.v1.message_pb2",
                # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.UpcomingTimePointInfo.ChildWorkflowTimePoint)
            },
        ),
        "NexusOperationTimeoutTimePoint": _reflection.GeneratedProtocolMessageType(
            "NexusOperationTimeoutTimePoint",
            (_message.Message,),
            {
                "DESCRIPTOR": _UPCOMINGTIMEPOINTINFO_NEXUSOPERATIONTIMEOUTTIMEPOINT,
                "__module__": "temporalio.api.workflow.v1.message_pb2",
                # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.UpcomingTimePointInfo.NexusOperationTimeoutTimePoint)
            },
        ),
        "DESCRIPTOR": _UPCOMINGTIMEPOINTINFO,
        "__module__": "temporalio.api.workflow.v1.message_pb2",
        # @@protoc_insertion_point(class_scope:temporal.api.workflow.v1.UpcomingTimePointInfo)
    },
)
_sym_db.RegisterMessage(UpcomingTimePointInfo)
_sym_db.RegisterMessage(UpcomingTimePointInfo.TimerTimePoint)
_sym_db.RegisterMessage(UpcomingTimePointInfo.ActivityTimeoutTimePoint)
_sym_db.RegisterMessage(UpcomingTimePointInfo.WorkflowTimeoutTimePoint)
_sym_db.RegisterMessage(UpcomingTimePointInfo.ChildWorkflowTimePoint)
_sym_db.RegisterMessage(UpcomingTimePointInfo.NexusOperationTimeoutTimePoint)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _WORKFLOWEXECUTIONEXTENDEDINFO._serialized_end = 2401
    _WORKFLOWEXECUTIONEXTENDEDINFO_REQUESTIDINFOSENTRY._serialized_start = 2307
    _WORKFLOWEXECUTIONEXTENDEDINFO_REQUESTIDINFOSENTRY._serialized_end = 2401
    _WORKFLOWEXECUTIONVERSIONINGINFO._serialized_start = 2404
    _WORKFLOWEXECUTIONVERSIONINGINFO._serialized_end = 2930
    _DEPLOYMENTTRANSITION._serialized_start = 2932
    _DEPLOYMENTTRANSITION._serialized_end = 3014
    _DEPLOYMENTVERSIONTRANSITION._serialized_start = 3017
    _DEPLOYMENTVERSIONTRANSITION._serialized_end = 3148
    _WORKFLOWEXECUTIONCONFIG._serialized_start = 3151
    _WORKFLOWEXECUTIONCONFIG._serialized_end = 3478
    _PENDINGACTIVITYINFO._serialized_start = 3481
    _PENDINGACTIVITYINFO._serialized_end = 5206
    _PENDINGACTIVITYINFO_PAUSEINFO._serialized_start = 4850
    _PENDINGACTIVITYINFO_PAUSEINFO._serialized_end = 5185
    _PENDINGACTIVITYINFO_PAUSEINFO_MANUAL._serialized_start = 5071
    _PENDINGACTIVITYINFO_PAUSEINFO_MANUAL._serialized_end = 5113
    _PENDINGACTIVITYINFO_PAUSEINFO_RULE._serialized_start = 5115
    _PENDINGACTIVITYINFO_PAUSEINFO_RULE._serialized_end = 5172
    _PENDINGCHILDEXECUTIONINFO._serialized_start = 5209
    _PENDINGCHILDEXECUTIONINFO._serialized_end = 5394
    _PENDINGWORKFLOWTASKINFO._serialized_start = 5397
    _PENDINGWORKFLOWTASKINFO._serialized_end = 5666
    _RESETPOINTS._serialized_start = 5668
    _RESETPOINTS._serialized_end = 5739
    _RESETPOINTINFO._serialized_start = 5742
    _RESETPOINTINFO._serialized_end = 5981
    _NEWWORKFLOWEXECUTIONINFO._serialized_start = 5984
    _NEWWORKFLOWEXECUTIONINFO._serialized_end = 6885
    _CALLBACKINFO._serialized_start = 6888
    _CALLBACKINFO._serialized_end = 7482
    _CALLBACKINFO_WORKFLOWCLOSED._serialized_start = 7362
    _CALLBACKINFO_WORKFLOWCLOSED._serialized_end = 7378
    _CALLBACKINFO_TRIGGER._serialized_start = 7380
    _CALLBACKINFO_TRIGGER._serialized_end = 7482
    _PENDINGNEXUSOPERATIONINFO._serialized_start = 7485
    _PENDINGNEXUSOPERATIONINFO._serialized_end = 8264
    _NEXUSOPERATIONCANCELLATIONINFO._serialized_start = 8267
    _NEXUSOPERATIONCANCELLATIONINFO._serialized_end = 8655
    _WORKFLOWEXECUTIONOPTIONS._serialized_start = 8658
    _WORKFLOWEXECUTIONOPTIONS._serialized_end = 8887
    _TIMESKIPPINGCONFIG._serialized_start = 8890
    _TIMESKIPPINGCONFIG._serialized_end = 9232
    _TIMESKIPPINGCONFIG_AUTOSKIPCONFIG._serialized_start = 9083
    _TIMESKIPPINGCONFIG_AUTOSKIPCONFIG._serialized_end = 9232
    _TIMESKIPPINGINFO._serialized_start = 9235
    _TIMESKIPPINGINFO._serialized_end = 9680
    _TIMESKIPPINGINFO_AUTOSKIPINFO._serialized_start = 9500
    _TIMESKIPPINGINFO_AUTOSKIPINFO._serialized_end = 9680
    _UPCOMINGTIMEPOINTINFO._serialized_start = 9683
    _UPCOMINGTIMEPOINTINFO._serialized_end = 10838
    _UPCOMINGTIMEPOINTINFO_TIMERTIMEPOINT._serialized_start = 10309
    _UPCOMINGTIMEPOINTINFO_TIMERTIMEPOINT._serialized_end = 10369
    _UPCOMINGTIMEPOINTINFO_ACTIVITYTIMEOUTTIMEPOINT._serialized_start = 10371
    _UPCOMINGTIMEPOINTINFO_ACTIVITYTIMEOUTTIMEPOINT._serialized_end = 10476
    _UPCOMINGTIMEPOINTINFO_WORKFLOWTIMEOUTTIMEPOINT._serialized_start = 10478
    _UPCOMINGTIMEPOINTINFO_WORKFLOWTIMEOUTTIMEPOINT._serialized_end = 10562
    _UPCOMINGTIMEPOINTINFO_CHILDWORKFLOWTIMEPOINT._serialized_start = 10564
    _UPCOMINGTIMEPOINTINFO_CHILDWORKFLOWTIMEPOINT._serialized_end = 10653
    _UPCOMINGTIMEPOINTINFO_NEXUSOPERATIONTIMEOUTTIMEPOINT._serialized_start = 10656
    _UPCOMINGTIMEPOINTINFO_NEXUSOPERATIONTIMEOUTTIMEPOINT._serialized_end = 10828
    _VERSIONINGOVERRIDE._serialized_start = 10841
    _VERSIONINGOVERRIDE._serialized_end = 11414
    _VERSIONINGOVERRIDE_PINNEDOVERRIDE._serialized_start = 11124
    _VERSIONINGOVERRIDE_PINNEDOVERRIDE._serialized_end = 11297
    _VERSIONINGOVERRIDE_PINNEDOVERRIDEBEHAVIOR._serialized_start = 11299
    _VERSIONINGOVERRIDE_PINNEDOVERRIDEBEHAVIOR._serialized_end = 11402
    _ONCONFLICTOPTIONS._serialized_start = 11416
    _ONCONFLICTOPTIONS._serialized_end = 11521
    _REQUESTIDINFO._serialized_start = 11523
    _REQUESTIDINFO._serialized_end = 11628
    _POSTRESETOPERATION._serialized_start = 11631
    _POSTRESETOPERATION._serialized_end = 12198
    _POSTRESETOPERATION_SIGNALWORKFLOW._serialized_start = 11845
    _POSTRESETOPERATION_SIGNALWORKFLOW._serialized_end = 12024
    _POSTRESETOPERATION_UPDATEWORKFLOWOPTIONS._serialized_start = 12027
    _POSTRESETOPERATION_UPDATEWORKFLOWOPTIONS._serialized_end = 12187
    _WORKFLOWEXECUTIONPAUSEINFO._serialized_start = 12200
    _WORKFLOWEXECUTIONPAUSEINFO._serialized_end = 12311
