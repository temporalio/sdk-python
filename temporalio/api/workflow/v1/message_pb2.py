...
_WORKFLOWEXECUTIONEXTENDEDINFO = DESCRIPTOR.message_types_by_name['WorkflowExecutionExtendedInfo']
_WORKFLOWEXECUTIONEXTENDEDINFO_REQUESTIDINFOSENTRY = _WORKFLOWEXECUTIONEXTENDEDINFO.nested_types_by_name['RequestIdInfosEntry']
_WORKFLOWEXECUTIONVERSIONINGINFO = DESCRIPTOR.message_types_by_name['WorkflowExecutionVersioningInfo']
_DEPLOYMENTTRANSITION = DESCRIPTOR.message_types_by_name['DeploymentTransition']
_DEPLOYMENTVERSIONTRANSITION = DESCRIPTOR.message_types_by_name['DeploymentVersionTransition']
...
_PENDINGACTIVITYINFO_PAUSEINFO_MANUAL = _PENDINGACTIVITYINFO_PAUSEINFO.nested_types_by_name['Manual']
_PENDINGACTIVITYINFO_PAUSEINFO_RULE = _PENDINGACTIVITYINFO_PAUSEINFO.nested_types_by_name['Rule']
...
_CALLBACKINFO_UPDATEWORKFLOWEXECUTIONCOMPLETED = _CALLBACKINFO.nested_types_by_name['UpdateWorkflowExecutionCompleted']
_CALLBACKINFO_TRIGGER = _CALLBACKINFO.nested_types_by_name['Trigger']
_PENDINGNEXUSOPERATIONINFO = DESCRIPTOR.message_types_by_name['PendingNexusOperationInfo']
_NEXUSOPERATIONCANCELLATIONINFO = DESCRIPTOR.message_types_by_name['NexusOperationCancellationInfo']
...
_VERSIONINGOVERRIDE_PINNEDOVERRIDE = _VERSIONINGOVERRIDE.nested_types_by_name['PinnedOverride']
_VERSIONINGOVERRIDE_ONETIMEOVERRIDE = _VERSIONINGOVERRIDE.nested_types_by_name['OneTimeOverride']
...
_POSTRESETOPERATION_SIGNALWORKFLOW = _POSTRESETOPERATION.nested_types_by_name['SignalWorkflow']
_POSTRESETOPERATION_UPDATEWORKFLOWOPTIONS = _POSTRESETOPERATION.nested_types_by_name['UpdateWorkflowOptions']
_WORKFLOWEXECUTIONPAUSEINFO = DESCRIPTOR.message_types_by_name['WorkflowExecutionPauseInfo']
_VERSIONINGOVERRIDE_PINNEDOVERRIDEBEHAVIOR = _VERSIONINGOVERRIDE.enum_types_by_name['PinnedOverrideBehavior']
...
WorkflowExecutionExtendedInfo = _reflection.GeneratedProtocolMessageType('WorkflowExecutionExtendedInfo', (_message.Message,), {

  'RequestIdInfosEntry' : _reflection.GeneratedProtocolMessageType('RequestIdInfosEntry', (_message.Message,), {
...
WorkflowExecutionVersioningInfo = _reflection.GeneratedProtocolMessageType('WorkflowExecutionVersioningInfo', (_message.Message,), {
...
DeploymentTransition = _reflection.GeneratedProtocolMessageType('DeploymentTransition', (_message.Message,), {
...
DeploymentVersionTransition = _reflection.GeneratedProtocolMessageType('DeploymentVersionTransition', (_message.Message,), {
...
PendingActivityInfo = _reflection.GeneratedProtocolMessageType('PendingActivityInfo', (_message.Message,), {
  ...
  'PauseInfo' : _reflection.GeneratedProtocolMessageType('PauseInfo', (_message.Message,), {
...
NewWorkflowExecutionInfo = _reflection.GeneratedProtocolMessageType('NewWorkflowExecutionInfo', (_message.Message,), {
...
CallbackInfo = _reflection.GeneratedProtocolMessageType('CallbackInfo', (_message.Message,), {

  'WorkflowClosed' : _reflection.GeneratedProtocolMessageType('WorkflowClosed', (_message.Message,), {
  ...
  'UpdateWorkflowExecutionCompleted' : _reflection.GeneratedProtocolMessageType('UpdateWorkflowExecutionCompleted', (_message.Message,), {
...
PendingNexusOperationInfo = _reflection.GeneratedProtocolMessageType('PendingNexusOperationInfo', (_message.Message,), {
...
NexusOperationCancellationInfo = _reflection.GeneratedProtocolMessageType('NexusOperationCancellationInfo', (_message.Message,), {
...
WorkflowExecutionOptions = _reflection.GeneratedProtocolMessageType('WorkflowExecutionOptions', (_message.Message,), {
...
VersioningOverride = _reflection.GeneratedProtocolMessageType('VersioningOverride', (_message.Message,), {

  'PinnedOverride' : _reflection.GeneratedProtocolMessageType('PinnedOverride', (_message.Message,), {
  ...
  'OneTimeOverride' : _reflection.GeneratedProtocolMessageType('OneTimeOverride', (_message.Message,), {
...
OnConflictOptions = _reflection.GeneratedProtocolMessageType('OnConflictOptions', (_message.Message,), {
...
RequestIdInfo = _reflection.GeneratedProtocolMessageType('RequestIdInfo', (_message.Message,), {
...
PostResetOperation = _reflection.GeneratedProtocolMessageType('PostResetOperation', (_message.Message,), {
  ...
  'UpdateWorkflowOptions' : _reflection.GeneratedProtocolMessageType('UpdateWorkflowOptions', (_message.Message,), {
...
WorkflowExecutionPauseInfo = _reflection.GeneratedProtocolMessageType('WorkflowExecutionPauseInfo', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _WORKFLOWEXECUTIONINFO.fields_by_name['most_recent_worker_version_stamp']._options = None
  _WORKFLOWEXECUTIONINFO.fields_by_name['most_recent_worker_version_stamp']._serialized_options = b'\030\001'
  _WORKFLOWEXECUTIONINFO.fields_by_name['assigned_build_id']._options = None
  _WORKFLOWEXECUTIONINFO.fields_by_name['assigned_build_id']._serialized_options = b'\030\001'
  _WORKFLOWEXECUTIONINFO.fields_by_name['inherited_build_id']._options = None
  _WORKFLOWEXECUTIONINFO.fields_by_name['inherited_build_id']._serialized_options = b'\030\001'
  ...
  _WORKFLOWEXECUTIONVERSIONINGINFO.fields_by_name['deployment']._serialized_options = b'\030\001'
  _WORKFLOWEXECUTIONVERSIONINGINFO.fields_by_name['version']._options = None
  _WORKFLOWEXECUTIONVERSIONINGINFO.fields_by_name['version']._serialized_options = b'\030\001'
  _WORKFLOWEXECUTIONVERSIONINGINFO.fields_by_name['deployment_transition']._options = None
  _WORKFLOWEXECUTIONVERSIONINGINFO.fields_by_name['deployment_transition']._serialized_options = b'\030\001'
  _DEPLOYMENTVERSIONTRANSITION.fields_by_name['version']._options = None
  _DEPLOYMENTVERSIONTRANSITION.fields_by_name['version']._serialized_options = b'\030\001'
  _PENDINGACTIVITYINFO.fields_by_name['use_workflow_build_id']._options = None
  _PENDINGACTIVITYINFO.fields_by_name['use_workflow_build_id']._serialized_options = b'\030\001'
  _PENDINGACTIVITYINFO.fields_by_name['last_independently_assigned_build_id']._options = None
  _PENDINGACTIVITYINFO.fields_by_name['last_independently_assigned_build_id']._serialized_options = b'\030\001'
  _PENDINGACTIVITYINFO.fields_by_name['last_worker_version_stamp']._options = None
  _PENDINGACTIVITYINFO.fields_by_name['last_worker_version_stamp']._serialized_options = b'\030\001'
  _PENDINGACTIVITYINFO.fields_by_name['last_deployment']._options = None
  _PENDINGACTIVITYINFO.fields_by_name['last_deployment']._serialized_options = b'\030\001'
  _PENDINGACTIVITYINFO.fields_by_name['last_worker_deployment_version']._options = None
  _PENDINGACTIVITYINFO.fields_by_name['last_worker_deployment_version']._serialized_options = b'\030\001'
  ...
  _PENDINGNEXUSOPERATIONINFO.fields_by_name['operation_id']._serialized_options = b'\030\001'
  ...
  _VERSIONINGOVERRIDE.fields_by_name['pinned_version']._serialized_options = b'\030\001'
  ...
  _CALLBACKINFO._serialized_end=7837
  _CALLBACKINFO_WORKFLOWCLOSED._serialized_start=7541
  _CALLBACKINFO_WORKFLOWCLOSED._serialized_end=7557
  _CALLBACKINFO_UPDATEWORKFLOWEXECUTIONCOMPLETED._serialized_start=7559
  _CALLBACKINFO_UPDATEWORKFLOWEXECUTIONCOMPLETED._serialized_end=7612
  _CALLBACKINFO_TRIGGER._serialized_start=7615
  _CALLBACKINFO_TRIGGER._serialized_end=7837
  _PENDINGNEXUSOPERATIONINFO._serialized_start=7840
  _PENDINGNEXUSOPERATIONINFO._serialized_end=8619
  _NEXUSOPERATIONCANCELLATIONINFO._serialized_start=8622
  _NEXUSOPERATIONCANCELLATIONINFO._serialized_end=9010
  _WORKFLOWEXECUTIONOPTIONS._serialized_start=9013
  _WORKFLOWEXECUTIONOPTIONS._serialized_end=9240
  _VERSIONINGOVERRIDE._serialized_start=9243
  _VERSIONINGOVERRIDE._serialized_end=10005
  _VERSIONINGOVERRIDE_PINNEDOVERRIDE._serialized_start=9608
  _VERSIONINGOVERRIDE_PINNEDOVERRIDE._serialized_end=9781
  _VERSIONINGOVERRIDE_ONETIMEOVERRIDE._serialized_start=9783
  _VERSIONINGOVERRIDE_ONETIMEOVERRIDE._serialized_end=9888
  _VERSIONINGOVERRIDE_PINNEDOVERRIDEBEHAVIOR._serialized_start=9890
  _VERSIONINGOVERRIDE_PINNEDOVERRIDEBEHAVIOR._serialized_end=9993
  _ONCONFLICTOPTIONS._serialized_start=10007
  _ONCONFLICTOPTIONS._serialized_end=10112
  _REQUESTIDINFO._serialized_start=10114
  _REQUESTIDINFO._serialized_end=10219
  _POSTRESETOPERATION._serialized_start=10222
  _POSTRESETOPERATION._serialized_end=10789
  _POSTRESETOPERATION_SIGNALWORKFLOW._serialized_start=10436
  _POSTRESETOPERATION_SIGNALWORKFLOW._serialized_end=10615
  _POSTRESETOPERATION_UPDATEWORKFLOWOPTIONS._serialized_start=10618
  _POSTRESETOPERATION_UPDATEWORKFLOWOPTIONS._serialized_end=10778
  _WORKFLOWEXECUTIONPAUSEINFO._serialized_start=10791
  _WORKFLOWEXECUTIONPAUSEINFO._serialized_end=10902
