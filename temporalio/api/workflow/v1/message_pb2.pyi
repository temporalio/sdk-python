...
class WorkflowExecutionInfo(google.protobuf.message.Message):
    ...
    @property
    def most_recent_worker_version_stamp(self) -> temporalio.api.common.v1.message_pb2.WorkerVersionStamp:
    ...
    def __init__(
        ...
        *,
        ...
        history_length: builtins.int = ...,
        parent_namespace_id: builtins.str = ...,
        parent_execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ...,
        ...
        state_transition_count: builtins.int = ...,
        history_size_bytes: builtins.int = ...,
        most_recent_worker_version_stamp: temporalio.api.common.v1.message_pb2.WorkerVersionStamp | None = ...,
        execution_duration: google.protobuf.duration_pb2.Duration | None = ...,
        root_execution: temporalio.api.common.v1.message_pb2.WorkflowExecution | None = ...,
        assigned_build_id: builtins.str = ...,
        inherited_build_id: builtins.str = ...,
        first_run_id: builtins.str = ...,
    ...
    def HasField(self, field_name: typing_extensions.Literal["auto_reset_points", b"auto_reset_points", "close_time", b"close_time", "execution", b"execution", "execution_duration", b"execution_duration", "execution_time", b"execution_time", "memo", b"memo", "most_recent_worker_version_stamp", b"most_recent_worker_version_stamp", "parent_execution", b"parent_execution", "priority", b"priority", "root_execution", b"root_execution", "search_attributes", b"search_attributes", "start_time", b"start_time", "type", b"type", "versioning_info", b"versioning_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["assigned_build_id", b"assigned_build_id", "auto_reset_points", b"auto_reset_points", "close_time", b"close_time", "execution", b"execution", "execution_duration", b"execution_duration", "execution_time", b"execution_time", "external_payload_count", b"external_payload_count", "external_payload_size_bytes", b"external_payload_size_bytes", "first_run_id", b"first_run_id", "history_length", b"history_length", "history_size_bytes", b"history_size_bytes", "inherited_build_id", b"inherited_build_id", "memo", b"memo", "most_recent_worker_version_stamp", b"most_recent_worker_version_stamp", "parent_execution", b"parent_execution", "parent_namespace_id", b"parent_namespace_id", "priority", b"priority", "root_execution", b"root_execution", "search_attributes", b"search_attributes", "start_time", b"start_time", "state_transition_count", b"state_transition_count", "status", b"status", "task_queue", b"task_queue", "type", b"type", "versioning_info", b"versioning_info", "worker_deployment_name", b"worker_deployment_name"]) -> None: ...
...
class WorkflowExecutionExtendedInfo(google.protobuf.message.Message):
    ...
    @property
    def request_id_infos(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___RequestIdInfo]:
    ...
    @property
    def time_skipping_info(self) -> temporalio.api.common.v1.message_pb2.TimeSkippingInfo:
    ...
    def __init__(
        ...
        *,
        ...
        reset_run_id: builtins.str = ...,
        request_id_infos: collections.abc.Mapping[builtins.str, global___RequestIdInfo] | None = ...,
        pause_info: global___WorkflowExecutionPauseInfo | None = ...,
        time_skipping_info: temporalio.api.common.v1.message_pb2.TimeSkippingInfo | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["execution_expiration_time", b"execution_expiration_time", "last_reset_time", b"last_reset_time", "original_start_time", b"original_start_time", "pause_info", b"pause_info", "run_expiration_time", b"run_expiration_time", "time_skipping_info", b"time_skipping_info"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cancel_requested", b"cancel_requested", "execution_expiration_time", b"execution_expiration_time", "last_reset_time", b"last_reset_time", "original_start_time", b"original_start_time", "pause_info", b"pause_info", "request_id_infos", b"request_id_infos", "reset_run_id", b"reset_run_id", "run_expiration_time", b"run_expiration_time", "time_skipping_info", b"time_skipping_info"]) -> None: ...
...
class WorkflowExecutionVersioningInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["deployment", b"deployment", "deployment_transition", b"deployment_transition", "deployment_version", b"deployment_version", "version_transition", b"version_transition", "versioning_override", b"versioning_override"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["behavior", b"behavior", "continue_as_new_initial_versioning_behavior", b"continue_as_new_initial_versioning_behavior", "deployment", b"deployment", "deployment_transition", b"deployment_transition", "deployment_version", b"deployment_version", "revision_number", b"revision_number", "version", b"version", "version_transition", b"version_transition", "versioning_override", b"versioning_override"]) -> None: ...
...
class DeploymentVersionTransition(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deployment_version", b"deployment_version", "version", b"version"]) -> None: ...
...
class WorkflowExecutionConfig(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        default_workflow_task_timeout: google.protobuf.duration_pb2.Duration | None = ...,
        user_metadata: temporalio.api.sdk.v1.user_metadata_pb2.UserMetadata | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["default_workflow_task_timeout", b"default_workflow_task_timeout", "task_queue", b"task_queue", "user_metadata", b"user_metadata", "workflow_execution_timeout", b"workflow_execution_timeout", "workflow_run_timeout", b"workflow_run_timeout"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["default_workflow_task_timeout", b"default_workflow_task_timeout", "task_queue", b"task_queue", "user_metadata", b"user_metadata", "workflow_execution_timeout", b"workflow_execution_timeout", "workflow_run_timeout", b"workflow_run_timeout"]) -> None: ...
...
class PendingActivityInfo(google.protobuf.message.Message):
    ...
    class PauseInfo(google.protobuf.message.Message):
        ...
        class Manual(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "reason", b"reason"]) -> None: ...
        ...
        class Rule(google.protobuf.message.Message):
            ...
            def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "reason", b"reason", "rule_id", b"rule_id"]) -> None: ...
        ...
        def HasField(self, field_name: typing_extensions.Literal["manual", b"manual", "pause_time", b"pause_time", "paused_by", b"paused_by", "rule", b"rule"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["manual", b"manual", "pause_time", b"pause_time", "paused_by", b"paused_by", "rule", b"rule"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["paused_by", b"paused_by"]) -> typing_extensions.Literal["manual", "rule"] | None: ...
    ...
    """
    @property
    def last_worker_version_stamp(self) -> temporalio.api.common.v1.message_pb2.WorkerVersionStamp:
    ...
    """
    @property
    def last_deployment_version(self) -> temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion:
        """The Worker Deployment Version this activity was dispatched to most recently.
    ...
    def __init__(
        ...
        *,
        ...
        last_independently_assigned_build_id: builtins.str = ...,
        last_worker_version_stamp: temporalio.api.common.v1.message_pb2.WorkerVersionStamp | None = ...,
        current_retry_interval: google.protobuf.duration_pb2.Duration | None = ...,
        last_attempt_complete_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        next_attempt_schedule_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        paused: builtins.bool = ...,
        last_deployment: temporalio.api.deployment.v1.message_pb2.Deployment | None = ...,
        last_worker_deployment_version: builtins.str = ...,
        last_deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ...,
        priority: temporalio.api.common.v1.message_pb2.Priority | None = ...,
...
class ResetPointInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["binary_checksum", b"binary_checksum", "build_id", b"build_id", "create_time", b"create_time", "expire_time", b"expire_time", "first_workflow_task_completed_id", b"first_workflow_task_completed_id", "resettable", b"resettable", "run_id", b"run_id"]) -> None: ...
...
class CallbackInfo(google.protobuf.message.Message):
    ...
    class UpdateWorkflowExecutionCompleted(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["update_id", b"update_id"]) -> None: ...
    ...
    class Trigger(google.protobuf.message.Message):
        ...
        @property
        def update_workflow_execution_completed(self) -> global___CallbackInfo.UpdateWorkflowExecutionCompleted: ...
        def __init__(
            self,
            *,
            workflow_closed: global___CallbackInfo.WorkflowClosed | None = ...,
            update_workflow_execution_completed: global___CallbackInfo.UpdateWorkflowExecutionCompleted | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["update_workflow_execution_completed", b"update_workflow_execution_completed", "variant", b"variant", "workflow_closed", b"workflow_closed"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["update_workflow_execution_completed", b"update_workflow_execution_completed", "variant", b"variant", "workflow_closed", b"workflow_closed"]) -> None: ...
        def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["workflow_closed", "update_workflow_execution_completed"] | None: ...
    ...
    def __init__(
        ...
        *,
        ...
        attempt: builtins.int = ...,
        last_attempt_complete_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        last_attempt_failure: temporalio.api.failure.v1.message_pb2.Failure | None = ...,
        next_attempt_schedule_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        blocked_reason: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["callback", b"callback", "last_attempt_complete_time", b"last_attempt_complete_time", "last_attempt_failure", b"last_attempt_failure", "next_attempt_schedule_time", b"next_attempt_schedule_time", "registration_time", b"registration_time", "trigger", b"trigger"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attempt", b"attempt", "blocked_reason", b"blocked_reason", "callback", b"callback", "last_attempt_complete_time", b"last_attempt_complete_time", "last_attempt_failure", b"last_attempt_failure", "next_attempt_schedule_time", b"next_attempt_schedule_time", "registration_time", b"registration_time", "state", b"state", "trigger", b"trigger"]) -> None: ...
...
class NexusOperationCancellationInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["last_attempt_complete_time", b"last_attempt_complete_time", "last_attempt_failure", b"last_attempt_failure", "next_attempt_schedule_time", b"next_attempt_schedule_time", "requested_time", b"requested_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attempt", b"attempt", "blocked_reason", b"blocked_reason", "last_attempt_complete_time", b"last_attempt_complete_time", "last_attempt_failure", b"last_attempt_failure", "next_attempt_schedule_time", b"next_attempt_schedule_time", "requested_time", b"requested_time", "state", b"state"]) -> None: ...
...
class WorkflowExecutionOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["priority", b"priority", "time_skipping_config", b"time_skipping_config", "versioning_override", b"versioning_override"]) -> None: ...
...
class VersioningOverride(google.protobuf.message.Message):
    ...
    class _PinnedOverrideBehaviorEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[VersioningOverride._PinnedOverrideBehavior.ValueType], builtins.type):  # noqa: F821
        DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
        PINNED_OVERRIDE_BEHAVIOR_UNSPECIFIED: VersioningOverride._PinnedOverrideBehavior.ValueType  # 0
        """Unspecified."""
        PINNED_OVERRIDE_BEHAVIOR_PINNED: VersioningOverride._PinnedOverrideBehavior.ValueType  # 1
        """Override workflow behavior to be Pinned."""

    class PinnedOverrideBehavior(_PinnedOverrideBehavior, metaclass=_PinnedOverrideBehaviorEnumTypeWrapper): ...
    PINNED_OVERRIDE_BEHAVIOR_UNSPECIFIED: VersioningOverride.PinnedOverrideBehavior.ValueType  # 0
    """Unspecified."""
    PINNED_OVERRIDE_BEHAVIOR_PINNED: VersioningOverride.PinnedOverrideBehavior.ValueType  # 1
    """Override workflow behavior to be Pinned."""
    ...
    class PinnedOverride(google.protobuf.message.Message):
        ...
        """
        @property
        def version(self) -> temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion:
        ...
        def __init__(
            ...
            *,
            behavior: global___VersioningOverride.PinnedOverrideBehavior.ValueType = ...,
            version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["version", b"version"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["behavior", b"behavior", "version", b"version"]) -> None: ...
    ...
    class OneTimeOverride(google.protobuf.message.Message):
        ...
        @property
        def target_deployment_version(self) -> temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion:
            """Required. Worker Deployment Version to receive the one-time Workflow Task."""
        def __init__(
            self,
            *,
            target_deployment_version: temporalio.api.deployment.v1.message_pb2.WorkerDeploymentVersion | None = ...,
        ) -> None: ...
        def HasField(self, field_name: typing_extensions.Literal["target_deployment_version", b"target_deployment_version"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["target_deployment_version", b"target_deployment_version"]) -> None: ...
    ...
    def HasField(self, field_name: typing_extensions.Literal["auto_upgrade", b"auto_upgrade", "deployment", b"deployment", "one_time", b"one_time", "override", b"override", "pinned", b"pinned"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["auto_upgrade", b"auto_upgrade", "behavior", b"behavior", "deployment", b"deployment", "one_time", b"one_time", "override", b"override", "pinned", b"pinned", "pinned_version", b"pinned_version"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["override", b"override"]) -> typing_extensions.Literal["pinned", "auto_upgrade", "one_time"] | None: ...
...
class OnConflictOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["attach_completion_callbacks", b"attach_completion_callbacks", "attach_links", b"attach_links", "attach_request_id", b"attach_request_id"]) -> None: ...
...
class RequestIdInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["buffered", b"buffered", "event_id", b"event_id", "event_type", b"event_type"]) -> None: ...
...
class PostResetOperation(google.protobuf.message.Message):
    ...
    class SignalWorkflow(google.protobuf.message.Message):
        ...
        def ClearField(self, field_name: typing_extensions.Literal["header", b"header", "input", b"input", "links", b"links", "signal_name", b"signal_name"]) -> None: ...
    ...
    class UpdateWorkflowOptions(google.protobuf.message.Message):
        ...
        def HasField(self, field_name: typing_extensions.Literal["update_mask", b"update_mask", "workflow_execution_options", b"workflow_execution_options"]) -> builtins.bool: ...
        def ClearField(self, field_name: typing_extensions.Literal["update_mask", b"update_mask", "workflow_execution_options", b"workflow_execution_options"]) -> None: ...
    ...
    @property
    def update_workflow_options(self) -> global___PostResetOperation.UpdateWorkflowOptions: ...
    def __init__(
        self,
        *,
        signal_workflow: global___PostResetOperation.SignalWorkflow | None = ...,
        update_workflow_options: global___PostResetOperation.UpdateWorkflowOptions | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["signal_workflow", b"signal_workflow", "update_workflow_options", b"update_workflow_options", "variant", b"variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["signal_workflow", b"signal_workflow", "update_workflow_options", b"update_workflow_options", "variant", b"variant"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["variant", b"variant"]) -> typing_extensions.Literal["signal_workflow", "update_workflow_options"] | None: ...
...
class WorkflowExecutionPauseInfo(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["paused_time", b"paused_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "paused_time", b"paused_time", "reason", b"reason"]) -> None: ...
