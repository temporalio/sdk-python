...
class DescribeNamespaceResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["config", b"config", "failover_history", b"failover_history", "failover_version", b"failover_version", "is_global_namespace", b"is_global_namespace", "namespace_info", b"namespace_info", "replication_config", b"replication_config"]) -> None: ...
...
class StartWorkflowExecutionResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["eager_workflow_task", b"eager_workflow_task", "link", b"link", "run_id", b"run_id", "started", b"started", "status", b"status"]) -> None: ...
...
class PollWorkflowTaskQueueRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["deployment_options", b"deployment_options", "task_queue", b"task_queue", "worker_heartbeat", b"worker_heartbeat", "worker_version_capabilities", b"worker_version_capabilities"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["binary_checksum", b"binary_checksum", "deployment_options", b"deployment_options", "identity", b"identity", "namespace", b"namespace", "task_queue", b"task_queue", "worker_heartbeat", b"worker_heartbeat", "worker_version_capabilities", b"worker_version_capabilities"]) -> None: ...
...
class PollWorkflowTaskQueueResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["history", b"history", "poller_scaling_decision", b"poller_scaling_decision", "query", b"query", "scheduled_time", b"scheduled_time", "started_time", b"started_time", "workflow_execution", b"workflow_execution", "workflow_execution_task_queue", b"workflow_execution_task_queue", "workflow_type", b"workflow_type"]) -> builtins.bool: ...
...
class RespondWorkflowTaskFailedRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["binary_checksum", b"binary_checksum", "cause", b"cause", "deployment", b"deployment", "deployment_options", b"deployment_options", "failure", b"failure", "identity", b"identity", "messages", b"messages", "namespace", b"namespace", "task_token", b"task_token", "worker_version", b"worker_version"]) -> None: ...
...
class PollActivityTaskQueueRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["deployment_options", b"deployment_options", "task_queue", b"task_queue", "task_queue_metadata", b"task_queue_metadata", "worker_heartbeat", b"worker_heartbeat", "worker_version_capabilities", b"worker_version_capabilities"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["deployment_options", b"deployment_options", "identity", b"identity", "namespace", b"namespace", "task_queue", b"task_queue", "task_queue_metadata", b"task_queue_metadata", "worker_heartbeat", b"worker_heartbeat", "worker_version_capabilities", b"worker_version_capabilities"]) -> None: ...
...
class RespondActivityTaskCompletedRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deployment", b"deployment", "deployment_options", b"deployment_options", "identity", b"identity", "namespace", b"namespace", "result", b"result", "task_token", b"task_token", "worker_version", b"worker_version"]) -> None: ...
...
class RespondActivityTaskFailedRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deployment", b"deployment", "deployment_options", b"deployment_options", "failure", b"failure", "identity", b"identity", "last_heartbeat_details", b"last_heartbeat_details", "namespace", b"namespace", "task_token", b"task_token", "worker_version", b"worker_version"]) -> None: ...
...
class RespondActivityTaskFailedByIdRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id", b"activity_id", "failure", b"failure", "identity", b"identity", "last_heartbeat_details", b"last_heartbeat_details", "namespace", b"namespace", "run_id", b"run_id", "workflow_id", b"workflow_id"]) -> None: ...
...
class RespondActivityTaskCanceledRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deployment", b"deployment", "deployment_options", b"deployment_options", "details", b"details", "identity", b"identity", "namespace", b"namespace", "task_token", b"task_token", "worker_version", b"worker_version"]) -> None: ...
...
class RespondActivityTaskCanceledByIdRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_id", b"activity_id", "deployment_options", b"deployment_options", "details", b"details", "identity", b"identity", "namespace", b"namespace", "run_id", b"run_id", "workflow_id", b"workflow_id"]) -> None: ...
...
class RespondQueryTaskCompletedRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["cause", b"cause", "completed_type", b"completed_type", "error_message", b"error_message", "failure", b"failure", "namespace", b"namespace", "query_result", b"query_result", "task_token", b"task_token"]) -> None: ...
...
class ShutdownWorkerRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "namespace", b"namespace", "reason", b"reason", "sticky_task_queue", b"sticky_task_queue", "worker_heartbeat", b"worker_heartbeat"]) -> None: ...
...
class UpdateScheduleRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["schedule", b"schedule", "search_attributes", b"search_attributes"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["conflict_token", b"conflict_token", "identity", b"identity", "namespace", b"namespace", "request_id", b"request_id", "schedule", b"schedule", "schedule_id", b"schedule_id", "search_attributes", b"search_attributes"]) -> None: ...
...
class DescribeBatchOperationResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["close_time", b"close_time", "complete_operation_count", b"complete_operation_count", "failure_operation_count", b"failure_operation_count", "identity", b"identity", "job_id", b"job_id", "operation_type", b"operation_type", "reason", b"reason", "start_time", b"start_time", "state", b"state", "total_operation_count", b"total_operation_count"]) -> None: ...
...
class PollNexusTaskQueueRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["deployment_options", b"deployment_options", "identity", b"identity", "namespace", b"namespace", "task_queue", b"task_queue", "worker_heartbeat", b"worker_heartbeat", "worker_version_capabilities", b"worker_version_capabilities"]) -> None: ...
...
class PollNexusTaskQueueResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["poller_scaling_decision", b"poller_scaling_decision", "request", b"request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["poller_scaling_decision", b"poller_scaling_decision", "request", b"request", "task_token", b"task_token"]) -> None: ...
...
class RespondNexusTaskCompletedRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "namespace", b"namespace", "response", b"response", "task_token", b"task_token"]) -> None: ...
...
class RespondNexusTaskFailedRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["error", b"error", "identity", b"identity", "namespace", b"namespace", "task_token", b"task_token"]) -> None: ...
...
class ExecuteMultiOperationRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace", b"namespace", "operations", b"operations"]) -> None: ...
...
class PauseActivityRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["activity", b"activity", "execution", b"execution", "id", b"id", "identity", b"identity", "namespace", b"namespace", "reason", b"reason", "type", b"type"]) -> None: ...
...
class UpdateWorkflowExecutionOptionsRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["namespace", b"namespace", "update_mask", b"update_mask", "workflow_execution", b"workflow_execution", "workflow_execution_options", b"workflow_execution_options"]) -> None: ...
...
class UpdateWorkflowExecutionOptionsResponse(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["workflow_execution_options", b"workflow_execution_options"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["workflow_execution_options", b"workflow_execution_options"]) -> None: ...
...
class RecordWorkerHeartbeatRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "namespace", b"namespace", "worker_heartbeat", b"worker_heartbeat"]) -> None: ...
...
class ListWorkersResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["next_page_token", b"next_page_token", "workers_info", b"workers_info"]) -> None: ...
...
class UpdateTaskQueueConfigRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "namespace", b"namespace", "task_queue", b"task_queue", "task_queue_type", b"task_queue_type", "update_fairness_key_rate_limit_default", b"update_fairness_key_rate_limit_default", "update_queue_rate_limit", b"update_queue_rate_limit"]) -> None: ...
...
class FetchWorkerConfigRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "namespace", b"namespace", "reason", b"reason", "selector", b"selector"]) -> None: ...
...
class UpdateWorkerConfigRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["identity", b"identity", "namespace", b"namespace", "reason", b"reason", "selector", b"selector", "update_mask", b"update_mask", "worker_config", b"worker_config"]) -> None: ...
