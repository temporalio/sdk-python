...
import temporalio.api.enums.v1.id_pb2
...
class UpdateActivityOptionsResponse(google.protobuf.message.Message):
    """Deprecated. See UpdateActivityExecutionOptionsResponse."""
...
class PauseActivityRequest(google.protobuf.message.Message):
    """Deprecated. See PauseActivityExecutionRequest."""
...
class PauseActivityResponse(google.protobuf.message.Message):
    """Deprecated. See PauseActivityExecutionResponse."""
...
class UnpauseActivityRequest(google.protobuf.message.Message):
    """Deprecated. See UnpauseActivityExecutionRequest."""
...
class UnpauseActivityResponse(google.protobuf.message.Message):
    """Deprecated. See UnpauseActivityExecutionResponse."""
...
class ResetActivityRequest(google.protobuf.message.Message):
    ...
    Deprecated. See ResetActivityExecutionRequest.
    """
...
class ResetActivityResponse(google.protobuf.message.Message):
    """Deprecated. See ResetActivityExecutionResponse."""
...
class StartActivityExecutionRequest(google.protobuf.message.Message):
    ...
    def activity_type(self) -> temporalio.api.common.v1.message_pb2.ActivityType: ...
    @property
    def options(self) -> temporalio.api.activity.v1.message_pb2.ActivityOptions: ...
    @property
    def input(self) -> temporalio.api.common.v1.message_pb2.Payloads:
        """Serialized arguments to the activity. These are passed as arguments to the activity function."""
    id_reuse_policy: temporalio.api.enums.v1.id_pb2.IdReusePolicy.ValueType
    ...
    """
    id_conflict_policy: temporalio.api.enums.v1.id_pb2.IdConflictPolicy.ValueType
    ...
    request_eager_execution: builtins.bool
    """Request to get the first activity task inline in the response bypassing matching service and worker polling.
    If set to `true` the caller is expected to have a worker available and capable of processing the task.
    The returned task will be marked as started and is expected to be completed by the specified
    `schedule_to_close_timeout`.
    """
    ...
    def on_conflict_options(
        self,
    ) -> temporalio.api.activity.v1.message_pb2.OnConflictOptions:
    ...
    def __init__(
        ...
        *,
        ...
        activity_id: builtins.str = ...,
        activity_type: temporalio.api.common.v1.message_pb2.ActivityType | None = ...,
        options: temporalio.api.activity.v1.message_pb2.ActivityOptions | None = ...,
        input: temporalio.api.common.v1.message_pb2.Payloads | None = ...,
        id_reuse_policy: temporalio.api.enums.v1.id_pb2.IdReusePolicy.ValueType = ...,
        id_conflict_policy: temporalio.api.enums.v1.id_pb2.IdConflictPolicy.ValueType = ...,
        memo: temporalio.api.common.v1.message_pb2.Memo | None = ...,
        ...
        links: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Link]
        | None = ...,
        on_conflict_options: temporalio.api.activity.v1.message_pb2.OnConflictOptions
        | None = ...,
        priority: temporalio.api.common.v1.message_pb2.Priority | None = ...,
    ) -> None: ...
    def HasField(
...
class StartActivityExecutionResponse(google.protobuf.message.Message):
    ...
    RUN_ID_FIELD_NUMBER: builtins.int
    STARTED_FIELD_NUMBER: builtins.int
    EAGER_TASK_FIELD_NUMBER: builtins.int
    LINK_FIELD_NUMBER: builtins.int
    run_id: builtins.str
    ...
    @property
    def eager_task(self) -> global___PollActivityTaskQueueResponse:
        """When `request_eager_execution` is set on the `StartActivityExecutionRequest`, the server will return the first
    ...
    def __init__(
        ...
        *,
        run_id: builtins.str = ...,
        started: builtins.bool = ...,
        eager_task: global___PollActivityTaskQueueResponse | None = ...,
        link: temporalio.api.common.v1.message_pb2.Link | None = ...,
    ) -> None: ...
    def HasField(
        self,
        field_name: typing_extensions.Literal[
            "eager_task", b"eager_task", "link", b"link"
        ],
    ) -> builtins.bool: ...
    def ClearField(
        self,
...
class DescribeActivityExecutionRequest(google.protobuf.message.Message):
    ...
    """If not empty, turns this request into a long poll that is unblocked when the activity state changes from the time
...
class DescribeActivityExecutionResponse(google.protobuf.message.Message):
    ...
    def ClearField(
        self,
        field_name: typing_extensions.Literal[
            "info", b"info", "long_poll_token", b"long_poll_token"
        ],
    ) -> None: ...
...
class ListActivityExecutionsResponse(google.protobuf.message.Message):
    ...
    def executions(
        ...
        temporalio.api.activity.v1.message_pb2.ActivityListInfo
    ]: ...
    next_page_token: builtins.bytes
...
class GetActivityExecutionResultRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___GetActivityExecutionResultRequest = GetActivityExecutionResultRequest

class GetActivityExecutionResultResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    FAILURE_FIELD_NUMBER: builtins.int
    run_id: builtins.str
    """The run ID of the completed activity, may be used in case a run ID was not specified in the request."""
    @property
    def result(self) -> temporalio.api.common.v1.message_pb2.Payloads:
...
global___GetActivityExecutionResultResponse = GetActivityExecutionResultResponse
...
class RequestCancelActivityExecutionRequest(google.protobuf.message.Message):
    ...
    """Used to de-dupe cancellation requests."""
    reason: builtins.str
    """Reason for requesting the cancellation, recorded and available via the DescribeActivityExecution API.
...
class UpdateActivityExecutionOptionsRequest(google.protobuf.message.Message):
    ...
    RUN_ID_FIELD_NUMBER: builtins.int
    IDENTITY_FIELD_NUMBER: builtins.int
    WORKFLOW_ACTIVITY_TYPE_FIELD_NUMBER: builtins.int
    ALL_WORKFLOW_ACTIVITIES_FIELD_NUMBER: builtins.int
    ACTIVITY_OPTIONS_FIELD_NUMBER: builtins.int
    UPDATE_MASK_FIELD_NUMBER: builtins.int
    RESTORE_ORIGINAL_FIELD_NUMBER: builtins.int
    namespace: builtins.str
    """Namespace of the workflow which scheduled this activity"""
    workflow_id: builtins.str
    """If provided, update options for a workflow activity (or activities) for the given workflow ID. If empty, target a
    standalone activity.
    """
    activity_id: builtins.str
    """Update options for an activity with this ID. Must be provided for a standalone activity.
    Mutually exclusive with workflow_activity_type and all_workflow_activities.
    """
    run_id: builtins.str
    """Run ID of the workflow or standalone activity."""
    identity: builtins.str
    """The identity of the client who initiated this request"""
    workflow_activity_type: builtins.str
    """Update all pending workflow activities of this type.
    Only available if workflow_id is provided.
    Mutually exclusive with activity_id and all_workflow_activities.

    Note: Experimental - the behavior of updating by activity type may change or be removed in a future release.
    """
    all_workflow_activities: builtins.bool
    """Update all pending workflow activities.
    Only available if workflow_id is provided.
    Mutually exclusive with activity_id and workflow_activity_type.

    Note: Experimental - the behavior of updating all activities may change or be removed in a future release.
    """
    @property
    def activity_options(
        self,
        ...
        """Activity options. Partial updates are accepted and controlled by update_mask
        Mutually exclusive with restore_original.
        """
    @property
    def update_mask(self) -> google.protobuf.field_mask_pb2.FieldMask:
        """Controls which fields from `activity_options` will be applied"""
    ...
    Mutually exclusive with activity_options.
    """
    def __init__(
        self,
        *,
    ...
    def ClearField(
        ...
        field_name: typing_extensions.Literal[
            ...
            "activity_options",
            b"activity_options",
            "all_workflow_activities",
            b"all_workflow_activities",
            "identity",
            b"identity",
            "namespace",
            b"namespace",
...
class PauseActivityExecutionRequest(google.protobuf.message.Message):
    ...
    """
    activity_id: builtins.str
    """Pause an activity with this ID. Must be provided for a standalone activity.
    ...
    """The identity of the client who initiated this request."""
    workflow_activity_type: builtins.str
    """Pause all pending activities of this type.
    Only available if workflow_id is provided.
    Mutually exclusive with activity_id.

    Note: Experimental - the behavior of pausing by activity type might change or be removed in a future release.
    """
    reason: builtins.str
    """Reason to pause the activity."""
    def __init__(
...
class UnpauseActivityExecutionRequest(google.protobuf.message.Message):
    ...
    """Namespace of the workflow which scheduled this activity."""
    workflow_id: builtins.str
    """If provided, unpause a workflow activity (or activities) for the given workflow ID.
    If empty, target a standalone activity.
    """
    activity_id: builtins.str
    """Unpause an activity with this ID. Must be provided for a standalone activity.
    Mutually exclusive with workflow_activity_type and all_workflow_activities.
    """
    run_id: builtins.str
    """Run ID of the workflow or standalone activity."""
    ...
    """The identity of the client who initiated this request."""
    workflow_activity_type: builtins.str
    """Unpause all currently paused workflow activities of this type.
    Only available if workflow_id is provided.
    Mutually exclusive with activity_id and all_workflow_activities.

    Note: Experimental - the behavior of unpausing by activity type may change or be removed in a future release.
    """
    all_workflow_activities: builtins.bool
    """Unpause all paused workflow activities.
    Only available if workflow_id is provided.
    Mutually exclusive with activity_id and workflow_activity_type.

    Note: Experimental - the behavior of unpausing all activities may change or be removed in a future release.
    """
    reset_attempts: builtins.bool
    """Providing this flag will also reset the number of attempts."""
    reset_heartbeat: builtins.bool
...
class ResetActivityExecutionRequest(google.protobuf.message.Message):
    ...
    """Namespace of the workflow which scheduled this activity."""
    workflow_id: builtins.str
    """If provided, reset a workflow activity (or activities) for the given workflow ID.
    If empty, target a standalone activity.
    """
    activity_id: builtins.str
    """Reset an activity with this ID. Must be provided for a standalone activity.
    Mutually exclusive with workflow_activity_type and all_workflow_activities.
    """
    run_id: builtins.str
    """Run ID of the workflow or standalone activity."""
    ...
    """The identity of the client who initiated this request."""
    workflow_activity_type: builtins.str
    """Reset all pending workflow activities of this type.
    Only available if workflow_id is provided.
    Mutually exclusive with activity_id and all_workflow_activities.

    Note: Experimental - the behavior of resetting by activity type may change or be removed in a future release.
    """
    all_workflow_activities: builtins.bool
    """Reset all pending workflow activities.
    Only available if workflow_id is provided.
    Mutually exclusive with activity_id and workflow_activity_type.

    Note: Experimental - the behavior of resetting all activities may change or be removed in a future release.
    """
    reset_heartbeat: builtins.bool
    """Indicates that activity should reset heartbeat details.
    This flag will be applied only to the new instance of the activity.
