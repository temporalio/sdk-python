...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    ]._serialized_options = b'\202\323\344\223\002E"@/api/v1/namespaces/{namespace}/workflows/execute-multi-operation:\001*'
    ...
    ]._serialized_options = b"\202\323\344\223\002Q\022O/api/v1/namespaces/{namespace}/task-queues/{task_queue}/worker-versioning-rules"
    ...
    _WORKFLOWSERVICE._serialized_end = 13208
