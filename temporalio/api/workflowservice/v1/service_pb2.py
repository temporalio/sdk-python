...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    ]._serialized_options = b'\202\323\344\223\002g"*/namespaces/{namespace}/activity-heartbeat:\001*Z6"1/api/v1/namespaces/{namespace}/activity-heartbeat:\001*'
    ...
    ]._serialized_options = b'\202\323\344\223\002e")/namespaces/{namespace}/activity-complete:\001*Z5"0/api/v1/namespaces/{namespace}/activity-complete:\001*'
    ...
    ]._serialized_options = b'\202\323\344\223\002]"%/namespaces/{namespace}/activity-fail:\001*Z1",/api/v1/namespaces/{namespace}/activity-fail:\001*'
    ...
    ]._serialized_options = b'\202\323\344\223\002{"4/namespaces/{namespace}/activity-resolve-as-canceled:\001*Z@";/api/v1/namespaces/{namespace}/activity-resolve-as-canceled:\001*'
    ...
    ]._serialized_options = b'\202\323\344\223\002\243\001"H/namespaces/{namespace}/worker-deployments/{deployment_name}/set-manager:\001*ZT"O/api/v1/namespaces/{namespace}/worker-deployments/{deployment_name}/set-manager:\001*'
    ...
    ]._serialized_options = b'\202\323\344\223\002\213\001"</namespaces/{namespace}/activities-deprecated/update-options:\001*ZH"C/api/v1/namespaces/{namespace}/activities-deprecated/update-options:\001*'
    ...
    _WORKFLOWSERVICE.methods_by_name[
        "PauseActivity"
    ]._serialized_options = b'\202\323\344\223\002y"3/namespaces/{namespace}/activities-deprecated/pause:\001*Z?":/api/v1/namespaces/{namespace}/activities-deprecated/pause:\001*'
    _WORKFLOWSERVICE.methods_by_name["UnpauseActivity"]._options = None
    _WORKFLOWSERVICE.methods_by_name[
        "UnpauseActivity"
    ]._serialized_options = b'\202\323\344\223\002}"5/namespaces/{namespace}/activities-deprecated/unpause:\001*ZA"</api/v1/namespaces/{namespace}/activities-deprecated/unpause:\001*'
    _WORKFLOWSERVICE.methods_by_name["ResetActivity"]._options = None
    _WORKFLOWSERVICE.methods_by_name[
        "ResetActivity"
    ]._serialized_options = b'\202\323\344\223\002y"3/namespaces/{namespace}/activities-deprecated/reset:\001*Z?":/api/v1/namespaces/{namespace}/activities-deprecated/reset:\001*'
    ...
    _WORKFLOWSERVICE.methods_by_name[
        "DescribeWorker"
    ]._serialized_options = b"\202\323\344\223\002\211\001\022>/namespaces/{namespace}/workers/describe/{worker_instance_key}ZG\022E/api/v1/namespaces/{namespace}/workers/describe/{worker_instance_key}"
    _WORKFLOWSERVICE.methods_by_name["PauseWorkflowExecution"]._options = None
    _WORKFLOWSERVICE.methods_by_name[
        "PauseWorkflowExecution"
    ]._serialized_options = b'\202\323\344\223\002}"5/namespaces/{namespace}/workflows/{workflow_id}/pause:\001*ZA"</api/v1/namespaces/{namespace}/workflows/{workflow_id}/pause:\001*'
    _WORKFLOWSERVICE.methods_by_name["UnpauseWorkflowExecution"]._options = None
    _WORKFLOWSERVICE.methods_by_name[
        "UnpauseWorkflowExecution"
    ]._serialized_options = b'\202\323\344\223\002\201\001"7/namespaces/{namespace}/workflows/{workflow_id}/unpause:\001*ZC">/api/v1/namespaces/{namespace}/workflows/{workflow_id}/unpause:\001*'
    ...
    _WORKFLOWSERVICE._serialized_end = 28766
