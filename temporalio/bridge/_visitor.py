...
class PayloadVisitor:
    ...
    async def _visit_temporal_api_failure_v1_TimeoutFailureInfo(self, fs, o):
        if o.HasField("last_heartbeat_details"):
            await self._visit_temporal_api_common_v1_Payloads(fs, o.last_heartbeat_details)
    ...
    async def _visit_temporal_api_failure_v1_Failure(self, fs, o):
        ...
        if o.HasField("application_failure_info"):
            await self._visit_temporal_api_failure_v1_ApplicationFailureInfo(fs, o.application_failure_info)
        elif o.HasField("timeout_failure_info"):
            await self._visit_temporal_api_failure_v1_TimeoutFailureInfo(fs, o.timeout_failure_info)
        elif o.HasField("canceled_failure_info"):
            await self._visit_temporal_api_failure_v1_CanceledFailureInfo(fs, o.canceled_failure_info)
        elif o.HasField("reset_workflow_failure_info"):
            await self._visit_temporal_api_failure_v1_ResetWorkflowFailureInfo(fs, o.reset_workflow_failure_info)
    ...
    async def _visit_coresdk_workflow_activation_InitializeWorkflow(self, fs, o):
        ...
        if o.HasField("last_completion_result"):
            await self._visit_temporal_api_common_v1_Payloads(fs, o.last_completion_result)
        if o.HasField("memo"):
            await self._visit_temporal_api_common_v1_Memo(fs, o.memo)
        if o.HasField("search_attributes"):
            await self._visit_temporal_api_common_v1_SearchAttributes(fs, o.search_attributes)
    ...
    async def _visit_coresdk_workflow_activation_ResolveChildWorkflowExecutionStart(self, fs, o):
        if o.HasField("cancelled"):
            await self._visit_coresdk_workflow_activation_ResolveChildWorkflowExecutionStartCancelled(fs, o.cancelled)
    ...
    async def _visit_coresdk_workflow_activation_ResolveChildWorkflowExecution(self, fs, o):
        if o.HasField("result"):
            await self._visit_coresdk_child_workflow_ChildWorkflowResult(fs, o.result)

    async def _visit_coresdk_workflow_activation_ResolveSignalExternalWorkflow(self, fs, o):
        if o.HasField("failure"):
            await self._visit_temporal_api_failure_v1_Failure(fs, o.failure)
    ...
    async def _visit_coresdk_workflow_activation_ResolveNexusOperationStart(self, fs, o):
    ...
    async def _visit_coresdk_workflow_activation_WorkflowActivationJob(self, fs, o):
        if o.HasField("initialize_workflow"):
            await self._visit_coresdk_workflow_activation_InitializeWorkflow(fs, o.initialize_workflow)
        elif o.HasField("query_workflow"):
            await self._visit_coresdk_workflow_activation_QueryWorkflow(fs, o.query_workflow)
        elif o.HasField("signal_workflow"):
            await self._visit_coresdk_workflow_activation_SignalWorkflow(fs, o.signal_workflow)
            ...
            await self._visit_coresdk_workflow_activation_ResolveChildWorkflowExecutionStart(fs, o.resolve_child_workflow_execution_start)
        elif o.HasField("resolve_child_workflow_execution"):
            await self._visit_coresdk_workflow_activation_ResolveChildWorkflowExecution(fs, o.resolve_child_workflow_execution)
        elif o.HasField("resolve_signal_external_workflow"):
            await self._visit_coresdk_workflow_activation_ResolveSignalExternalWorkflow(fs, o.resolve_signal_external_workflow)
            ...
            await self._visit_coresdk_workflow_activation_ResolveNexusOperationStart(fs, o.resolve_nexus_operation_start)
        elif o.HasField("resolve_nexus_operation"):
            await self._visit_coresdk_workflow_activation_ResolveNexusOperation(fs, o.resolve_nexus_operation)
    ...
    async def _visit_coresdk_workflow_commands_ContinueAsNewWorkflowExecution(self, fs, o):
        await self._visit_payload_container(fs, o.arguments)
    ...
    async def _visit_coresdk_workflow_commands_SignalExternalWorkflowExecution(self, fs, o):
    ...
    async def _visit_coresdk_workflow_commands_UpsertWorkflowSearchAttributes(self, fs, o):
        if o.HasField("search_attributes"):
            await self._visit_temporal_api_common_v1_SearchAttributes(fs, o.search_attributes)
    ...
    async def _visit_coresdk_workflow_commands_WorkflowCommand(self, fs, o):
        ...
        if o.HasField("schedule_activity"):
            await self._visit_coresdk_workflow_commands_ScheduleActivity(fs, o.schedule_activity)
        elif o.HasField("respond_to_query"):
            await self._visit_coresdk_workflow_commands_QueryResult(fs, o.respond_to_query)
        elif o.HasField("complete_workflow_execution"):
            await self._visit_coresdk_workflow_commands_CompleteWorkflowExecution(fs, o.complete_workflow_execution)
        elif o.HasField("fail_workflow_execution"):
            await self._visit_coresdk_workflow_commands_FailWorkflowExecution(fs, o.fail_workflow_execution)
        elif o.HasField("continue_as_new_workflow_execution"):
            await self._visit_coresdk_workflow_commands_ContinueAsNewWorkflowExecution(fs, o.continue_as_new_workflow_execution)
        elif o.HasField("start_child_workflow_execution"):
            await self._visit_coresdk_workflow_commands_StartChildWorkflowExecution(fs, o.start_child_workflow_execution)
        elif o.HasField("signal_external_workflow_execution"):
            await self._visit_coresdk_workflow_commands_SignalExternalWorkflowExecution(fs, o.signal_external_workflow_execution)
        elif o.HasField("schedule_local_activity"):
            await self._visit_coresdk_workflow_commands_ScheduleLocalActivity(fs, o.schedule_local_activity)
            ...
            await self._visit_coresdk_workflow_commands_ModifyWorkflowProperties(fs, o.modify_workflow_properties)
        elif o.HasField("update_response"):
            await self._visit_coresdk_workflow_commands_UpdateResponse(fs, o.update_response)
        elif o.HasField("schedule_nexus_operation"):
            await self._visit_coresdk_workflow_commands_ScheduleNexusOperation(fs, o.schedule_nexus_operation)
    ...
    async def _visit_coresdk_workflow_completion_WorkflowActivationCompletion(self, fs, o):
