...
class PayloadVisitor:
    ...
    async def _visit_temporal_api_failure_v1_ApplicationFailureInfo(
        self,
        fs: VisitorFunctions,
        o: temporalio.api.failure.v1.message_pb2.ApplicationFailureInfo,
    ):
    ...
    async def _visit_temporal_api_failure_v1_TimeoutFailureInfo(
        self,
        fs: VisitorFunctions,
        o: temporalio.api.failure.v1.message_pb2.TimeoutFailureInfo,
    ):
    ...
    async def _visit_temporal_api_failure_v1_CanceledFailureInfo(
        self,
        fs: VisitorFunctions,
        o: temporalio.api.failure.v1.message_pb2.CanceledFailureInfo,
    ):
        if o.HasField("details"):
            await self._visit_temporal_api_common_v1_Payloads(fs, o.details)
    ...
    async def _visit_temporal_api_failure_v1_ResetWorkflowFailureInfo(
        self,
        fs: VisitorFunctions,
        o: temporalio.api.failure.v1.message_pb2.ResetWorkflowFailureInfo,
    ):
        if o.HasField("last_heartbeat_details"):
            await self._visit_temporal_api_common_v1_Payloads(
                fs, o.last_heartbeat_details
    ...
    async def _visit_temporal_api_failure_v1_Failure(
        self, fs: VisitorFunctions, o: temporalio.api.failure.v1.message_pb2.Failure
    ):
    ...
    async def _visit_coresdk_workflow_activation_InitializeWorkflow(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.InitializeWorkflow,
    ):
    ...
    async def _visit_coresdk_workflow_activation_QueryWorkflow(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.QueryWorkflow,
    ):
        await self._visit_payload_container(fs, o.arguments)
        if not self.skip_headers:
            for v in o.headers.values():
    ...
    async def _visit_coresdk_workflow_activation_SignalWorkflow(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.SignalWorkflow,
    ):
    ...
    async def _visit_coresdk_activity_result_Success(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.activity_result.activity_result_pb2.Success,
    ):
    ...
    async def _visit_coresdk_activity_result_Failure(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.activity_result.activity_result_pb2.Failure,
    ):
    ...
    async def _visit_coresdk_activity_result_Cancellation(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.activity_result.activity_result_pb2.Cancellation,
    ):
        if o.HasField("failure"):
            await self._visit_temporal_api_failure_v1_Failure(fs, o.failure)
    ...
    async def _visit_coresdk_activity_result_ActivityResolution(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.activity_result.activity_result_pb2.ActivityResolution,
    ):
    ...
    async def _visit_coresdk_workflow_activation_ResolveActivity(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.ResolveActivity,
    ):
        if o.HasField("result"):
    ...
    async def _visit_coresdk_workflow_activation_ResolveChildWorkflowExecutionStartCancelled(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.ResolveChildWorkflowExecutionStartCancelled,
    ):
        if o.HasField("failure"):
            await self._visit_temporal_api_failure_v1_Failure(fs, o.failure)
    ...
    async def _visit_coresdk_workflow_activation_ResolveChildWorkflowExecutionStart(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.ResolveChildWorkflowExecutionStart,
    ):
    ...
    async def _visit_coresdk_child_workflow_Success(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.child_workflow.child_workflow_pb2.Success,
    ):
        if o.HasField("result"):
            await self._visit_temporal_api_common_v1_Payload(fs, o.result)

    async def _visit_coresdk_child_workflow_Failure(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.child_workflow.child_workflow_pb2.Failure,
    ):
        if o.HasField("failure"):
            await self._visit_temporal_api_failure_v1_Failure(fs, o.failure)
    ...
    async def _visit_coresdk_child_workflow_Cancellation(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.child_workflow.child_workflow_pb2.Cancellation,
    ):
        if o.HasField("failure"):
            await self._visit_temporal_api_failure_v1_Failure(fs, o.failure)
    ...
    async def _visit_coresdk_child_workflow_ChildWorkflowResult(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.child_workflow.child_workflow_pb2.ChildWorkflowResult,
    ):
        if o.HasField("completed"):
    ...
    async def _visit_coresdk_workflow_activation_ResolveChildWorkflowExecution(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.ResolveChildWorkflowExecution,
    ):
        if o.HasField("result"):
    ...
    async def _visit_coresdk_workflow_activation_ResolveSignalExternalWorkflow(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.ResolveSignalExternalWorkflow,
    ):
        if o.HasField("failure"):
            await self._visit_temporal_api_failure_v1_Failure(fs, o.failure)
    ...
    async def _visit_coresdk_workflow_activation_ResolveRequestCancelExternalWorkflow(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.ResolveRequestCancelExternalWorkflow,
    ):
        if o.HasField("failure"):
            await self._visit_temporal_api_failure_v1_Failure(fs, o.failure)
    ...
    async def _visit_coresdk_workflow_activation_DoUpdate(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.DoUpdate,
    ):
        await self._visit_payload_container(fs, o.input)
        if not self.skip_headers:
            for v in o.headers.values():
    ...
    async def _visit_coresdk_workflow_activation_ResolveNexusOperationStart(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.ResolveNexusOperationStart,
    ):
    ...
    async def _visit_coresdk_nexus_NexusOperationResult(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.nexus.nexus_pb2.NexusOperationResult,
    ):
        if o.HasField("completed"):
    ...
    async def _visit_coresdk_workflow_activation_ResolveNexusOperation(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.ResolveNexusOperation,
    ):
        if o.HasField("result"):
    ...
    async def _visit_coresdk_workflow_activation_WorkflowActivationJob(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.WorkflowActivationJob,
    ):
    ...
    async def _visit_coresdk_workflow_activation_WorkflowActivation(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_activation.workflow_activation_pb2.WorkflowActivation,
    ):
        for v in o.jobs:
    ...
    async def _visit_coresdk_workflow_commands_ScheduleActivity(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.ScheduleActivity,
    ):
        if not self.skip_headers:
            for v in o.headers.values():
                await self._visit_temporal_api_common_v1_Payload(fs, v)
    ...
    async def _visit_coresdk_workflow_commands_QuerySuccess(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.QuerySuccess,
    ):
    ...
    async def _visit_coresdk_workflow_commands_QueryResult(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.QueryResult,
    ):
    ...
    async def _visit_coresdk_workflow_commands_CompleteWorkflowExecution(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.CompleteWorkflowExecution,
    ):
        if o.HasField("result"):
            await self._visit_temporal_api_common_v1_Payload(fs, o.result)
    ...
    async def _visit_coresdk_workflow_commands_FailWorkflowExecution(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.FailWorkflowExecution,
    ):
        if o.HasField("failure"):
            await self._visit_temporal_api_failure_v1_Failure(fs, o.failure)
    ...
    async def _visit_coresdk_workflow_commands_ContinueAsNewWorkflowExecution(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.ContinueAsNewWorkflowExecution,
    ):
        await self._visit_payload_container(fs, o.arguments)
    ...
    async def _visit_coresdk_workflow_commands_StartChildWorkflowExecution(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.StartChildWorkflowExecution,
    ):
        await self._visit_payload_container(fs, o.input)
        if not self.skip_headers:
            for v in o.headers.values():
    ...
    async def _visit_coresdk_workflow_commands_SignalExternalWorkflowExecution(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.SignalExternalWorkflowExecution,
    ):
    ...
    async def _visit_coresdk_workflow_commands_ScheduleLocalActivity(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.ScheduleLocalActivity,
    ):
        if not self.skip_headers:
            for v in o.headers.values():
                await self._visit_temporal_api_common_v1_Payload(fs, v)
    ...
    async def _visit_coresdk_workflow_commands_UpsertWorkflowSearchAttributes(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.UpsertWorkflowSearchAttributes,
    ):
        if o.HasField("search_attributes"):
            await self._visit_temporal_api_common_v1_SearchAttributes(
                fs, o.search_attributes
    ...
    async def _visit_coresdk_workflow_commands_ModifyWorkflowProperties(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.ModifyWorkflowProperties,
    ):
    ...
    async def _visit_coresdk_workflow_commands_UpdateResponse(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.UpdateResponse,
    ):
    ...
    async def _visit_coresdk_workflow_commands_ScheduleNexusOperation(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.ScheduleNexusOperation,
    ):
        if o.HasField("input"):
    ...
    async def _visit_coresdk_workflow_commands_WorkflowCommand(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_commands.workflow_commands_pb2.WorkflowCommand,
    ):
    ...
    async def _visit_coresdk_workflow_completion_Success(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_completion.workflow_completion_pb2.Success,
    ):
        for v in o.commands:
    ...
    async def _visit_coresdk_workflow_completion_Failure(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_completion.workflow_completion_pb2.Failure,
    ):
        if o.HasField("failure"):
            await self._visit_temporal_api_failure_v1_Failure(fs, o.failure)
    ...
    async def _visit_coresdk_workflow_completion_WorkflowActivationCompletion(
        self,
        fs: VisitorFunctions,
        o: temporalio.bridge.proto.workflow_completion.workflow_completion_pb2.WorkflowActivationCompletion,
    ):
