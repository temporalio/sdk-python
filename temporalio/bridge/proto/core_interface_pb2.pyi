...
class ActivityHeartbeat(google.protobuf.message.Message):
    ...
    @property
    def details(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[temporalio.api.common.v1.message_pb2.Payload]: ...
    def __init__(
        self,
        *,
        task_token: builtins.bytes = ...,
        details: collections.abc.Iterable[temporalio.api.common.v1.message_pb2.Payload] | None = ...,
    ) -> None: ...
...
class ActivityTaskCompletion(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        task_token: builtins.bytes = ...,
        result: temporalio.bridge.proto.activity_result.activity_result_pb2.ActivityExecutionResult | None = ...,
    ) -> None: ...
...
class WorkflowSlotInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["is_sticky", b"is_sticky", "workflow_type", b"workflow_type"]) -> None: ...
...
class ActivitySlotInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["activity_type", b"activity_type"]) -> None: ...
...
class NexusSlotInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["operation", b"operation", "service", b"service"]) -> None: ...
