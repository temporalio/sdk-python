...
_NEXUSOPERATIONCANCELLATIONTYPE = DESCRIPTOR.enum_types_by_name['NexusOperationCancellationType']
NexusOperationCancellationType = enum_type_wrapper.EnumTypeWrapper(_NEXUSOPERATIONCANCELLATIONTYPE)
TIMED_OUT = 0
WORKER_SHUTDOWN = 1
...
NexusOperationResult = _reflection.GeneratedProtocolMessageType('NexusOperationResult', (_message.Message,), {
...
NexusTaskCompletion = _reflection.GeneratedProtocolMessageType('NexusTaskCompletion', (_message.Message,), {
...
NexusTask = _reflection.GeneratedProtocolMessageType('NexusTask', (_message.Message,), {
...
CancelNexusTask = _reflection.GeneratedProtocolMessageType('CancelNexusTask', (_message.Message,), {
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  DESCRIPTOR._serialized_options = b'\352\002(Temporalio::Internal::Bridge::Api::Nexus'
  _NEXUSTASKCOMPLETION.fields_by_name['error']._options = None
  _NEXUSTASKCOMPLETION.fields_by_name['error']._serialized_options = b'\030\001'
  _NEXUSTASKCANCELREASON._serialized_start=1110
  _NEXUSTASKCANCELREASON._serialized_end=1169
  _NEXUSOPERATIONCANCELLATIONTYPE._serialized_start=1171
  _NEXUSOPERATIONCANCELLATIONTYPE._serialized_end=1298
  ...
  _NEXUSTASKCOMPLETION._serialized_end=786
  _NEXUSTASK._serialized_start=789
  _NEXUSTASK._serialized_end=1015
  _CANCELNEXUSTASK._serialized_start=1017
  _CANCELNEXUSTASK._serialized_end=1108
