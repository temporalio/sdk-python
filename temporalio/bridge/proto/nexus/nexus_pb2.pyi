...
class _NexusTaskCancelReasonEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_NexusTaskCancelReason.ValueType], builtins.type):  # noqa: F821
...
class _NexusOperationCancellationTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_NexusOperationCancellationType.ValueType], builtins.type):  # noqa: F821
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class NexusTaskCompletion(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["ack_cancel", b"ack_cancel", "completed", b"completed", "error", b"error", "failure", b"failure", "status", b"status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["ack_cancel", b"ack_cancel", "completed", b"completed", "error", b"error", "failure", b"failure", "status", b"status", "task_token", b"task_token"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["status", b"status"]) -> typing_extensions.Literal["completed", "error", "ack_cancel", "failure"] | None: ...
...
class NexusTask(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        task: temporalio.api.workflowservice.v1.request_response_pb2.PollNexusTaskQueueResponse | None = ...,
        cancel_task: global___CancelNexusTask | None = ...,
        request_deadline: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        endpoint: builtins.str = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["cancel_task", b"cancel_task", "request_deadline", b"request_deadline", "task", b"task", "variant", b"variant"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cancel_task", b"cancel_task", "endpoint", b"endpoint", "request_deadline", b"request_deadline", "task", b"task", "variant", b"variant"]) -> None: ...
