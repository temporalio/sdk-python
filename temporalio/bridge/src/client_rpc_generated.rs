    ...
    self.runtime.future_into_py(py, async move {
        let bytes = match call.rpc.as_str() {
          ...
          "set_worker_deployment_manager" => { 
            rpc_call!(retry_client, call, WorkflowService, set_worker_deployment_manager)
          }
    ...
    self.runtime.future_into_py(py, async move {
        let bytes = match call.rpc.as_str() {
          ...
          "set_service_account_namespace_access" => { 
            rpc_call!(retry_client, call, CloudService, set_service_account_namespace_access)
          }
          ...
          "validate_account_audit_log_sink" => { 
            rpc_call!(retry_client, call, CloudService, validate_account_audit_log_sink)
          }
