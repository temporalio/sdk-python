...
@dataclass
class WorkflowEvent:
    eventRef: Optional[EventRef] = None
    namespace: Optional[str] = None
    requestIdRef: Optional[RequestIDRef] = None
...
class Openapiv3:
    ...
    workflowEvent: Optional[WorkflowEvent] = None
...
@dataclass
class WorkflowServiceSignalWithStartWorkflowExecutionInput:
    ...
    signalInput: Optional[Input] = None
    """Serialized value(s) to provide with the signal"""
...
@dataclass
class WorkflowServiceSignalWithStartWorkflowExecutionOutput:
    runId: Optional[str] = None
