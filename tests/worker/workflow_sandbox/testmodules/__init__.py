...
from temporalio.worker.workflow_sandbox.restrictions import SandboxRestrictions, SandboxMatcher

restrictions = SandboxRestrictions(
    passthrough_modules=SandboxRestrictions.passthrough_modules_minimum | SandboxMatcher.nested_child(
